...
.method private readGoAway(Lcom/koushikdutta/async/ByteBufferList;II)V
    ...
    sget-object p2, Lcom/koushikdutta/async/http/spdy/ByteString;->EMPTY:Lcom/koushikdutta/async/http/spdy/ByteString;

    invoke-interface {p1, p3, v1, p2}, Lcom/koushikdutta/async/http/spdy/FrameReader$Handler;->goAway(ILcom/koushikdutta/async/http/spdy/ErrorCode;Lcom/koushikdutta/async/http/spdy/ByteString;)V
    ...
    invoke-static {p1, p3}, Lcom/koushikdutta/async/http/spdy/Spdy3$Reader;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method private readPing(Lcom/koushikdutta/async/ByteBufferList;II)V
    ...
    .line 325
    iget-boolean p3, p0, Lcom/koushikdutta/async/http/spdy/Spdy3$Reader;->client:Z
    ...
    .line 326
    :goto_1
    iget-object p3, p0, Lcom/koushikdutta/async/http/spdy/Spdy3$Reader;->handler:Lcom/koushikdutta/async/http/spdy/FrameReader$Handler;

    invoke-interface {p3, v0, p1, p2}, Lcom/koushikdutta/async/http/spdy/FrameReader$Handler;->ping(ZII)V
...
.method private readRstStream(Lcom/koushikdutta/async/ByteBufferList;II)V
    ...
    invoke-interface {p1, p3, v1}, Lcom/koushikdutta/async/http/spdy/FrameReader$Handler;->rstStream(ILcom/koushikdutta/async/http/spdy/ErrorCode;)V
...
.method private readWindowUpdate(Lcom/koushikdutta/async/ByteBufferList;II)V
    ...
    invoke-interface {p1, p3, v1, v2}, Lcom/koushikdutta/async/http/spdy/FrameReader$Handler;->windowUpdate(IJ)V
