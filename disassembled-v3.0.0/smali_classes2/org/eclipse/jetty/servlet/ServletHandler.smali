...
.method public doHandle(Ljava/lang/String;Lorg/eclipse/jetty/server/Request;Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    invoke-interface {v2, v7, v5}, Lorg/eclipse/jetty/util/log/Logger;->debug(Ljava/lang/String;[Ljava/lang/Object;)V

    const/16 v2, 0x1f4

    const-string v5, "javax.servlet.error.exception"

    const-string v7, "Response already committed for handling "
    ...
    invoke-virtual {v9}, Lorg/eclipse/jetty/server/ServletResponseHttpWrapper;->getResponse()Ljavax/servlet/ServletResponse;
    ...
    .line 499
    invoke-interface {v3, p1, v9}, Ljavax/servlet/FilterChain;->doFilter(Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletResponse;)V

    goto :goto_3

    .line 501
    :cond_6
    invoke-virtual {v1, p2, p1, v9}, Lorg/eclipse/jetty/servlet/ServletHolder;->handle(Lorg/eclipse/jetty/server/Request;Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletResponse;)V
    :try_end_0
    ...
    .line 602
    :goto_4
    invoke-virtual {p2, v4}, Lorg/eclipse/jetty/server/Request;->setHandled(Z)V
    ...
    invoke-interface {v0, v3, v6}, Lorg/eclipse/jetty/util/log/Logger;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {p3, v8, v0}, Ljavax/servlet/http/HttpServletRequest;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    .line 593
    invoke-interface {p3, v5, p1}, Ljavax/servlet/http/HttpServletRequest;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {p3, v7, p1}, Lorg/eclipse/jetty/util/log/Logger;->debug(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v3, v9}, Lorg/eclipse/jetty/util/log/Logger;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public doScope(Ljava/lang/String;Lorg/eclipse/jetty/server/Request;Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    .line 425
    :cond_5
    iget-object v3, p0, Lorg/eclipse/jetty/servlet/ServletHandler;->_nextScope:Lorg/eclipse/jetty/server/handler/ScopedHandler;
    ...
    .line 427
    :cond_6
    iget-object v3, p0, Lorg/eclipse/jetty/servlet/ServletHandler;->_outerScope:Lorg/eclipse/jetty/server/handler/ScopedHandler;
