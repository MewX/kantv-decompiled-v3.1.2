...
.source "EventedValueChannelLoudness.java"
...
.method public getAttributes()[Ljava/util/Map$Entry;
    ...
    new-instance v2, Lorg/fourthline/cling/model/types/BooleanDatatype;

    invoke-direct {v2}, Lorg/fourthline/cling/model/types/BooleanDatatype;-><init>()V

    .line 58
    invoke-virtual {p0}, Lorg/fourthline/cling/support/renderingcontrol/lastchange/EventedValueChannelLoudness;->getValue()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lorg/fourthline/cling/support/renderingcontrol/lastchange/ChannelLoudness;

    invoke-virtual {v3}, Lorg/fourthline/cling/support/renderingcontrol/lastchange/ChannelLoudness;->getLoudness()Ljava/lang/Boolean;

    move-result-object v3

    invoke-virtual {v2, v3}, Lorg/fourthline/cling/model/types/BooleanDatatype;->getString(Ljava/lang/Boolean;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lorg/fourthline/cling/support/model/Channel;->name()Ljava/lang/String;
...
.method protected valueOf([Ljava/util/Map$Entry;)Lorg/fourthline/cling/support/renderingcontrol/lastchange/ChannelLoudness;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 50
    new-instance v1, Lorg/fourthline/cling/support/renderingcontrol/lastchange/ChannelLoudness;

    invoke-direct {v1, v3, v4}, Lorg/fourthline/cling/support/renderingcontrol/lastchange/ChannelLoudness;-><init>(Lorg/fourthline/cling/support/model/Channel;Ljava/lang/Boolean;)V
