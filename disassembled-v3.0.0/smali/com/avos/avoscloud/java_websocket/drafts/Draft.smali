...
.method public static readStringLine(Ljava/nio/ByteBuffer;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p0}, Lcom/avos/avoscloud/java_websocket/util/Charsetfunctions;->stringAscii([BII)Ljava/lang/String;
...
.method public static translateHandshakeHttp(Ljava/nio/ByteBuffer;Lcom/avos/avoscloud/java_websocket/WebSocket$Role;)Lcom/avos/avoscloud/java_websocket/handshake/HandshakeBuilder;
    ...
    check-cast v1, Lcom/avos/avoscloud/java_websocket/handshake/ServerHandshakeBuilder;
    ...
    invoke-interface {v1, v4}, Lcom/avos/avoscloud/java_websocket/handshake/ServerHandshakeBuilder;->setHttpStatus(S)V

    .line 95
    aget-object v0, v0, v2

    invoke-interface {v1, v0}, Lcom/avos/avoscloud/java_websocket/handshake/ServerHandshakeBuilder;->setHttpStatusMessage(Ljava/lang/String;)V

    goto :goto_0

    .line 98
    :cond_0
    new-instance p1, Lcom/avos/avoscloud/java_websocket/handshake/HandshakeImpl1Client;

    invoke-direct {p1}, Lcom/avos/avoscloud/java_websocket/handshake/HandshakeImpl1Client;-><init>()V

    .line 99
    aget-object v0, v0, v3

    invoke-interface {p1, v0}, Lcom/avos/avoscloud/java_websocket/handshake/ClientHandshakeBuilder;->setResourceDescriptor(Ljava/lang/String;)V
    ...
    invoke-interface {p1, v1, v0}, Lcom/avos/avoscloud/java_websocket/handshake/HandshakeBuilder;->put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 107
    :cond_1
    new-instance p0, Lcom/avos/avoscloud/java_websocket/exceptions/InvalidHandshakeException;

    const-string p1, "not an http header"

    invoke-direct {p0, p1}, Lcom/avos/avoscloud/java_websocket/exceptions/InvalidHandshakeException;-><init>(Ljava/lang/String;)V
    ...
    .line 112
    :cond_3
    new-instance p0, Lcom/avos/avoscloud/java_websocket/exceptions/IncompleteHandshakeException;

    invoke-direct {p0}, Lcom/avos/avoscloud/java_websocket/exceptions/IncompleteHandshakeException;-><init>()V
    ...
    invoke-direct {p0}, Lcom/avos/avoscloud/java_websocket/exceptions/InvalidHandshakeException;-><init>()V
    ...
    invoke-direct {p1, p0}, Lcom/avos/avoscloud/java_websocket/exceptions/IncompleteHandshakeException;-><init>(I)V
...
.method public checkAlloc(I)I
    ...
    invoke-direct {p1, v0, v1}, Lcom/avos/avoscloud/java_websocket/exceptions/InvalidDataException;-><init>(ILjava/lang/String;)V
...
.method public createHandshake(Lcom/avos/avoscloud/java_websocket/handshake/Handshakedata;Lcom/avos/avoscloud/java_websocket/WebSocket$Role;Z)Ljava/util/List;
    ...
    check-cast v1, Lcom/avos/avoscloud/java_websocket/handshake/ServerHandshake;

    invoke-interface {v1}, Lcom/avos/avoscloud/java_websocket/handshake/ServerHandshake;->getHttpStatusMessage()Ljava/lang/String;
    ...
    .line 177
    invoke-interface {p1, v2}, Lcom/avos/avoscloud/java_websocket/handshake/Handshakedata;->getFieldValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/avos/avoscloud/java_websocket/util/Charsetfunctions;->asciiBytes(Ljava/lang/String;)[B
