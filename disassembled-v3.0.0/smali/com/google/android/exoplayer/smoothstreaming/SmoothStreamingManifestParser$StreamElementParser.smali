...
.method private parseStreamElementStartTag(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->putNormalizedAttribute(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 532
    invoke-virtual {p0, p1, v1}, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->parseRequiredString(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "QualityLevels"

    .line 537
    invoke-virtual {p0, p1, v1, v0}, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->parseInt(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I

    move-result v1

    iput v1, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->qualityLevels:I
    ...
    iput-object v1, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->url:Ljava/lang/String;
    ...
    iput v1, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->maxWidth:I
    ...
    iput v1, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->maxHeight:I
    ...
    iput v1, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->displayWidth:I
    ...
    iput v1, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->displayHeight:I
    ...
    .line 544
    iget-object v2, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->language:Ljava/lang/String;

    invoke-virtual {p0, v1, v2}, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->putNormalizedAttribute(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iput-wide v2, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->timescale:J

    .line 546
    iget-wide v2, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->timescale:J
    ...
    .line 547
    invoke-virtual {p0, v1}, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->getNormalizedAttribute(Ljava/lang/String;)Ljava/lang/Object;
...
.method private parseStreamFragmentStartTag(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 501
    invoke-virtual {p0, p1, v3, v1, v2}, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->parseLong(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;J)J
    ...
    .line 506
    :cond_0
    iget-wide v3, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->lastChunkDuration:J
    ...
    .line 508
    iget-object v3, p0, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->startTimes:Ljava/util/ArrayList;
    ...
    .line 516
    invoke-virtual {p0, p1, v0, v1, v2}, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->parseLong(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;J)J
    ...
    .line 518
    invoke-virtual {p0, p1, v0, v6, v7}, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$StreamElementParser;->parseLong(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;J)J
...
.method private parseType(Lorg/xmlpull/v1/XmlPullParser;)I
    ...
    invoke-direct {p1, v0}, Lcom/google/android/exoplayer/smoothstreaming/SmoothStreamingManifestParser$MissingFieldException;-><init>(Ljava/lang/String;)V
