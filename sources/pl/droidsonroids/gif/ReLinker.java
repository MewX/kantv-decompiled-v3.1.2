...
class ReLinker {
    ...
    private static java.io.File unpackLibrary(android.content.Context r8) {
        ...
        L_0x0036:
            ...
            clearOldLibraryFiles(r3, r4)
            android.content.pm.ApplicationInfo r8 = r8.getApplicationInfo()
            java.io.File r0 = new java.io.File
            java.lang.String r8 = r8.sourceDir
            r0.<init>(r8)
            r8 = 0
            java.util.zip.ZipFile r0 = openZipFile(r0)     // Catch:{ all -> 0x00bf }
        L_0x0057:
            int r4 = r2 + 1
            r5 = 5
            if (r2 >= r5) goto L_0x00b9
            java.util.zip.ZipEntry r2 = findLibraryEntry(r0)     // Catch:{ all -> 0x00b7 }
            ...
            copy(r2, r5)     // Catch:{ IOException -> 0x007c, all -> 0x0078 }
            closeSilently(r2)     // Catch:{ all -> 0x00b7 }
            closeSilently(r5)     // Catch:{ all -> 0x00b7 }
            setFilePermissions(r1)     // Catch:{ all -> 0x00b7 }
            goto L_0x00b9
        L_0x0078:
            r8 = move-exception
            r1 = r8
        ...
        L_0x0084:
            closeSilently(r2)     // Catch:{ all -> 0x00b7 }
            closeSilently(r8)     // Catch:{ all -> 0x00b7 }
        ...
        L_0x0099:
            ...
            java.lang.String r2 = MAPPED_BASE_LIB_NAME     // Catch:{ all -> 0x00b7 }
            r1.append(r2)     // Catch:{ all -> 0x00b7 }
