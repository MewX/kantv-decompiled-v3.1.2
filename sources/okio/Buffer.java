...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
        ...
        return new InputStream() {
            ...
            public int read() {
                if (Buffer.this.size > 0) {
                    return Buffer.this.readByte() & Draft_75.END_OF_FRAME;
                }
                return -1;
            }
    ...
    public short readShort() {
        if (this.size >= 2) {
            ...
            int i3 = i + 1;
            int i4 = i3 + 1;
            byte b = ((bArr[i] & Draft_75.END_OF_FRAME) << 8) | (bArr[i3] & Draft_75.END_OF_FRAME);
            this.size -= 2;
            if (i4 == i2) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
    ...
    public int readInt() {
        if (this.size >= 4) {
            ...
            int i3 = i + 1;
            int i4 = i3 + 1;
            byte b = ((bArr[i] & Draft_75.END_OF_FRAME) << 24) | ((bArr[i3] & Draft_75.END_OF_FRAME) << 16);
            int i5 = i4 + 1;
            byte b2 = b | ((bArr[i4] & Draft_75.END_OF_FRAME) << 8);
            int i6 = i5 + 1;
            byte b3 = b2 | (bArr[i5] & Draft_75.END_OF_FRAME);
            this.size -= 4;
            if (i6 == i2) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
            ...
            while (true) {
                ...
                if (i11 < 0) {
                    ...
                    while (true) {
                        i2 = i6 + 1;
                        int i15 = i12 + 1;
                        if ((bArr2[i6] & Draft_75.END_OF_FRAME) != iArr[i12]) {
                            return i8;
                        }
                        boolean z2 = i15 == i14;
                        if (i2 == i7) {
                    ...
                    int i18 = i6 + 1;
                    byte b = bArr2[i6] & Draft_75.END_OF_FRAME;
                    int i19 = i12 + i11;
                    while (i12 != i19) {
                        if (b == iArr[i12]) {
                            i = iArr[i12 + i11];
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if (this.size != 0) {
            ...
            if ((b3 & 128) == 0) {
                ...
                i = 1;
                b = 0;
            } else if ((b3 & Code.NEGFIXINT_PREFIX) == 192) {
                b2 = b3 & 31;
                i = 2;
                b = 128;
            } else if ((b3 & 240) == 224) {
