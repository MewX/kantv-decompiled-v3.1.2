...
public class FlutterFragment extends Fragment implements Host {
    ...
    public static class CachedEngineFragmentBuilder {
        ...
        public <T extends FlutterFragment> T build() {
            try {
                ...
                sb.append("The FlutterFragment subclass sent in the constructor (");
                sb.append(this.fragmentClass.getCanonicalName());
                sb.append(") does not match the expected return type.");
                throw new RuntimeException(sb.toString());
            } catch (Exception e) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append("Could not instantiate FlutterFragment subclass (");
    ...
    public static class NewEngineFragmentBuilder {
        ...
        public NewEngineFragmentBuilder() {
            this.dartEntrypoint = ConfigBuilder.DEFAULT_DART_ENTRYPOINT;
            this.initialRoute = "/";
    ...
    public String getDartEntrypointFunctionName() {
        return getArguments().getString(ARG_DART_ENTRYPOINT, ConfigBuilder.DEFAULT_DART_ENTRYPOINT);
    }
