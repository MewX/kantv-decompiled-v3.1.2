...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelFilterConditionalSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0007:
                r0 = 1
                io.reactivex.functions.Predicate r4 = r9.predicate     // Catch:{ Throwable -> 0x001b }
                boolean r2 = r4.test(r10)     // Catch:{ Throwable -> 0x001b }
            ...
            L_0x001b:
                ...
                r5 = 2
                io.reactivex.functions.BiFunction r6 = r9.errorHandler     // Catch:{ Throwable -> 0x0052 }
                r7 = 1
                long r2 = r2 + r7
                ...
                java.lang.Object r6 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, r7)     // Catch:{ Throwable -> 0x0052 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ Throwable -> 0x0052 }
    ...
    static final class ParallelFilterSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0007:
                r0 = 1
                io.reactivex.functions.Predicate r4 = r9.predicate     // Catch:{ Throwable -> 0x0017 }
                boolean r2 = r4.test(r10)     // Catch:{ Throwable -> 0x0017 }
            ...
            L_0x0017:
                ...
                io.reactivex.exceptions.Exceptions.throwIfFatal(r4)
                r5 = 2
                io.reactivex.functions.BiFunction r6 = r9.errorHandler     // Catch:{ Throwable -> 0x004e }
                r7 = 1
                long r2 = r2 + r7
                java.lang.Long r7 = java.lang.Long.valueOf(r2)     // Catch:{ Throwable -> 0x004e }
                java.lang.Object r6 = r6.apply(r7, r4)     // Catch:{ Throwable -> 0x004e }
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, r7)     // Catch:{ Throwable -> 0x004e }
                io.reactivex.parallel.ParallelFailureHandling r6 = (io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ Throwable -> 0x004e }
                int[] r7 = io.reactivex.internal.operators.parallel.ParallelFilterTry.AnonymousClass1.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r0) goto L_0x0007
