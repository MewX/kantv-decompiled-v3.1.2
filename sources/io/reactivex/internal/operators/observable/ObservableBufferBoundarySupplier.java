    ...
    static final class BufferBoundarySupplierObserver<T, U extends Collection<? super T>, B> extends QueueDrainObserver<T, U, U> implements Observer<T>, Disposable {
        ...
        public void next() {
            /*
                ...
                java.lang.Object r0 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r0, r1)     // Catch:{ Throwable -> 0x0051 }
                ...
                java.lang.Object r1 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r1, r2)     // Catch:{ Throwable -> 0x003f }
                io.reactivex.ObservableSource r1 = (io.reactivex.ObservableSource) r1     // Catch:{ Throwable -> 0x003f }
