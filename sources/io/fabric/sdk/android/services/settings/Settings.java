    ...
    public synchronized Settings initialize(Kit kit, IdManager idManager, HttpRequestFactory httpRequestFactory, String str, String str2, String str3) {
        ...
        synchronized (this) {
            ...
            if (this.settingsController == null) {
                ...
                String str6 = str2;
                String str7 = str;
                SettingsRequest settingsRequest = new SettingsRequest(value, modelName, str5, idManager.getOsDisplayVersionString(), idManager.getAppInstallIdentifier(), CommonUtils.createInstanceIdFrom(CommonUtils.resolveBuildId(context)), str6, str7, DeliveryMechanism.determineFrom(installerPackageName).getId(), appIconHashOrNull);
