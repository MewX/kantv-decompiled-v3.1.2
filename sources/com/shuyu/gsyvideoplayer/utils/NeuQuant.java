...
class NeuQuant {
    ...
    public void learn() {
        ...
        int i13 = 2048;
        while (i9 < i3) {
            int i14 = (bArr[i10 + 0] & Draft_75.END_OF_FRAME) << 4;
            int i15 = (bArr[i10 + 1] & Draft_75.END_OF_FRAME) << 4;
            int i16 = (bArr[i10 + 2] & Draft_75.END_OF_FRAME) << 4;
            int contest = contest(i14, i15, i16);
            int i17 = i16;
            int i18 = i15;
            int i19 = i14;
            altersingle(i11, contest, i14, i15, i17);
            if (i12 != 0) {
                alterneigh(i12, contest, i19, i18, i17);
            }
            i10 += i7;
            if (i10 >= i2) {
                i10 -= this.lengthcount;
            }
            i9++;
            if (i8 == 0) {
                i8 = 1;
