...
public abstract class GSYVideoControlView extends GSYVideoView implements OnClickListener, OnTouchListener, OnSeekBarChangeListener {
            ...
            if (GSYVideoControlView.this.mCurrentState != 0 && GSYVideoControlView.this.mCurrentState != 7 && GSYVideoControlView.this.mCurrentState != 6 && GSYVideoControlView.this.getActivityContext() != null) {
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    public void run() {
                        ...
                        GSYVideoControlView.this.setViewShowState(GSYVideoControlView.this.mLockScreen, 8);
    ...
    public boolean onTouch(android.view.View r7, android.view.MotionEvent r8) {
        ...
        L_0x0068:
            ...
            com.shuyu.gsyvideoplayer.utils.Debuger.printfLog(r7)
    ...
    public void touchSurfaceMove(float f, float f2, float f3) {
        ...
        } else if (!z && this.mBrightness && Math.abs(f2) > ((float) this.mThreshold)) {
    ...
    public void startProgressTimer() {
        ...
        this.updateProcessTimer.schedule(this.mProgressTimerTask, 0, 300);
    }
    ...
    public void startDismissControlViewTimer() {
        ...
        this.mDismissControlViewTimer.schedule(this.mDismissControlViewTimerTask, (long) this.mDismissControlTime);
    }
