...
public final class UrlImageViewHelper {
    ...
    public static android.graphics.Bitmap loadBitmapFromStream(android.content.Context r8, java.lang.String r9, java.lang.String r10, int r11, int r12) {
        ...
        L_0x00b1:
            ...
            r12.close()     // Catch:{ IOException -> 0x00b7 }
            goto L_0x00bb
        L_0x00b7:
            r9 = move-exception
            android.util.Log.w(r1, r0, r9)
    ...
    private static void setUrlDrawable(android.content.Context r20, android.widget.ImageView r21, java.lang.String r22, android.graphics.drawable.Drawable r23, long r24, com.koushikdutta.urlimageviewhelper.UrlImageViewCallback r26) {
        ...
        L_0x013b:
            ...
            boolean r0 = checkCacheDuration(r14, r10)     // Catch:{ Exception -> 0x01b2 }
            ...
            r0.append(r1)     // Catch:{ Exception -> 0x01b2 }
            r0.append(r8)     // Catch:{ Exception -> 0x01b2 }
            java.lang.String r1 = ". "
            r0.append(r1)     // Catch:{ Exception -> 0x01b2 }
            long r1 = java.lang.System.currentTimeMillis()     // Catch:{ Exception -> 0x01b2 }
            long r3 = r14.lastModified()     // Catch:{ Exception -> 0x01b2 }
            long r1 = r1 - r3
            r0.append(r1)     // Catch:{ Exception -> 0x01b2 }
            java.lang.String r1 = "ms old."
            r0.append(r1)     // Catch:{ Exception -> 0x01b2 }
            java.lang.String r0 = r0.toString()     // Catch:{ Exception -> 0x01b2 }
            java.lang.Object[] r1 = new java.lang.Object[r15]     // Catch:{ Exception -> 0x01b2 }
            clog(r0, r1)     // Catch:{ Exception -> 0x01b2 }
            com.koushikdutta.urlimageviewhelper.UrlImageViewHelper$3 r0 = new com.koushikdutta.urlimageviewhelper.UrlImageViewHelper$3     // Catch:{ Exception -> 0x01b2 }
            r4 = r17
            r5 = r19
            r0.<init>(r4, r13, r5)     // Catch:{ Exception -> 0x01b6 }
            executeTask(r0)     // Catch:{ Exception -> 0x01b6 }
            return
        L_0x01a6:
            r4 = r17
            r5 = r19
            java.lang.String r0 = "File cache has expired. Refreshing."
            java.lang.Object[] r1 = new java.lang.Object[r15]     // Catch:{ Exception -> 0x01b6 }
            clog(r0, r1)     // Catch:{ Exception -> 0x01b6 }
            goto L_0x01b6
        L_0x01b2:
            r4 = r17
            r5 = r19
        ...
        L_0x01dc:
            ...
            java.util.Hashtable<android.widget.ImageView, java.lang.String> r0 = mPendingViews
            r0.remove(r7)
            boolean r0 = r4 instanceof com.koushikdutta.urlimageviewhelper.UrlImageViewHelper.ZombieDrawable
            if (r0 == 0) goto L_0x01f1
            com.koushikdutta.urlimageviewhelper.UrlImageViewHelper$ZombieDrawable r4 = (com.koushikdutta.urlimageviewhelper.UrlImageViewHelper.ZombieDrawable) r4
            android.content.res.Resources r0 = mResources
            com.koushikdutta.urlimageviewhelper.UrlImageViewHelper$ZombieDrawable r0 = r4.clone(r0)
        L_0x01ef:
            r4 = r0
            goto L_0x01fb
        L_0x01f1:
