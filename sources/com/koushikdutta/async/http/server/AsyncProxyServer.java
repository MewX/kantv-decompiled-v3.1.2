...
public class AsyncProxyServer extends AsyncHttpServer {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:?, code lost:
        r6 = r7.getHeaders().get(org.eclipse.jetty.http.HttpHeaders.HOST);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x003f, code lost:
        ...
        r2.append(r1);
        r2.append(r0);
        r2.append(r7.getPath());
        r6 = android.net.Uri.parse(r2.toString());
     */
    ...
    public void onRequest(com.koushikdutta.async.http.server.HttpServerRequestCallback r6, com.koushikdutta.async.http.server.AsyncHttpServerRequest r7, final com.koushikdutta.async.http.server.AsyncHttpServerResponse r8) {
        ...
        L_0x0061:
            com.koushikdutta.async.http.AsyncHttpClient r0 = r5.proxyClient     // Catch:{ Exception -> 0x0079 }
            ...
            r0.execute(r1, r6)     // Catch:{ Exception -> 0x0079 }
            goto L_0x0086
        L_0x0079:
            r6 = move-exception
