...
abstract class HybiParser {
    ...
    public void parseOpcode(byte b) throws ProtocolError {
        boolean z = (b & 64) == 64;
        boolean z2 = (b & HttpTokens.SPACE) == 32;
        boolean z3 = (b & 16) == 16;
    ...
    private byte[] frame(int r22, byte[] r23, int r24, int r25, int r26) {
        ...
        L_0x00d2:
            ...
            int r2 = r1.length
            r3 = 0
            java.lang.System.arraycopy(r1, r3, r13, r10, r2)
            mask(r13, r1, r11)
        L_0x0126:
            return r13
        */
    ...
    public void emitFrame() throws IOException {
        ...
        if (i2 == 0) {
            ...
            if (mask.length >= 2) {
                i = (mask[1] & Draft_75.END_OF_FRAME) + ((mask[0] & Draft_75.END_OF_FRAME) * CacheManager.RESULT_SUCCESS);
            }
    ...
    private static long byteArrayToLong(byte[] bArr, int i, int i2) {
        if (bArr.length >= i2) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                j += (long) ((bArr[i3 + i] & Draft_75.END_OF_FRAME) << (((i2 - 1) - i3) * 8));
            }
            return j;
        }
