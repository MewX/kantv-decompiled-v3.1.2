...
public class HttpTransportMiddleware extends SimpleMiddleware {
    /* JADX WARNING: type inference failed for: r5v0, types: [com.koushikdutta.async.BufferedDataSink] */
    /* JADX WARNING: type inference failed for: r1v3, types: [com.koushikdutta.async.DataSink] */
    ...
    public boolean exchangeHeaders(final com.koushikdutta.async.http.AsyncHttpClientMiddleware.OnExchangeHeaderData r10) {
        ...
        L_0x00b6:
            ...
            r2.<init>(r0, r5)
            com.koushikdutta.async.Util.writeAll(r1, r3, r2)
