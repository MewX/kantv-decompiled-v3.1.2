...
public class Tencent {
    ...
    private static boolean a(Context context, String str) {
        String str2 = "openSDK_LOG.Tencent";
        try {
            ...
            try {
                ...
                sb3.append("AndroidManifest.xml 没有检测到com.tencent.connect.common.AssistActivity\n");
                sb3.append(sb2);
                f.e(str2, sb3.toString());
                return false;
            }
        } catch (NameNotFoundException unused2) {
            StringBuilder sb4 = new StringBuilder();
            sb4.append("没有在AndroidManifest.xml中检测到com.tencent.tauth.AuthActivity,请加上com.tencent.tauth.AuthActivity,并配置<data android:scheme=\"tencent");
            sb4.append(str);
            sb4.append("\" />,详细信息请查看官网文档.");
            ...
            sb6.append(str);
            sb6.append("\" />\n");
            sb6.append("</intent-filter>\n");
            sb6.append("</activity>");
            String sb7 = sb6.toString();
            StringBuilder sb8 = new StringBuilder();
            sb8.append("AndroidManifest.xml 没有检测到com.tencent.tauth.AuthActivity");
            sb8.append(sb7);
            f.e(str2, sb8.toString());
            return false;
        }
    }
    ...
    public int loginServerSide(Activity activity, String str, IUiListener iUiListener) {
        ...
        sb2.append(str);
        sb2.append(str2);
        return cVar.a(activity, sb2.toString(), iUiListener);
    }
    ...
    public int loginServerSide(Fragment fragment, String str, IUiListener iUiListener) {
        ...
        sb2.append(str);
        sb2.append(str2);
        return cVar.a(fragment, sb2.toString(), iUiListener, "");
    }
    ...
    public void setAccessToken(String str, String str2) {
        ...
        sb.append(str2);
        sb.append("");
        f.a("openSDK_LOG.Tencent", sb.toString());
        this.a.a(str, str2);
    }
    ...
    public boolean isSupportSSOLogin(Activity activity) {
        boolean z = true;
        if (k.d((Context) activity) && h.a((Context) activity, Constants.PACKAGE_QQ_PAD) != null) {
            return true;
        }
    ...
    public boolean joinQQGroup(Activity activity, String str) {
        ...
        if (!TextUtils.isEmpty(openId)) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append("&openid=");
            sb2.append(Base64.encodeToString(k.i(openId), 2));
