...
public final class videoinvitation {
    ...
    public static final class MsgBody extends MessageMicro<MsgBody> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42, 48, 58, 66};
            String[] strArr = {"int32_buss_type", "int32_auth_type", "uint32_auth_id", "uint32_sdk_appid", "bytes_buff", "int32_request_type", "msg_sender", "rpt_msg_receiver_list"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, valueOf, null, null}, MsgBody.class);
        }
    }
    ...
    public static final class ProcResult extends MessageMicro<ProcResult> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16}, new String[]{"msg_receiver_info", "int32_result"}, new Object[]{null, Integer.valueOf(0)}, ProcResult.class);
    ...
    public static final class RsqMsgBody extends MessageMicro<RsqMsgBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"rpt_msg_result"}, new Object[]{null}, RsqMsgBody.class);
    ...
    public static final class UserInfo extends MessageMicro<UserInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26}, new String[]{"bytes_appid", "bytes_openid", "bytes_acounttype"}, new Object[]{ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, UserInfo.class);
