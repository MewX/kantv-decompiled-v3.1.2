...
public final class userid_to_uin {
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26}, new String[]{"uidtype", "openappid", "openid"}, new Object[]{ByteStringMicro.EMPTY, Integer.valueOf(0), ByteStringMicro.EMPTY}, ReqBody.class);
