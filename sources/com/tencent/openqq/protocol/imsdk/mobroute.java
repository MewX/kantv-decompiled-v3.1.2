...
public final class mobroute {
    ...
    public static final class MobRouteSSOList extends MessageMicro<MobRouteSSOList> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"uint32_timeout", "vec_tcplist", "vec_httplist"}, new Object[]{Integer.valueOf(0), null, null}, MobRouteSSOList.class);
    ...
    public static final class MobRouteSSOListInfo extends MessageMicro<MobRouteSSOListInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16}, new String[]{"string_ip", "uint32_port"}, new Object[]{"", Integer.valueOf(0)}, MobRouteSSOListInfo.class);
    ...
    public static final class MobRouteSSOListReq extends MessageMicro<MobRouteSSOListReq> {
        ...
        public final PBStringField string_imsi;
        public final PBStringField string_uin;
        public final PBUInt32Field uint32_appid;
        public final PBUInt32Field uint32_nettype;
        public final PBUInt32Field uint32_uintype = PBField.initUInt32(0);

        public MobRouteSSOListReq() {
            String str = "";
            this.string_uin = PBField.initString(str);
            this.string_imsi = PBField.initString(str);
            this.uint32_nettype = PBField.initUInt32(0);
            this.uint32_appid = PBField.initUInt32(0);
            this.string_imei = PBField.initString(str);
        }

        static {
            int[] iArr = {8, 18, 26, 32, 40, 50};
            String[] strArr = {"uint32_uintype", "string_uin", "string_imsi", "uint32_nettype", "uint32_appid", "string_imei"};
            Integer valueOf = Integer.valueOf(0);
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, str, str, valueOf, valueOf, str}, MobRouteSSOListReq.class);
        }
    }
