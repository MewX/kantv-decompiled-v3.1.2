...
public final class common {
    ...
    public static final class CmdErrorCode extends MessageMicro<CmdErrorCode> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"uint32_code", "bytes_err_msg"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY}, CmdErrorCode.class);
