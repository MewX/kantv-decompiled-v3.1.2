...
public final class report_im_push {
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static {
            int[] iArr = {8, 16, 24, 34, 40, 48};
            String[] strArr = {"uint64_tinyid", "uint32_seq", "uint32_rand", "bytes_task_id", "uint32_report_type", "uint32_client_type"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf2, valueOf2, ByteStringMicro.EMPTY, valueOf2, valueOf2}, ReqBody.class);
        }
    }

    public static final class RspBody extends MessageMicro<RspBody> {
        public static final int UINT32_ERROR_CODE_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8}, new String[]{"uint32_error_code"}, new Object[]{Integer.valueOf(0)}, RspBody.class);
