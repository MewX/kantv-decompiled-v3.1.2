...
public final class sharp {
    ...
    public static final class RspBody extends MessageMicro<RspBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 32}, new String[]{"msg_cmd_error_code", "bytes_rsp_data", "uint64_uin_for_invite", "enum_uin_type_for_invite"}, new Object[]{null, ByteStringMicro.EMPTY, Long.valueOf(0), Integer.valueOf(1)}, RspBody.class);
