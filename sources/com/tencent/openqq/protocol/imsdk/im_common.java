...
public final class im_common {
    ...
    public static final class BladeSoulToken extends MessageMicro<BladeSoulToken> {
        ...
        static {
            ...
            String[] strArr = {"key_ver", "uin", "app_id", "key_time", "random"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, Long.valueOf(0), valueOf, valueOf, valueOf}, BladeSoulToken.class);
        }
    }
    ...
    public static final class GroupInfo extends MessageMicro<GroupInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16}, new String[]{"group_id", "group_type"}, new Object[]{Long.valueOf(0), Integer.valueOf(1)}, GroupInfo.class);
    ...
    public static final class Signature extends MessageMicro<Signature> {
        ...
        static {
            int[] iArr = {8, 16, 26};
            String[] strArr = {"key_type", "session_app_id", "session_key"};
            Integer valueOf = Integer.valueOf(0);
    ...
    public static final class Token extends MessageMicro<Token> {
        ...
        static {
            int[] iArr = {10, 16, 24, 34};
            String[] strArr = {"buf", "c2c_type", "service_type", "bytes_sigt"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, valueOf, valueOf, ByteStringMicro.EMPTY}, Token.class);
        }
    }
    ...
    public static final class User extends MessageMicro<User> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 45, 48, 58, 64, 72, 82};
            String[] strArr = {"uin", "app_id", "instance_id", "app_type", "client_ip", "version", "str_phone_number", "platform_id", IjkMediaMeta.IJKM_KEY_LANGUAGE, "equip_key"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, "", valueOf2, valueOf2, ByteStringMicro.EMPTY}, User.class);
        }
    }
