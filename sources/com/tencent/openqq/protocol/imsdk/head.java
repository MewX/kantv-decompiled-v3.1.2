...
public final class head {
    ...
    public static final class AndroidOfflineInfo extends MessageMicro<AndroidOfflineInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"bytes_sound"}, new Object[]{ByteStringMicro.EMPTY}, AndroidOfflineInfo.class);
    ...
    public static final class AnyConnC2CInfo extends MessageMicro<AnyConnC2CInfo> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32};
            String[] strArr = {"uint64_from_uin", "uint64_to_uin", "enum_from_node_type", "enum_to_node_type"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(1);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2}, AnyConnC2CInfo.class);
        }
    }
    ...
    public static final class ApnsOfflineInfo extends MessageMicro<ApnsOfflineInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16}, new String[]{"bytes_sound", "uint32_badge_mode"}, new Object[]{ByteStringMicro.EMPTY, Integer.valueOf(0)}, ApnsOfflineInfo.class);
        public final PBBytesField bytes_sound = PBField.initBytes(ByteStringMicro.EMPTY);
    ...
    public static final class C2CHead extends MessageMicro<C2CHead> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42, 50, 58, 64, 72, 80, 90};
            String[] strArr = {"uint64_to_uin", "uint64_from_uin", "uint32_cc_type", "uint32_cc_cmd", "bytes_auth_pic_sig", "bytes_auth_sig", "bytes_auth_buf", "uint32_server_time", "uint32_client_time", "uint32_rand", "string_phone_number"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf2, valueOf2, valueOf2, ""}, C2CHead.class);
        }
    }
    ...
    public static final class C2CInfo extends MessageMicro<C2CInfo> {
        ...
        static {
            int[] iArr = {8, 16, 26, 32, 40, 48, 56, 64, 74, 82, 88, 96};
            String[] strArr = {"uint64_from_uin", "uint64_to_uin", "bytes_from_uin_nick", "uint64_from_uin_binded", "enum_from_uin_type", "enum_to_uin_type", "uint64_to_uin_binded", "uint32_from_indentity_for_client", "msg_from_phoneinfo", "msg_to_phoneinfo", "enum_to_domain", "enum_to_uin_binded_type"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(1);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf2, valueOf2, valueOf, Integer.valueOf(0), null, null, valueOf2, valueOf2}, C2CInfo.class);
        }
    }
    ...
    public static final class C2CTempInfo extends MessageMicro<C2CTempInfo> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42, 48, 56, 64, 74, 82, 90, 96, 104};
            String[] strArr = {"uint64_from_uin", "uint64_to_uin", "enum_from_uin_type", "enum_to_uin_type", "bytes_from_uin_nick", "uint64_from_uin_binded", "uint64_to_uin_binded", "uint32_from_indentity_for_client", "msg_tmp_sig", "msg_from_phoneinfo", "msg_to_phoneinfo", "enum_to_domain", "enum_to_uin_binded_type"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(1);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2, ByteStringMicro.EMPTY, valueOf, valueOf, Integer.valueOf(0), null, null, null, valueOf2, valueOf2}, C2CTempInfo.class);
        }
    }
    ...
    public static final class C2SInfo extends MessageMicro<C2SInfo> {
        ...
        static {
            int[] iArr = {8, 16, 24};
            String[] strArr = {"uint64_from_uin", "enum_dest_svr_type", "enum_from_uin_type"};
            Integer valueOf = Integer.valueOf(1);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{Long.valueOf(0), valueOf, valueOf}, C2SInfo.class);
        }
    }
    ...
    public static final class CSHead extends MessageMicro<CSHead> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 56, 64, 72, 85, 88, 101, 104, 117, 120, 133, 136, Opcodes.FCMPL, 152, Opcodes.IF_ICMPNE, 168, 176, 184, 192};
            String[] strArr = {"uint64_uin", "uint32_command", "uint32_seq", "uint32_version", "uint32_retry_times", "uint32_client_type", "uint32_pubno", "uint32_localid", "uint32_timezone", "uint32_client_ip", "uint32_client_port", "uint32_conn_ip", "uint32_conn_port", "uint32_interface_ip", "uint32_interface_port", "uint32_actual_ip", "uint32_flag", "uint32_timestamp", "uint32_subcmd", "uint32_result", "uint32_app_id", "uint32_instance_id", "uint64_session_id", "uint32_idc_id"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf, valueOf2}, CSHead.class);
        }
    }
    ...
    public static final class ConfInfo extends MessageMicro<ConfInfo> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42, 48, 56, 66, 74, 82};
            String[] strArr = {"uint64_from_uin", "uint64_to_uin", "enum_from_uin_type", "enum_to_uin_type", "bytes_from_uin_nick", "uint64_conf_uin", "uint32_from_uin_image_id", "bytes_conf_name", "bytes_to_phone_number", "bytes_combined_conf_name"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(1);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2, ByteStringMicro.EMPTY, valueOf, Integer.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, ConfInfo.class);
        }
    }
    ...
    public static final class ContentHead extends MessageMicro<ContentHead> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 56, 64};
            String[] strArr = {"uint32_type", "uint32_subtype", "uint32_seq", "uint32_rand", "uint32_server_time", "uint32_client_time", "uint32_user_cmd", "uint32_server_seq"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf}, ContentHead.class);
        }
    }
    ...
    public static final class DeltaHead extends MessageMicro<DeltaHead> {
        ...
        static {
            int[] iArr = {8, 16, 24, 34, 42, 48, 56};
            String[] strArr = {"uint64_total_len", "uint64_offset", "uint64_ack_offset", "bytes_cookie", "bytes_ack_cookie", "uint32_result", "uint32_flags"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf2, valueOf2}, DeltaHead.class);
        }
    }
    ...
    public static final class GroupInfo extends MessageMicro<GroupInfo> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42, 48, 56, 66, 72, 80, 90, 98, 104, 114};
            String[] strArr = {"uint64_from_uin", "uint64_to_uin", "enum_from_uin_type", "enum_to_uin_type", "bytes_from_uin_nick", "uint64_group_uin", "uint64_group_code", "bytes_group_name", "uint64_from_uin_binded", "uint64_to_uin_binded", "bytes_from_uin_headurl", "bytes_group_id", "uint32_msg_flag", "msg_from_uin_extra_info"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(1);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2, ByteStringMicro.EMPTY, valueOf, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, Integer.valueOf(0), null}, GroupInfo.class);
        }
    }
    ...
    public static final class GroupOpenAppDefinedData extends MessageMicro<GroupOpenAppDefinedData> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"bytes_key", "bytes_value"}, new Object[]{ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, GroupOpenAppDefinedData.class);
    ...
    public static final class Head extends MessageMicro<Head> {
        ...
        static {
            int[] iArr = {8, 18, 26, 34, 40, 50, 58, 66, 74, 82, 90, 98};
            String[] strArr = {"uint32_head_type", "msg_cs_head", "msg_s2c_head", "msg_httpconn_head", "uint32_paint_flag", "msg_login_sig", "msg_delta_head", "msg_c2c_head", "msg_sconn_head", "msg_inst_ctrl", "msg_service_head", "msg_msg_head"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, null, null, null, valueOf, null, null, null, null, null, null, null}, Head.class);
        }
    }
    ...
    public static final class HttpConnHead extends MessageMicro<HttpConnHead> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 93, 96, 109, 112, AVException.INVALID_EMAIL_ADDRESS, 128, 136, 146, 152, Opcodes.IF_ICMPNE, 168, Opcodes.GETSTATIC};
            String[] strArr = {"uint64_uin", "uint32_command", "uint32_sub_command", "uint32_seq", "uint32_version", "uint32_retry_times", "uint32_client_type", "uint32_pub_no", "uint32_local_id", "uint32_time_zone", "uint32_client_ip", "uint32_client_port", "uint32_qzhttp_ip", "uint32_qzhttp_port", "uint32_spp_ip", "uint32_spp_port", "uint32_flag", "bytes_key", "uint32_compress_type", "uint32_origin_size", "uint32_error_code", "msg_redirect"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, ByteStringMicro.EMPTY, valueOf2, valueOf2, valueOf2, null}, HttpConnHead.class);
        }
    }

    public static final class InstCond extends MessageMicro<InstCond> {
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[0], new String[0], new Object[0], InstCond.class);
    }
    ...
    public static final class InstCtrl extends MessageMicro<InstCtrl> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26}, new String[]{"rpt_msg_send_to_inst", "rpt_msg_exclude_inst", "msg_from_inst"}, new Object[]{null, null, null}, InstCtrl.class);
    ...
    public static final class InstInfo extends MessageMicro<InstInfo> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 58, 64, 72, 80, 90};
            String[] strArr = {"uint32_apppid", "uint32_instid", "uint32_platform", "uint32_open_appid", "uint32_productid", "uint32_sso_bid", "bytes_guid", "uint32_ver_min", "uint32_ver_max", "enum_device_type", "bytes_platform_name"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf, Integer.valueOf(1), ByteStringMicro.EMPTY}, InstInfo.class);
        }
    }
    ...
    public static final class LoginSig extends MessageMicro<LoginSig> {
        ...
        static {
            int[] iArr = {8, 18, 24};
            String[] strArr = {"uint32_type", "bytes_sig", "uint32_app_id"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, ByteStringMicro.EMPTY, valueOf}, LoginSig.class);
        }
    }
    ...
    public static final class MsgDestroyTimeConfigInfo extends MessageMicro<MsgDestroyTimeConfigInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"msg_client_time_config", "msg_server_time_config"}, new Object[]{null, null}, MsgDestroyTimeConfigInfo.class);
    ...
    public static final class MsgDestroyTimeInfo extends MessageMicro<MsgDestroyTimeInfo> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32};
            String[] strArr = {"uint32_time_length", "uint32_set_time", "uint64_set_qcallid", "uint32_set_time_us"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, Long.valueOf(0), valueOf}, MsgDestroyTimeInfo.class);
        }
    }
    ...
    public static final class MsgEncryptInfo extends MessageMicro<MsgEncryptInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 24, 34}, new String[]{"uint32_encrypt_flag", "bytes_msg_digest", "uint64_auth_key_id", "bytes_auth_key"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY, Long.valueOf(0), ByteStringMicro.EMPTY}, MsgEncryptInfo.class);
    ...
    public static final class MsgExtraInfo extends MessageMicro<MsgExtraInfo> {
        ...
        static {
            int[] iArr = {8, 16, 26, 34, 40, 48, 56, 66, 72, 80, 90, 98, 104, 114, 122, 128};
            String[] strArr = {"uint32_notify_flag", "uint32_msg_lifetime", "msg_destroy_time_config", "msg_uin_extra_info", "uint32_place_msg", "uint32_msg_compatibility_type", "uint32_sync_from_old_system", "msg_encrypt_info", "uint32_mutli_inst_sync", "uint32_msg_priority", "bytes_identifier", "bytes_from_uin_nick", "uint64_stat_flag", "msg_offline_push_info", "bytes_push_task_id", "uint64_msg_id_crc"};
            Integer valueOf = Integer.valueOf(0);
            Long valueOf2 = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, null, null, valueOf, valueOf, valueOf, null, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf2, null, ByteStringMicro.EMPTY, valueOf2}, MsgExtraInfo.class);
        }
    }
    ...
    public static final class MsgHead extends MessageMicro<MsgHead> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34}, new String[]{"msg_content_head", "msg_routine_head", "msg_qqlogin_sig", "msg_extra_info"}, new Object[]{null, null, null, null}, MsgHead.class);
    ...
    public static final class MsgTransInfo extends MessageMicro<MsgTransInfo> {
        ...
        static {
            int[] iArr = {8, 16, 26};
            String[] strArr = {"trans_type", "trans_code", "trans_msg"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, ByteStringMicro.EMPTY}, MsgTransInfo.class);
        }
    }
    ...
    public static final class MultiCastInfo extends MessageMicro<MultiCastInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"msg_from_uin_info", "rpt_msg_to_uin_info"}, new Object[]{null, null}, MultiCastInfo.class);
    ...
    public static final class OfflinePushInfo extends MessageMicro<OfflinePushInfo> {
        ...
        static {
            int[] iArr = {10, 18, 26, 32, 40, 48, 56, 66, 74, 82};
            String[] strArr = {"bytes_desc", "bytes_ext", "bytes_sound", "uint32_push_flag", "rpt_uint32_apns_certs", "rpt_uint32_android_certs", "uint32_notify_mode", "bytes_title", "msg_apns_info", "msg_android_info"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, null, null}, OfflinePushInfo.class);
        }
    }
    ...
    public static final class PhoneInfo extends MessageMicro<PhoneInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26}, new String[]{"bytes_nation", "bytes_prefix", "bytes_uin_mobile"}, new Object[]{ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, PhoneInfo.class);
    ...
    public static final class QQLoginSig extends MessageMicro<QQLoginSig> {
        ...
        static {
            int[] iArr = {8, 16, 26, 32};
            String[] strArr = {"uint64_uin", "uint32_type", "bytes_sig", "uint32_appid"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf2, ByteStringMicro.EMPTY, valueOf2}, QQLoginSig.class);
        }
    }
    ...
    public static final class RedirectMsg extends MessageMicro<RedirectMsg> {
        ...
        static {
            int[] iArr = {13, 16, 29, 32, 40};
            String[] strArr = {"uint32_last_redirect_ip", "uint32_last_redirect_port", "uint32_redirect_ip", "uint32_redirect_port", "uint32_redirect_count"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf, valueOf}, RedirectMsg.class);
        }
    }
    ...
    public static final class RoutineHead extends MessageMicro<RoutineHead> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 42, 50, 58, 66}, new String[]{"msg_inst_ctrl", "msg_c2c_info", "msg_c2c_temp_info", "msg_group_info", "msg_conf_info", "msg_c2s_info", "msg_multi_cast_info", "msg_team_info"}, new Object[]{null, null, null, null, null, null, null, null}, RoutineHead.class);
    ...
    public static final class S2CHead extends MessageMicro<S2CHead> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 45, 48, 56, 64, 72, 80, 88};
            String[] strArr = {"uint32_sub_msgtype", "uint32_msg_type", "uint64_from_uin", "uint32_msg_id", "uint32_relay_ip", "uint32_relay_port", "uint64_to_uin", "uint32_server_time", "uint32_rand", "uint32_user_def_sub_cmd", "uint32_save_ctrl"};
            Integer valueOf = Integer.valueOf(0);
            Long valueOf2 = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf, valueOf, valueOf, valueOf2, valueOf, valueOf, valueOf, valueOf}, S2CHead.class);
        }
    }

    public static final class SConnHead extends MessageMicro<SConnHead> {
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[0], new String[0], new Object[0], SConnHead.class);
    }
    ...
    public static final class ServiceHead extends MessageMicro<ServiceHead> {
        ...
        static {
            int[] iArr = {8, 16, 24, 34, 42, 50, 56, 64};
            String[] strArr = {"enum_source_svr_type", "uint32_seq", "uint64_uin", "msg_from_inst", "string_service_cmd", "msg_sig", "uint32_client_ip", "uint32_client_port"};
            Integer valueOf = Integer.valueOf(1);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf2, Long.valueOf(0), null, "", null, valueOf2, valueOf2}, ServiceHead.class);
        }
    }
    ...
    public static final class Signature extends MessageMicro<Signature> {
        ...
        static {
            int[] iArr = {8, 16, 26};
            String[] strArr = {"uint32_key_type", "uint32_session_app_id", "bytes_session_key"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, ByteStringMicro.EMPTY}, Signature.class);
        }
    }
    ...
    public static final class TeamInfo extends MessageMicro<TeamInfo> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42, 48, 56, 66, 74, 82};
            String[] strArr = {"uint64_from_uin", "uint64_to_uin", "enum_from_uin_type", "enum_to_uin_type", "bytes_from_uin_nick", "uint64_team_uin", "uint32_from_uin_image_id", "bytes_conf_name", "bytes_from_uin_card_name", "bytes_to_phone_number"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(1);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2, ByteStringMicro.EMPTY, valueOf, Integer.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, TeamInfo.class);
        }
    }
    ...
    public static final class TermInfo extends MessageMicro<TermInfo> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40};
            String[] strArr = {"product", "device", "os", "version_no", "version_id"};
            Integer valueOf = Integer.valueOf(1);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf2, valueOf2}, TermInfo.class);
        }
    }
    ...
    public static final class TmpMsgToken extends MessageMicro<TmpMsgToken> {
        ...
        static {
            int[] iArr = {10, 16, 24};
            String[] strArr = {"bytes_buf", "uint32_c2c_type", "uint32_service_type"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, valueOf, valueOf}, TmpMsgToken.class);
        }
    }
    ...
    public static final class UinExtaInfo extends MessageMicro<UinExtaInfo> {
        ...
        static {
            int[] iArr = {8, 16, 26, 34, 42, 50};
            String[] strArr = {"uint32_msg_flag", "uint32_role", "bytes_name_card", "rpt_msg_app_defined_data_account", "rpt_msg_app_defined_data_group_member", "bytes_user_id"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, ByteStringMicro.EMPTY, null, null, ByteStringMicro.EMPTY}, UinExtaInfo.class);
        }
    }
    ...
    public static final class UinInfo extends MessageMicro<UinInfo> {
        ...
        public static final int UINT64_UIN_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26}, new String[]{"uint64_uin", "enum_uin_type", "msg_uin_extra_info"}, new Object[]{Long.valueOf(0), Integer.valueOf(1), null}, UinInfo.class);
