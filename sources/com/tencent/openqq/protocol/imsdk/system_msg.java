...
public final class system_msg {
    ...
    public static final class InviteQQToMultiSharp extends MessageMicro<InviteQQToMultiSharp> {
        ...
        static {
            int[] iArr = {8, 16};
            String[] strArr = {"uint64_conf_code", "rpt_uint64_uin_list"};
            Long valueOf = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf}, InviteQQToMultiSharp.class);
        }
    }
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26}, new String[]{"msg_msg_head", "uint32_op_type", "msg_invite_qq_info"}, new Object[]{null, Integer.valueOf(0), null}, ReqBody.class);
    ...
    public static final class RspBody extends MessageMicro<RspBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"msg_cmd_error_code"}, new Object[]{null}, RspBody.class);
