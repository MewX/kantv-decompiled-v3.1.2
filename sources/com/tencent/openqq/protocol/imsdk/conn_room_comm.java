...
public final class conn_room_comm {
    ...
    public static final class ConnRoomInfo extends MessageMicro<ConnRoomInfo> {
        ...
        static {
            ...
            String[] strArr = {"uint32_groupcode", "uint64_account", "uint32_room_num", "uint32_center_ip", "uint32_access_ip", "uint32_location_id", "uint32_terminal_type", "uint32_group_state", "uint32_share_type"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, Long.valueOf(0), valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf}, ConnRoomInfo.class);
        }
    }
    ...
    public static final class TransferReq extends MessageMicro<TransferReq> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"msg_conn_room_info"}, new Object[]{null}, TransferReq.class);
    ...
    public static final class TransferRes extends MessageMicro<TransferRes> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"msg_conned_room_info"}, new Object[]{null}, TransferRes.class);
