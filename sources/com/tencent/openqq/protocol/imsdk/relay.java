...
public final class relay {
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"sdkdata", "reqbody"}, new Object[]{null, ByteStringMicro.EMPTY}, ReqBody.class);
    ...
    public static final class RspBody extends MessageMicro<RspBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"enum_cmd_error_code", "rspbody"}, new Object[]{null, ByteStringMicro.EMPTY}, RspBody.class);
