...
public final class quality_report {
    ...
    public static final class CommonInfo extends MessageMicro<CommonInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26}, new String[]{"msg_device_info", "msg_system_info", "msg_network_info"}, new Object[]{null, null, null}, CommonInfo.class);
    ...
    public static final class DeviceInfo extends MessageMicro<DeviceInfo> {
        ...
        public final PBStringField str_device_board;
        public final PBStringField str_device_brand;
        public final PBStringField str_device_cpu_abi;
        public final PBStringField str_device_model;

        public DeviceInfo() {
            String str = "";
            this.str_device_brand = PBField.initString(str);
            this.str_device_model = PBField.initString(str);
            this.str_device_board = PBField.initString(str);
            this.str_device_cpu_abi = PBField.initString(str);
        }

        static {
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34, 42}, new String[]{"enum_device_type", "str_device_brand", "str_device_model", "str_device_board", "str_device_cpu_abi"}, new Object[]{Integer.valueOf(1), str, str, str, str}, DeviceInfo.class);
        }
    }
    ...
    public static final class NetworkInfo extends MessageMicro<NetworkInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8}, new String[]{"enum_network_type"}, new Object[]{Integer.valueOf(0)}, NetworkInfo.class);
    ...
    public static final class ReportContent extends MessageMicro<ReportContent> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"uint32_type", "bytes_report_data"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY}, ReportContent.class);
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42, 50};
            String[] strArr = {"uint32_sdkappid", "uint64_from_uin", "uint32_timestamp", "uint32_seq", "msg_common_info", "msg_report_content"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, Long.valueOf(0), valueOf, valueOf, null, null}, ReqBody.class);
        }
    }
    ...
    public static final class RspBody extends MessageMicro<RspBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"uint32_result", "str_err_msg"}, new Object[]{Integer.valueOf(0), ""}, RspBody.class);
    ...
    public static final class SystemInfo extends MessageMicro<SystemInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"enum_os_type", "str_os_version"}, new Object[]{Integer.valueOf(1), ""}, SystemInfo.class);
