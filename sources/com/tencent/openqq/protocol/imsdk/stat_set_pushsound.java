...
public final class stat_set_pushsound {
    ...
    public static final class Config extends MessageMicro<Config> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34}, new String[]{"uint32_openpush", "bytes_c2c_sound", "bytes_grp_sound", "bytes_video_sound"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, Config.class);
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"uint32_platform", "msg_config"}, new Object[]{Integer.valueOf(0), null}, ReqBody.class);
    ...
    public static final class RspBody extends MessageMicro<RspBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"enum_cmd_error_code"}, new Object[]{null}, RspBody.class);
