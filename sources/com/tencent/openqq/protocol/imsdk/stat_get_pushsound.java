...
public final class stat_get_pushsound {
    ...
    public static final class RspBody extends MessageMicro<RspBody> {
        ...
        public static final int UINT32_PLATFORM_FIELD_NUMBER = 2;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26}, new String[]{"enum_cmd_error_code", "uint32_platform", "msg_config"}, new Object[]{null, Integer.valueOf(0), null}, RspBody.class);
