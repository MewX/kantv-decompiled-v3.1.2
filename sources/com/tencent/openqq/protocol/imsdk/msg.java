...
public final class msg {
    ...
    public static final class AnonymousGroupMsg extends MessageMicro<AnonymousGroupMsg> {
        ...
        static {
            int[] iArr = {8, 18, 26, 32, 40, 48};
            String[] strArr = {"uint32_flags", "str_anon_id", "str_anon_nick", "uint32_head_portrait", "uint32_expire_time", "uint32_bubble_id"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf}, AnonymousGroupMsg.class);
        }
    }
    ...
    public static final class ApolloActMsg extends MessageMicro<ApolloActMsg> {
        ...
        static {
            int[] iArr = {8, 18, 26, 32, 40, 48, 56, 64, 72, 80, 90, 98, 106};
            String[] strArr = {"uint32_action_id", "bytes_action_name", "bytes_action_text", "uint32_flag", "uint32_peer_uin", "uint32_sender_ts", "uint32_peer_ts", "int32_sender_status", "int32_peer_status", "diytext_id", "diytext_content", "input_text", "bytes_pb_reserve"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, ApolloActMsg.class);
        }
    }
    ...
    public static final class ArkAppElem extends MessageMicro<ArkAppElem> {
        ...
        public final PBStringField min_version;
        public final PBStringField xml_template;

        public ArkAppElem() {
            String str = "";
            this.app_name = PBField.initString(str);
            this.min_version = PBField.initString(str);
            this.xml_template = PBField.initString(str);
        }

        static {
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34}, new String[]{"app_name", "min_version", "xml_template", "bytes_data"}, new Object[]{str, str, str, ByteStringMicro.EMPTY}, ArkAppElem.class);
        }
    }
    ...
    public static final class Attr extends MessageMicro<Attr> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 56, 64, 74, 82};
            String[] strArr = {"code_page", "time", "random", TtmlNode.ATTR_TTS_COLOR, "size", "effect", "char_set", "pitch_and_family", "font_name", "reserve_data"};
            Integer valueOf = Integer.valueOf(-1);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, Integer.valueOf(1), valueOf2, valueOf2, Integer.valueOf(10), Integer.valueOf(7), Integer.valueOf(78), Integer.valueOf(90), "Times New Roman", ByteStringMicro.EMPTY}, Attr.class);
        }
    }

    public static final class BitAppMsg extends MessageMicro<BitAppMsg> {
        public static final int BYTES_BUF_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"bytes_buf"}, new Object[]{ByteStringMicro.EMPTY}, BitAppMsg.class);
    ...
    public static final class BlessingMessage extends MessageMicro<BlessingMessage> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8}, new String[]{"uint32_msg_type"}, new Object[]{Integer.valueOf(0)}, BlessingMessage.class);
    ...
    public static final class CommonElem extends MessageMicro<CommonElem> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"uint32_service_type", "bytes_pb_elem"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY}, CommonElem.class);
    ...
    public static final class CrmElem extends MessageMicro<CrmElem> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24}, new String[]{"crm_buf", "bytes_msg_resid", "uint32_qidian_flag"}, new Object[]{ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, Integer.valueOf(0)}, CrmElem.class);
    ...
    public static final class CustomElem extends MessageMicro<CustomElem> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 34, 42}, new String[]{"bytes_desc", "bytes_data", "enum_type", "bytes_ext", "bytes_sound"}, new Object[]{ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, Integer.valueOf(1), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, CustomElem.class);
        public final PBBytesField bytes_data = PBField.initBytes(ByteStringMicro.EMPTY);
    ...
    public static final class CustomFace extends MessageMicro<CustomFace> {
        ...
        public CustomFace() {
            String str = "";
            this.str_file_path = PBField.initString(str);
            this.str_shortcut = PBField.initString(str);
            this.bytes_buffer = PBField.initBytes(ByteStringMicro.EMPTY);
            this.bytes_flag = PBField.initBytes(ByteStringMicro.EMPTY);
            this.bytes_old_data = PBField.initBytes(ByteStringMicro.EMPTY);
            ...
            this.bytes_md5 = PBField.initBytes(ByteStringMicro.EMPTY);
            this.str_thumb_url = PBField.initString(str);
            this.str_big_url = PBField.initString(str);
            this.str_orig_url = PBField.initString(str);
            ...
            this.str_400_url = PBField.initString(str);
        ...
        static {
            int[] iArr = {10, 18, 26, 34, 42, 50, 56, 64, 72, 80, 90, 96, 106, 114, 122, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, 136, IjkMediaMeta.FF_PROFILE_H264_HIGH_444, 152, Opcodes.IF_ICMPNE, 168, 176, 184, 192, 200, AVException.ACCOUNT_ALREADY_LINKED, 216, 224, 232, PsExtractor.VIDEO_STREAM_MASK, 250, 256, 264, MessageInfo.MSG_STATUS_DELETE};
            String[] strArr = {"bytes_guid", "str_file_path", "str_shortcut", "bytes_buffer", "bytes_flag", "bytes_old_data", "uint32_file_id", "uint32_server_ip", "uint32_server_port", "uint32_file_type", "bytes_signature", "uint32_useful", "bytes_md5", "str_thumb_url", "str_big_url", "str_orig_url", "biz_type", "repeat_index", "repeat_image", "image_type", Param.INDEX, "uint32_width", "uint32_height", "uint32_source", "uint32_size", "uint32_origin", "uint32_thumb_width", "uint32_thumb_height", "uint32_show_len", "uint32_download_len", "str_400_url", "uint32_400_width", "uint32_400_height", "bytes_pb_reserve"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, str, str, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, valueOf, ByteStringMicro.EMPTY, str, str, str, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, str, valueOf, valueOf, ByteStringMicro.EMPTY}, CustomFace.class);
        }
    }
    ...
    public static final class DeliverGiftMsg extends MessageMicro<DeliverGiftMsg> {
        ...
        static {
            int[] iArr = {10, 16, 26, 34, 42, 48, 56, 66, 72, 80, 90, 98, 106, 112, 122, 128, TsExtractor.TS_STREAM_TYPE_DTS, 146};
            String[] strArr = {"bytes_gray_tip_content", "uint32_animation_package_id", "bytes_animation_package_url_a", "bytes_animation_package_url_i", "bytes_remind_brief", "uint32_gift_id", "uint32_gift_count", "bytes_animation_brief", "uint64_sender_uin", "uint64_receiver_uin", "bytes_stmessage_title", "bytes_stmessage_subtitle", "bytes_stmessage_message", "uint32_stmessage_giftpicid", "bytes_stmessage_comefrom", "uint32_stmessage_exflag", "bytes_to_all_gift_id", "bytes_comefrom_link"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            Long valueOf2 = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, ByteStringMicro.EMPTY, valueOf2, valueOf2, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, ByteStringMicro.EMPTY, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, DeliverGiftMsg.class);
        }
    }
    ...
    public static final class EIMInfo extends MessageMicro<EIMInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16}, new String[]{"uint64_root_id", "uint32_flag"}, new Object[]{Long.valueOf(0), Integer.valueOf(0)}, EIMInfo.class);
        public final PBUInt32Field uint32_flag = PBField.initUInt32(0);
    ...
    public static final class ElemFlags2 extends MessageMicro<ElemFlags2> {
        ...
        public static final class Inst extends MessageMicro<Inst> {
            ...
            static {
                int[] iArr = {8, 16};
                String[] strArr = {"uint32_app_id", "uint32_inst_id"};
                Integer valueOf = Integer.valueOf(0);
                __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf}, Inst.class);
            }
        }

        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 58, 64, 74, 80, 88, 96, 106, 112};
            String[] strArr = {"uint32_color_text_id", "uint64_msg_id", "uint32_whisper_session_id", "uint32_ptt_change_bit", "uint32_vip_status", "uint32_compatible_id", "rpt_insts", "uint32_msg_rpt_cnt", "src_inst", "uint32_longtitude", "uint32_latitude", "uint32_custom_font", "pc_support_def", "uint32_crm_flags"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, Long.valueOf(0), valueOf, valueOf, valueOf, valueOf, null, valueOf, null, valueOf, valueOf, valueOf, null, valueOf}, ElemFlags2.class);
        }
    }
    ...
    public static final class ExtraInfo extends MessageMicro<ExtraInfo> {
        ...
        static {
            int[] iArr = {10, 18, 24, 32, 40, 48, 58, 66, 72, 80, 88};
            String[] strArr = {"bytes_nick", "bytes_group_card", "uint32_level", "uint32_flags", "uint32_group_mask", "uint32_msg_tail_id", "bytes_sender_title", "bytes_apns_tips", "uint64_uin", "uint32_msg_state_flag", "uint32_apns_sound_type"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, Long.valueOf(0), valueOf, valueOf}, ExtraInfo.class);
        }
    }
    ...
    public static final class Face extends MessageMicro<Face> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 90}, new String[]{Param.INDEX, "old", "buf"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, Face.class);
    ...
    public static final class FunFace extends MessageMicro<FunFace> {
        ...
        public static final class Turntable extends MessageMicro<Turntable> {
            ...
            static {
                int[] iArr = {8, 16, 26};
                String[] strArr = {"rpt_uint64_uin_list", "uint64_hit_uin", "str_hit_uin_nick"};
                Long valueOf = Long.valueOf(0);
                __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, ""}, Turntable.class);
            }
        }
    }
    ...
    public static final class GeneralFlags extends MessageMicro<GeneralFlags> {
        ...
        static {
            int[] iArr = {8, 16, 24, 34, 40, 48, 58, 64, 72, 80, 88, 96, 104, 114, 120, 128, 136, 146, Opcodes.IFNE};
            String[] strArr = {"uint32_bubble_diy_text_id", "uint32_group_flag_new", "uint64_uin", "bytes_rp_id", "uint32_prp_fold", "long_text_flag", "long_text_resid", "uint32_group_type", "uint32_to_uin_flag", "uint32_glamour_level", "uint32_member_level", "uint64_group_rank_seq", "uint32_olympic_torch", "babyq_guide_msg_cookie", "uin32_expert_flag", "uint32_bubble_sub_id", "uint64_pendant_id", "bytes_rp_index", "bytes_pb_reserve"};
            Integer valueOf = Integer.valueOf(0);
            Long valueOf2 = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, ByteStringMicro.EMPTY, valueOf, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, valueOf, valueOf2, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf2, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, GeneralFlags.class);
        }
    }
    ...
    public static final class GroupBusinessMsg extends MessageMicro<GroupBusinessMsg> {
        ...
        public static final int UINT32_FLAGS_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34, 42, 50, 58, 66}, new String[]{"uint32_flags", "bytes_head_url", "bytes_head_clk_url", "bytes_nick", "bytes_nick_color", "bytes_rank", "bytes_rank_color", "bytes_rank_bgcolor"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, GroupBusinessMsg.class);
    ...
    public static final class GroupFile extends MessageMicro<GroupFile> {
        ...
        static {
            int[] iArr = {10, 16, 26, 34, 42, 50, 56, 66, 72, 82};
            String[] strArr = {"bytes_filename", "uint64_file_size", "bytes_file_id", "bytes_batch_id", "bytes_file_key", "bytes_mark", "uint64_sequence", "bytes_batch_item_id", "uint32_feed_msg_time", "bytes_pb_reserve"};
            Long valueOf = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{ByteStringMicro.EMPTY, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, ByteStringMicro.EMPTY, Integer.valueOf(0), ByteStringMicro.EMPTY}, GroupFile.class);
        }
    }
    ...
    public static final class GroupPostElem extends MessageMicro<GroupPostElem> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"uint32_trans_type", "bytes_trans_msg"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY}, GroupPostElem.class);
    ...
    public static final class GroupPubAccountInfo extends MessageMicro<GroupPubAccountInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8}, new String[]{"uint64_pub_account"}, new Object[]{Long.valueOf(0)}, GroupPubAccountInfo.class);
    ...
    public static final class LifeOnlineAccount extends MessageMicro<LifeOnlineAccount> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 58, 66, 74};
            String[] strArr = {"uint64_unique_id", "uint32_op", "uint32_show_time", "uint32_report", "uint32_ack", "uint64_bitmap", "gdt_imp_data", "gdt_cli_data", "view_id"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf2, valueOf2, valueOf2, valueOf2, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, LifeOnlineAccount.class);
        }
    }
    ...
    public static final class LightAppElem extends MessageMicro<LightAppElem> {
        ...
        public static final int BYTES_MSG_RESID_FIELD_NUMBER = 2;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"bytes_data", "bytes_msg_resid"}, new Object[]{ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, LightAppElem.class);
        public final PBBytesField bytes_data = PBField.initBytes(ByteStringMicro.EMPTY);
        public final PBBytesField bytes_msg_resid = PBField.initBytes(ByteStringMicro.EMPTY);
    }
    ...
    public static final class LocationInfo extends MessageMicro<LocationInfo> {
        ...
        static {
            int[] iArr = {9, 17, 26};
            String[] strArr = {"double_longitude", "double_latitude", "bytes_desc"};
            Double valueOf = Double.valueOf(0.0d);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, ByteStringMicro.EMPTY}, LocationInfo.class);
        }
    }
    ...
    public static final class LolaMsg extends MessageMicro<LolaMsg> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34}, new String[]{"bytes_msg_resid", "bytes_encode_content", "bytes_long_msg_url", "bytes_download_key"}, new Object[]{ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, LolaMsg.class);
    ...
    public static final class LowVersionTips extends MessageMicro<LowVersionTips> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42};
            String[] strArr = {"uint32_business_id", "uint32_session_type", "uint64_session_uin", "uint64_sender_uin", "str_text"};
            Integer valueOf = Integer.valueOf(0);
            Long valueOf2 = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2, ""}, LowVersionTips.class);
        }
    }
    ...
    public static final class MarketFace extends MessageMicro<MarketFace> {
        ...
        static {
            int[] iArr = {10, 16, 24, 34, 40, 48, 58, 66, 72, 80, 88, 98, 106};
            String[] strArr = {"bytes_face_name", "uint32_item_type", "uint32_face_info", "bytes_face_id", "uint32_tab_id", "uint32_sub_type", "bytes_key", "bytes_param", "uint32_media_type", "uint32_image_width", "uint32_image_height", "bytes_mobileparam", "bytes_pb_reserve"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, valueOf, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, MarketFace.class);
        }
    }
    ...
    public static final class MarketTrans extends MessageMicro<MarketTrans> {
        ...
        static {
            int[] iArr = {8, 18, 26, 32, 40};
            String[] strArr = {"int32_flag", "bytes_xml", "bytes_msg_resid", "uint32_ability", "uint32_min_ability"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf}, MarketTrans.class);
        }
    }
    ...
    public static final class MsgBody extends MessageMicro<MsgBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26}, new String[]{"rich_text", "msg_content", "msg_encrypt_content"}, new Object[]{null, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, MsgBody.class);
    ...
    public static final class NearByMessageType extends MessageMicro<NearByMessageType> {
        ...
        static {
            int[] iArr = {8, 16};
            String[] strArr = {"uint32_type", "uint32_identify_type"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf}, NearByMessageType.class);
        }
    }
    ...
    public static final class NotOnlineFile extends MessageMicro<NotOnlineFile> {
        ...
        static {
            int[] iArr = {8, 18, 26, 34, 42, 48, 58, 64, 72, 80, 90, 96, 400, 408, 416, HttpStatus.FAILED_DEPENDENCY_424, 432, 440};
            String[] strArr = {"uint32_file_type", "bytes_sig", "bytes_file_uuid", "bytes_file_md5", "bytes_file_name", "uint64_file_size", "bytes_note", "uint32_reserved", "uint32_subcmd", "uint32_micro_cloud", "rpt_bytes_file_urls", "uint32_download_flag", "uint32_danger_evel", "uint32_life_time", "uint32_upload_time", "uint32_abs_file_type", "uint32_client_type", "uint32_expire_time"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, Long.valueOf(0), ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf}, NotOnlineFile.class);
        }
    }
    ...
    public static final class NotOnlineImage extends MessageMicro<NotOnlineImage> {
        ...
        public NotOnlineImage() {
            ...
            this.index = PBField.initUInt32(0);
            this.op_face_buf = PBField.initBytes(ByteStringMicro.EMPTY);
        ...
        static {
            int[] iArr = {10, 16, 26, 34, 40, 50, 58, 64, 72, 82, 90, 98, 104, 114, 122, 128, 136, IjkMediaMeta.FF_PROFILE_H264_HIGH_444, Opcodes.IFNE, Opcodes.IF_ICMPNE, 168, 176, 184, 192, 200, AVException.USERNAME_PASSWORD_MISMATCH, 216, 224, 234};
            String[] strArr = {"file_path", "file_len", "download_path", "old_ver_send_file", "img_type", "previews_image", "pic_md5", "pic_height", "pic_width", "res_id", "flag", "str_thumb_url", "original", "str_big_url", "str_orig_url", "biz_type", ConversationControlOp.MEMBER_COUNT_QUERY_RESULT, Param.INDEX, "op_face_buf", "old_pic_md5", "uint32_thumb_width", "uint32_thumb_height", "uint32_file_id", "uint32_show_len", "uint32_download_len", "str_400_url", "uint32_400_width", "uint32_400_height", "bytes_pb_reserve"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, str, valueOf, str, str, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, Boolean.valueOf(false), valueOf, valueOf, valueOf, valueOf, valueOf, str, valueOf, valueOf, ByteStringMicro.EMPTY}, NotOnlineImage.class);
        }
    }
    ...
    public static final class OpenQQData extends MessageMicro<OpenQQData> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"bytes_car_qq_data"}, new Object[]{ByteStringMicro.EMPTY}, OpenQQData.class);
    ...
    public static final class PatsElem extends MessageMicro<PatsElem> {
        ...
        static {
            int[] iArr = {8, 16};
            String[] strArr = {"uint32_pat_type", "uint32_pat_count"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf}, PatsElem.class);
        }
    }
    ...
    public static final class PcSupportDef extends MessageMicro<PcSupportDef> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48};
            String[] strArr = {"uint32_pc_ptl_begin", "uint32_pc_ptl_end", "uint32_mac_ptl_begin", "uint32_mac_ptl_end", "rpt_ptls_support", "rpt_ptls_not_support"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf, valueOf, valueOf}, PcSupportDef.class);
        }
    }
    ...
    public static final class Ptt extends MessageMicro<Ptt> {
        ...
        static {
            int[] iArr = {8, 16, 26, 34, 42, 48, 58, 64, 72, 80, 88, 98, 106, 114, 120, 128, TsExtractor.TS_STREAM_TYPE_DTS, 146, 152, 162, 232, 242, 250, 256};
            String[] strArr = {"uint32_file_type", "uint64_src_uin", "bytes_file_uuid", "bytes_file_md5", "bytes_file_name", "uint32_file_size", "bytes_reserve", "uint32_file_id", "uint32_server_ip", "uint32_server_port", "bool_valid", "bytes_signature", "bytes_shortcut", "bytes_file_key", "uint32_magic_ptt_index", "uint32_voice_switch", "bytes_ptt_url", "bytes_group_file_key", "uint32_time", "bytes_down_para", "uint32_format", "bytes_pb_reserve", "rpt_bytes_ptt_urls", "uint32_download_flag"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, Long.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, Boolean.valueOf(false), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, ByteStringMicro.EMPTY, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf}, Ptt.class);
        }
    }
    ...
    public static final class PubAccInfo extends MessageMicro<PubAccInfo> {
        ...
        public final PBStringField string_long_msg_url;
        public final PBStringField string_msg_template_id;
        public final PBUInt32Field uint32_is_inter_num = PBField.initUInt32(0);

        public PubAccInfo() {
            String str = "";
            this.string_msg_template_id = PBField.initString(str);
            this.string_long_msg_url = PBField.initString(str);
            this.bytes_download_key = PBField.initBytes(ByteStringMicro.EMPTY);
        }

        static {
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34}, new String[]{"uint32_is_inter_num", "string_msg_template_id", "string_long_msg_url", "bytes_download_key"}, new Object[]{Integer.valueOf(0), str, str, ByteStringMicro.EMPTY}, PubAccInfo.class);
        }
    }
    ...
    public static final class PubAccount extends MessageMicro<PubAccount> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16}, new String[]{"bytes_buf", "uint64_pub_account_uin"}, new Object[]{ByteStringMicro.EMPTY, Long.valueOf(0)}, PubAccount.class);
        public final PBBytesField bytes_buf = PBField.initBytes(ByteStringMicro.EMPTY);
    ...
    public static final class PubGroup extends MessageMicro<PubGroup> {
        ...
        static {
            int[] iArr = {10, 16, 24, 32};
            String[] strArr = {"bytes_nickname", "uint32_gender", "uint32_age", "uint32_distance"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, valueOf, valueOf, valueOf}, PubGroup.class);
        }
    }
    ...
    public static final class QQWalletAioBody extends MessageMicro<QQWalletAioBody> {
        ...
        static {
            int[] iArr = {8, 18, 26, 32, 40, 48, 56, 64, 74, 82, 88, 96, 104, 114, 120, 128, TsExtractor.TS_STREAM_TYPE_DTS, 146};
            String[] strArr = {"uint64_senduin", "sender", SocialConstants.PARAM_RECEIVER, "sint32_channelid", "sint32_templateid", "uint32_resend", "uint32_msg_priority", "sint32_redtype", "bytes_billno", "bytes_authkey", "sint32_sessiontype", "sint32_msgtype", "sint32_envelopeid", "bytes_name", "sint32_conftype", "sint32_msg_from", "bytes_pc_body", "string_index"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, null, null, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf2, valueOf2, valueOf2, ByteStringMicro.EMPTY, valueOf2, valueOf2, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, QQWalletAioBody.class);
        }
    }
    ...
    public static final class QQWalletAioElem extends MessageMicro<QQWalletAioElem> {
        ...
        static {
            int[] iArr = {8, 16, 26, 34, 42, 50, 58, 66, 72, 80, 90, 98, 106, 114, 122, 128, 136, 146, Opcodes.IFNE, 162};
            String[] strArr = {"uint32_background", "uint32_icon", "bytes_title", "bytes_subtitle", "bytes_content", "bytes_linkurl", "bytes_blackstripe", "bytes_notice", "uint32_title_color", "uint32_subtitle_color", "bytes_actions_priority", "bytes_jump_url", "bytes_native_ios", "bytes_native_android", "bytes_iconurl", "uint32_content_color", "uint32_content_bgcolor", "bytes_aio_image_left", "bytes_aio_image_right", "bytes_cft_image"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, QQWalletAioElem.class);
        }
    }
    ...
    public static final class RichMsg extends MessageMicro<RichMsg> {
        ...
        static {
            int[] iArr = {10, 16, 26, 32, 40, 48};
            String[] strArr = {"bytes_template_1", "uint32_service_id", "bytes_msg_resid", "uint32_rand", "uint32_seq", "uint32_flags"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf}, RichMsg.class);
        }
    }
    ...
    public static final class RichText extends MessageMicro<RichText> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 42, 50}, new String[]{Conversation.ATTRIBUTE, "elems", "not_online_file", "ptt", "tmp_ptt", "trans_211_tmp_msg"}, new Object[]{null, null, null, null, null, null}, RichText.class);
    ...
    public static final class SecretFileMsg extends MessageMicro<SecretFileMsg> {
        ...
        static {
            int[] iArr = {10, 16, 24, 32, 40, 48, 56, 64, 74, 80, 88, 98, 106, 112, 122};
            String[] strArr = {"bytes_file_key", "uint64_from_uin", "uint64_to_uin", "uint32_status", "uint32_ttl", "uint32_type", "uint32_encrypt_prehead_length", "uint32_encrypt_type", "bytes_encrypt_key", "uint32_read_times", "uint32_left_time", "not_online_image", "elem_flags2", "uint32_opertype", "str_fromphonenum"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            Long valueOf2 = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, valueOf2, valueOf2, valueOf, valueOf, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, valueOf, valueOf, null, null, valueOf, ""}, SecretFileMsg.class);
        }
    }
    ...
    public static final class ShakeWindow extends MessageMicro<ShakeWindow> {
        ...
        static {
            int[] iArr = {8, 16, 24};
            String[] strArr = {"uint32_type", "uint32_reserve", "uint64_uin"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, Long.valueOf(0)}, ShakeWindow.class);
        }
    }
    ...
    public static final class SourceMsg extends MessageMicro<SourceMsg> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42, 48, 58};
            String[] strArr = {"uint32_orig_seqs", "uint64_sender_uin", "uint32_time", "uint32_flag", "elems", "uint32_type", "bytes_richMsg"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, Long.valueOf(0), valueOf, valueOf, null, valueOf, ByteStringMicro.EMPTY}, SourceMsg.class);
        }
    }
    ...
    public static final class TipsInfo extends MessageMicro<TipsInfo> {
        public static final int TEXT_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{MimeTypes.BASE_TYPE_TEXT}, new Object[]{""}, TipsInfo.class);
    ...
    public static final class TmpPtt extends MessageMicro<TmpPtt> {
        ...
        static {
            int[] iArr = {8, 18, 26, 34, 40, 48, 56, 64, 72, 80, 242};
            String[] strArr = {"uint32_file_type", "bytes_file_uuid", "bytes_file_md5", "bytes_file_name", "uint32_file_size", "uint64_ptt_times", "uint32_user_type", "uint32_ptttrans_flag", "uint32_busi_type", "uint64_msg_id", "bytes_pb_reserve"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, valueOf, valueOf, Long.valueOf(0), ByteStringMicro.EMPTY}, TmpPtt.class);
        }
    }
    ...
    public static final class VideoFile extends MessageMicro<VideoFile> {
        ...
        static {
            int[] iArr = {10, 18, 26, 32, 40, 48, 56, 64, 74, 82, 88, 96, 104, 112, 120, 128, 136, IjkMediaMeta.FF_PROFILE_H264_HIGH_444, 152, 162, OpType.block_VALUE, 176, 184};
            String[] strArr = {"bytes_file_uuid", "bytes_file_md5", "bytes_file_name", "uint32_file_format", "uint32_file_time", "uint32_file_size", "uint32_thumb_width", "uint32_thumb_height", "bytes_thumb_file_md5", "bytes_source", "uint32_thumb_file_size", "uint32_busi_type", "uint32_from_chat_type", "uint32_to_chat_type", "bool_support_progressive", "uint32_file_width", "uint32_file_height", "uint32_sub_busi_type", "uint32_video_attr", "rpt_bytes_thumb_file_urls", "rpt_bytes_video_file_urls", "uint32_thumb_download_flag", "uint32_video_download_flag"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf, valueOf, valueOf, Boolean.valueOf(false), valueOf, valueOf, valueOf, valueOf, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf, valueOf}, VideoFile.class);
        }
    }
    ...
    public static final class WorkflowNotifyMsg extends MessageMicro<WorkflowNotifyMsg> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16}, new String[]{"bytes_ext_msg", "uint64_create_uin"}, new Object[]{ByteStringMicro.EMPTY, Long.valueOf(0)}, WorkflowNotifyMsg.class);
