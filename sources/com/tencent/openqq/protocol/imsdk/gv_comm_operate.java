...
import com.tencent.openqq.protocol.imsdk.conn_room_comm.TransferReq;
import com.tencent.openqq.protocol.imsdk.conn_room_comm.TransferRes;
import com.tencent.openqq.protocol.imsdk.conn_room_sig.ConnRoomSig;
...
public final class gv_comm_operate {
    ...
    public static final class ConnRoomReq_0xa extends MessageMicro<ConnRoomReq_0xa> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34}, new String[]{"uint32_conned_groupcode", "uint64_conned_account", "msg_conn_room_sig", "msg_transfer_req"}, new Object[]{Integer.valueOf(0), Long.valueOf(0), null, null}, ConnRoomReq_0xa.class);
        public ConnRoomSig msg_conn_room_sig = new ConnRoomSig();
        public TransferReq msg_transfer_req = new TransferReq();
    ...
    public static final class ConnRoomRsp_0xa extends MessageMicro<ConnRoomRsp_0xa> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"msg_transfer_res"}, new Object[]{null}, ConnRoomRsp_0xa.class);
        public TransferRes msg_transfer_res = new TransferRes();
    }
    ...
    public static final class GVCommOprHead extends MessageMicro<GVCommOprHead> {
        ...
        public final PBBytesField bytes_cookie_buff;
        public final PBRepeatMessageField<RelayInfo> rpt_relay_info = PBField.initRepeatMessage(RelayInfo.class);
        public final PBRepeatField<Long> rpt_to_Account;
        public final PBRepeatField<String> rpt_to_openid;
        public final PBRepeatField<Long> rpt_to_uin;
        public final PBStringField str_av_token;
        public final PBStringField str_client_version;
        public final PBStringField str_error_msg;
        public final PBStringField str_openid;
        ...
        public final PBUInt32Field uint32_sdk_appid;
        public final PBUInt32Field uint32_seq = PBField.initUInt32(0);
        public final PBUInt32Field uint32_sub_cmd = PBField.initUInt32(0);
        public final PBUInt32Field uint32_terminal_type;
        public final PBUInt64Field uint64_uin = PBField.initUInt64(0);

        public GVCommOprHead() {
            String str = "";
            this.str_error_msg = PBField.initString(str);
            this.uint32_sdk_appid = PBField.initUInt32(0);
            this.str_av_token = PBField.initString(str);
            this.rpt_to_uin = PBField.initRepeat(PBUInt64Field.__repeatHelper__);
            this.str_openid = PBField.initString(str);
            this.rpt_to_openid = PBField.initRepeat(PBStringField.__repeatHelper__);
            this.bytes_cookie_buff = PBField.initBytes(ByteStringMicro.EMPTY);
            this.uint32_terminal_type = PBField.initUInt32(0);
            this.str_client_version = PBField.initString(str);
            this.rpt_to_Account = PBField.initRepeat(PBUInt64Field.__repeatHelper__);
        }

        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 58, 64, 74, 80, 90, 96, 162, OpType.block_VALUE, Opcodes.GETSTATIC, 184, 194, 200};
            String[] strArr = {"uint32_sub_cmd", "uint32_seq", "uint32_buss_type", "uint32_auth_type", "uint32_auth_key", "uint64_uin", "rpt_relay_info", "uint32_result", "str_error_msg", "uint32_sdk_appid", "str_av_token", "rpt_to_uin", "str_openid", "rpt_to_openid", "bytes_cookie_buff", "uint32_terminal_type", "str_client_version", "rpt_to_Account"};
            Integer valueOf = Integer.valueOf(0);
            Long valueOf2 = Long.valueOf(0);
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf, valueOf, valueOf2, null, valueOf, str, valueOf, str, valueOf2, str, str, ByteStringMicro.EMPTY, valueOf, str, valueOf2}, GVCommOprHead.class);
        }
    }
    ...
    public static final class LiveUrl extends MessageMicro<LiveUrl> {
        ...
        static {
            int[] iArr = {8, 18, 24};
            String[] strArr = {"uint32_type", "string_play_url", "rate_type"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, "", valueOf}, LiveUrl.class);
        }
    }
    ...
    public static final class RelayInfo extends MessageMicro<RelayInfo> {
        ...
        static {
            int[] iArr = {8, 16, 26};
            String[] strArr = {"uint32_client_ip", "uint32_client_port", "bytes_context"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, ByteStringMicro.EMPTY}, RelayInfo.class);
        }
    }
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 42, 50, 58, 66, 74, 82, 810}, new String[]{"req_0x1", "req_0x2", "req_0x3", "req_0x4", "req_0x5", "req_0x6", "req_0x7", "req_0x8", "req_0x9", "req_0xa", "req_0x101"}, new Object[]{null, null, null, null, null, null, null, null, null, null, null}, ReqBody.class);
    ...
    public static final class RspBody extends MessageMicro<RspBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 42, 50, 58, 66, 74, 82, 810}, new String[]{"rsp_0x1", "rsp_0x2", "rsp_0x3", "rsp_0x4", "rsp_0x5", "rsp_0x6", "rsp_0x7", "rsp_0x8", "rsp_0x9", "rsp_0xa", "rsp_0x101"}, new Object[]{null, null, null, null, null, null, null, null, null, null, null}, RspBody.class);
    ...
    public static final class SpeedAccessInf extends MessageMicro<SpeedAccessInf> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 56, 64, 72};
            String[] strArr = {"access_ip", "access_port", "access_isp", "access_country", "access_prov", "test_cnt", "test_gap", "test_timeout", "test_pkg_size"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf}, SpeedAccessInf.class);
        }
    }
    ...
    public static final class SpeedResultReportReq_0x9 extends MessageMicro<SpeedResultReportReq_0x9> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 50, 58, 65, 73, 80, 88, 96, 104, 114, 120, 128, 136};
            String[] strArr = {"test_id", "test_time", "roomid", "client_type", "net_type", "net_name", "wifi_name", "longitude", "latitude", "client_ip", "call_type", "sdkappid", "test_type", ConversationControlOp.QUERY_RESULT, "net_changecnt", "access_ip", "access_port"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            Double valueOf3 = Double.valueOf(0.0d);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf2, valueOf2, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, valueOf3, valueOf3, valueOf2, valueOf2, valueOf2, valueOf2, null, valueOf2, valueOf2, valueOf2}, SpeedResultReportReq_0x9.class);
        }
    }

    public static final class SpeedResultReportRsp_0x9 extends MessageMicro<SpeedResultReportRsp_0x9> {
        public static final int TEST_ID_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8}, new String[]{"test_id"}, new Object[]{Long.valueOf(0)}, SpeedResultReportRsp_0x9.class);
        public final PBUInt64Field test_id = PBField.initUInt64(0);
    }
    ...
    public static final class SpeedTestHeadPkt extends MessageMicro<SpeedTestHeadPkt> {
        ...
        static {
            ...
            String[] strArr = {"test_id", "uin", "sdkappid", "seq", "timestamp", "buss_type", "access_client_ip", "up_seq"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2, valueOf, valueOf2, valueOf2, valueOf2}, SpeedTestHeadPkt.class);
        }
    }
    ...
    public static final class SpeedTestReq_0x8 extends MessageMicro<SpeedTestReq_0x8> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 56, 66};
            String[] strArr = {"roomid", "call_type", "net_type", "client_type", "support_type", "test_purpose", "os_type", "os_version"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2, valueOf2, valueOf2, valueOf2, ByteStringMicro.EMPTY}, SpeedTestReq_0x8.class);
        }
    }
    ...
    public static final class SpeedTestResult extends MessageMicro<SpeedTestResult> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120, 128, 136, IjkMediaMeta.FF_PROFILE_H264_HIGH_444, 152, Opcodes.IF_ICMPNE, 168, 176, 184, 192, 200, AVException.ACCOUNT_ALREADY_LINKED, 216, 224, 232, PsExtractor.VIDEO_STREAM_MASK, 248, 256, 264, 272, 280, 288, 296, 304, 312};
            String[] strArr = {"access_ip", "access_port", "clientip", "test_cnt", "test_pkg_size", "avg_rtt", "max_rtt", "min_rtt", "rtt0_50", "rtt50_100", "rtt100_200", "rtt200_300", "rtt300_700", "rtt700_1000", "rtt1000", "jitter0_20", "jitter20_50", "jitter50_100", "jitter100_200", "jitter200_300", "jitter300_500", "jitter500_800", "jitter800", "t1_uploss", "t1_dwloss", "up_cons_loss0", "up_cons_loss1", "up_cons_loss2", "up_cons_loss3", "up_cons_lossb3", "dw_cons_loss0", "dw_cons_loss1", "dw_cons_loss2", "dw_cons_loss3", "dw_cons_lossb3", "up_disorder", "dw_disorder", "up_seq", "dw_seq"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf}, SpeedTestResult.class);
        }
    }
    ...
    public static final class SpeedTestRsp_0x8 extends MessageMicro<SpeedTestRsp_0x8> {
        ...
        static {
            ...
            String[] strArr = {"client_ip", "test_id", ConversationControlOp.MEMBER_COUNT_QUERY_RESULT, "test_type", "access_list"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, Long.valueOf(0), valueOf, valueOf, null}, SpeedTestRsp_0x8.class);
        }
    }
    ...
    public static final class SubReq_0x1 extends MessageMicro<SubReq_0x1> {
        ...
        static {
            int[] iArr = {8, 16, 24};
            String[] strArr = {"uint32_room_num", "uint32_delete_type", "rpt_uins"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, Long.valueOf(0)}, SubReq_0x1.class);
        }
    }
    ...
    public static final class SubReq_0x101 extends MessageMicro<SubReq_0x101> {
        ...
        static {
            int[] iArr = {8, 16, 26};
            String[] strArr = {"uint32_client_ip", "uint32_client_port", "bytes_buff"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, ByteStringMicro.EMPTY}, SubReq_0x101.class);
        }
    }
    ...
    public static final class SubReq_0x2 extends MessageMicro<SubReq_0x2> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 42};
            String[] strArr = {"uint32_room_num", "uint64_privilege_map", "uint32_set_priv_type", "rpt_uins", "str_privilege_map"};
            Integer valueOf = Integer.valueOf(0);
            Long valueOf2 = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf2, valueOf, valueOf2, ""}, SubReq_0x2.class);
        }
    }
    ...
    public static final class SubReq_0x3 extends MessageMicro<SubReq_0x3> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32};
            String[] strArr = {"uint32_room_num", "uint32_op_type", "uint32_recv_ip", "uint32_recv_port"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, valueOf}, SubReq_0x3.class);
        }
    }
    ...
    public static final class SubReq_0x5 extends MessageMicro<SubReq_0x5> {
        ...
        static {
            int[] iArr = {8, 16, 26, 34, 40, 48, 56, 64, 72, 80, 88, 96};
            String[] strArr = {"uint32_oper", "uint32_seq", "string_file_name", "string_tags", "uint32_classid", "uint32_IsTransCode", "uint32_IsScreenShot", "uint32_IsWaterMark", "uint32_sdk_type", "uint32_record_data_type", "uint32_record_appid", "uint32_record_type"};
            Integer valueOf = Integer.valueOf(0);
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, str, str, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf}, SubReq_0x5.class);
        }
    }
    ...
    public static final class SubReq_0x6 extends MessageMicro<SubReq_0x6> {
        ...
        static final FieldMap __fieldMap__;
        public final PBRepeatField<Integer> rpt_rate_type;
        public final PBStringField str_channel_describe;
        public final PBStringField str_channel_name;
        public final PBStringField str_player_pwd;
        public final PBStringField str_stream_id;
        public final PBUInt32Field uint32_live_code = PBField.initUInt32(0);
        public final PBUInt32Field uint32_oper = PBField.initUInt32(0);
        public final PBUInt32Field uint32_push_data_type;
        public final PBUInt32Field uint32_push_duration;
        public final PBUInt32Field uint32_push_flag;
        public final PBUInt32Field uint32_push_ip;
        public final PBUInt32Field uint32_push_port;
        public final PBUInt32Field uint32_record_type;
        public final PBUInt32Field uint32_reset_mod;
        public final PBUInt32Field uint32_room_id;
        public final PBUInt32Field uint32_sdk_type = PBField.initUInt32(0);
        public final PBUInt32Field uint32_tape_flag;
        public final PBUInt32Field uint32_watermark_flag;
        public final PBUInt32Field uint32_watermark_id;
        public final PBRepeatField<Long> uint64_channel_id;

        public SubReq_0x6() {
            String str = "";
            this.str_channel_name = PBField.initString(str);
            this.str_channel_describe = PBField.initString(str);
            this.str_player_pwd = PBField.initString(str);
            this.uint64_channel_id = PBField.initRepeat(PBUInt64Field.__repeatHelper__);
            this.uint32_push_data_type = PBField.initUInt32(0);
            this.uint32_tape_flag = PBField.initUInt32(0);
            this.uint32_push_duration = PBField.initUInt32(0);
            this.uint32_watermark_flag = PBField.initUInt32(0);
            this.uint32_watermark_id = PBField.initUInt32(0);
            this.rpt_rate_type = PBField.initRepeat(PBEnumField.__repeatHelper__);
            this.uint32_record_type = PBField.initUInt32(0);
            this.uint32_push_ip = PBField.initUInt32(0);
            this.uint32_push_port = PBField.initUInt32(0);
            this.uint32_room_id = PBField.initUInt32(0);
            this.uint32_reset_mod = PBField.initUInt32(0);
            this.str_stream_id = PBField.initString(str);
            this.uint32_push_flag = PBField.initUInt32(0);
        }

        static {
            int[] iArr = {8, 16, 24, 34, 42, 50, 56, 64, 72, 80, 88, 96, 104, 112, 120, 128, 136, IjkMediaMeta.FF_PROFILE_H264_HIGH_444, Opcodes.IFNE, Opcodes.IF_ICMPNE};
            String[] strArr = {"uint32_oper", "uint32_live_code", "uint32_sdk_type", "str_channel_name", "str_channel_describe", "str_player_pwd", "uint64_channel_id", "uint32_push_data_type", "uint32_tape_flag", "uint32_push_duration", "uint32_watermark_flag", "uint32_watermark_id", "rpt_rate_type", "uint32_record_type", "uint32_push_ip", "uint32_push_port", "uint32_room_id", "uint32_reset_mod", "str_stream_id", "uint32_push_flag"};
            Integer valueOf = Integer.valueOf(0);
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, str, str, str, Long.valueOf(0), valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, valueOf, str, valueOf}, SubReq_0x6.class);
        }
    }
    ...
    public static final class SubRsp_0x5 extends MessageMicro<SubRsp_0x5> {
        ...
        static {
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"uint32_result", "str_errorinfo", "str_fileID"}, new Object[]{Integer.valueOf(0), str, str}, SubRsp_0x5.class);
        }
    }
    ...
    public static final class SubRsp_0x6 extends MessageMicro<SubRsp_0x6> {
        ...
        static {
            ...
            String[] strArr = {"uint32_result", "msg_live_url", "str_errorinfo", "uint64_channel_id", "uint32_tape_task_id"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, null, "", Long.valueOf(0), valueOf}, SubRsp_0x6.class);
        }
    }
