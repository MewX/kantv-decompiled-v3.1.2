...
public final class group_video_info {
    ...
    public static final class GroupVideoInfoBodyReq extends MessageMicro<GroupVideoInfoBodyReq> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32, 40, 50, 58};
            String[] strArr = {"uint32_buss_type", "uint32_auth_type", "uint32_auth_key", "uint64_uin", "uint32_sdk_appid", "msg_record_req", "msg_push_req"};
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, Long.valueOf(0), valueOf, null, null}, GroupVideoInfoBodyReq.class);
        }
    }
    ...
    public static final class GroupVideoInfoBodyRes extends MessageMicro<GroupVideoInfoBodyRes> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"msg_record_res", "msg_push_res"}, new Object[]{null, null}, GroupVideoInfoBodyRes.class);
    ...
    public static final class LiveUrl extends MessageMicro<LiveUrl> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"uint32_type", "string_play_url"}, new Object[]{Integer.valueOf(0), ""}, LiveUrl.class);
    ...
    public static final class VideoPushReq extends MessageMicro<VideoPushReq> {
        ...
        static {
            int[] iArr = {8, 16, 24, 34, 42, 50, 56};
            String[] strArr = {"uint32_oper", "uint32_live_code", "uint32_sdk_type", "str_channel_name", "str_channel_describe", "str_player_pwd", "uint64_channel_id"};
            Integer valueOf = Integer.valueOf(0);
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf, str, str, str, Long.valueOf(0)}, VideoPushReq.class);
        }
    }
    ...
    public static final class VideoPushRes extends MessageMicro<VideoPushRes> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32}, new String[]{"uint32_result", "msg_live_url", "str_errorinfo", "uint64_channel_id"}, new Object[]{Integer.valueOf(0), null, "", Long.valueOf(0)}, VideoPushRes.class);
    ...
    public static final class VideoRecordReq extends MessageMicro<VideoRecordReq> {
        ...
        static {
            int[] iArr = {8, 16, 26, 34, 40, 48, 56, 64, 72};
            String[] strArr = {"uint32_oper", "uint32_seq", "string_file_name", "string_tags", "uint32_classid", "uint32_IsTransCode", "uint32_IsScreenShot", "uint32_IsWaterMark", "uint32_sdk_type"};
            Integer valueOf = Integer.valueOf(0);
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, str, str, valueOf, valueOf, valueOf, valueOf, valueOf}, VideoRecordReq.class);
        }
    }
    ...
    public static final class VideoRecordRes extends MessageMicro<VideoRecordRes> {
        ...
        static {
            String str = "";
            __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"uint32_result", "str_errorinfo", "str_fileID"}, new Object[]{Integer.valueOf(0), str, str}, VideoRecordRes.class);
        }
    }
