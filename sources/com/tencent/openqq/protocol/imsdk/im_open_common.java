...
public final class im_open_common {
    ...
    public static final class FriendInfo extends MessageMicro<FriendInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{18, 26, 34, 40, 50, 58, 66}, new String[]{"openid", "nick", "avatarurl", "gender", "country", UserPreference.PROVINCE, UserPreference.CITY}, new Object[]{ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, Integer.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, FriendInfo.class);
    ...
    public static final class IMUserId extends MessageMicro<IMUserId> {
        ...
        static {
            int[] iArr = {10, 16, 26, 32, 40};
            String[] strArr = {"uidtype", "userappid", "userid", "tinyid", "uin"};
            Long valueOf = Long.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{ByteStringMicro.EMPTY, Integer.valueOf(0), ByteStringMicro.EMPTY, valueOf, valueOf}, IMUserId.class);
        }
    }
    ...
    public static final class SdkData extends MessageMicro<SdkData> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"sdkappid", "sdkapptoken"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY}, SdkData.class);
    ...
    public static final class UserId extends MessageMicro<UserId> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24}, new String[]{"openid", "uin", "uin_type"}, new Object[]{ByteStringMicro.EMPTY, Long.valueOf(0), Integer.valueOf(0)}, UserId.class);
        public final PBBytesField openid = PBField.initBytes(ByteStringMicro.EMPTY);
        public final PBUInt64Field uin = PBField.initUInt64(0);
    ...
    public static final class UserStatus extends MessageMicro<UserStatus> {
        ...
        static {
            int[] iArr = {10, 16, 24};
            String[] strArr = {"openid", "status", "network_type"};
            ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
            Integer valueOf = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{byteStringMicro, valueOf, valueOf}, UserStatus.class);
        }
    }
