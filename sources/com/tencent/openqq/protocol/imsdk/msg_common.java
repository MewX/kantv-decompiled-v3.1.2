...
import com.tencent.openqq.protocol.imsdk.head.Head;
...
public final class msg_common {
    ...
    public static final class MsgKey extends MessageMicro<MsgKey> {
        ...
        static {
            int[] iArr = {8, 16, 24, 32};
            String[] strArr = {"uint64_from_uin", "uint64_to_uin", "uint32_seq", "uint32_rand"};
            Long valueOf = Long.valueOf(0);
            Integer valueOf2 = Integer.valueOf(0);
            __fieldMap__ = MessageMicro.initFieldMap(iArr, strArr, new Object[]{valueOf, valueOf, valueOf2, valueOf2}, MsgKey.class);
        }
    }
