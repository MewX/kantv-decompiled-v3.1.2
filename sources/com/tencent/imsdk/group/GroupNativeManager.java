...
public class GroupNativeManager {
    ...
    protected static native void nativeGetGroupMembersByFilter(@NonNull String str, long j, @NonNull long j2, List<String> list, long j3, ICallback iCallback);
    ...
    public static native void nativeInitGroupModule();
