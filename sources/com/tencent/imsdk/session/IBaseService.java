...
public interface IBaseService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBaseService {
        private static final String DESCRIPTOR = "com.tencent.imsdk.session.IBaseService";
        ...
        private static class Proxy implements IBaseService {
            ...
            public void init(IWrapperCallback iWrapperCallback) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(iWrapperCallback != null ? iWrapperCallback.asBinder() : null);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                init(com.tencent.imsdk.session.IWrapperCallback.Stub.asInterface(parcel.readStrongBinder()));
    ...
    void init(IWrapperCallback iWrapperCallback) throws RemoteException;
