...
public class MarketService {
    ...
    public void showUpdateDialog(JSONObject jSONObject) {
        if (jSONObject != null && this.version == null && isActive()) {
            ...
            String optString = optJSONObject.optString(ConversationControlOp.UPDATE, "Update");
            String optString2 = optJSONObject.optString(Conversation.QUERY_PARAM_OFFSET, "Skip");
