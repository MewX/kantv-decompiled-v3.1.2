...
public class GoogleHandle extends AccountHandle implements OnClickListener, OnCancelListener {
    ...
    public GoogleHandle(Activity activity, String str, String str2) {
        if (Constants.ACTIVE_ACCOUNT.equals(str2)) {
    ...
    public void auth() {
        if (this.email == null) {
            ...
            Account[] accountsByType = this.am.getAccountsByType(AccountType.GOOGLE);
    ...
    private void accountDialog() {
        ...
        this.accs = this.am.getAccountsByType(AccountType.GOOGLE);
