...
public abstract class AbstractAQuery<T extends AbstractAQuery<T>> implements Constants {
    ...
    public T create(View view2) {
        T t = null;
        try {
            T t2 = (AbstractAQuery) getConstructor().newInstance(new Object[]{view2});
            try {
                t2.act = this.act;
                return t2;
            } catch (Exception e) {
    ...
    public T parent(int r3) {
        ...
        L_0x0017:
            r0 = 0
        L_0x0018:
            com.androidquery.AbstractAQuery r3 = r2.create(r0)
            return r3
        */
    ...
    public T image(String str, boolean z, boolean z2, int i, int i2, Bitmap bitmap, int i3, float f, int i4, String str2) {
        if (this.view instanceof ImageView) {
            BitmapAjaxCallback.async(this.act, getContext(), (ImageView) this.view, str, z, z2, i, i2, bitmap, i3, f, Float.MAX_VALUE, this.progress, this.ah, this.policy.intValue(), i4, this.proxy, str2);
            reset();
        }
        return self();
    }
