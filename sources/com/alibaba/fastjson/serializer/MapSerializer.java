...
public class MapSerializer extends SerializeFilterable implements ObjectSerializer {
    ...
    public void write(com.alibaba.fastjson.serializer.JSONSerializer r24, java.lang.Object r25, java.lang.Object r26, java.lang.reflect.Type r27, int r28, boolean r29) throws java.io.IOException {
        ...
        L_0x0055:
            r24.incrementIndent()     // Catch:{ all -> 0x02fd }
            ...
            boolean r1 = r11.isEnabled(r1)     // Catch:{ all -> 0x02fd }
            r15 = 1
            if (r1 == 0) goto L_0x0090
            com.alibaba.fastjson.serializer.SerializeConfig r1 = r8.config     // Catch:{ all -> 0x02fd }
            java.lang.String r1 = r1.typeKey     // Catch:{ all -> 0x02fd }
        ...
        L_0x00a1:
            ...
            java.util.List r2 = r8.propertyPreFilters     // Catch:{ all -> 0x02fd }
        ...
        L_0x00d4:
            ...
            boolean r2 = r7.applyName(r8, r0, r2)     // Catch:{ all -> 0x02fd }
            if (r2 != 0) goto L_0x00ec
            goto L_0x00e8
        L_0x00df:
            r2 = r1
        ...
        L_0x00e8:
            ...
            goto L_0x023d
        L_0x00ec:
            java.util.List r2 = r7.propertyPreFilters     // Catch:{ all -> 0x02fd }
        ...
        L_0x0116:
            ...
            goto L_0x00e8
        L_0x0120:
            java.util.List r2 = r8.propertyFilters     // Catch:{ all -> 0x02fd }
        ...
        L_0x013f:
            java.lang.String r2 = com.alibaba.fastjson.JSON.toJSONString(r1)     // Catch:{ all -> 0x02fd }
            boolean r2 = r7.apply(r8, r0, r2, r5)     // Catch:{ all -> 0x02fd }
            if (r2 != 0) goto L_0x0154
            goto L_0x00e8
        L_0x014a:
            r2 = r1
            ...
            goto L_0x00e8
        L_0x0154:
            java.util.List r2 = r7.propertyFilters     // Catch:{ all -> 0x02fd }
        ...
        L_0x017f:
            ...
            goto L_0x00e8
        L_0x018a:
            java.util.List r2 = r8.nameFilters     // Catch:{ all -> 0x02fd }
        ...
        L_0x01a9:
            ...
            java.lang.String r1 = r7.processKey(r8, r0, r1, r5)     // Catch:{ all -> 0x02fd }
            goto L_0x01b8
        L_0x01b2:
            java.lang.String r1 = (java.lang.String) r1     // Catch:{ all -> 0x02fd }
            java.lang.String r1 = r7.processKey(r8, r0, r1, r5)     // Catch:{ all -> 0x02fd }
        L_0x01b8:
            java.util.List r2 = r7.nameFilters     // Catch:{ all -> 0x02fd }
        ...
        L_0x01fa:
            ...
            r22 = r6
            r6 = r21
            java.lang.Object r1 = r1.processValue(r2, r3, r4, r5, r6)     // Catch:{ all -> 0x02fd }
            goto L_0x0232
        L_0x0215:
            r14 = r4
            r21 = r5
        ...
        L_0x0250:
            ...
            r24.println()     // Catch:{ all -> 0x02fd }
        L_0x025b:
            r11.writeFieldName(r4, r15)     // Catch:{ all -> 0x02fd }
            goto L_0x0280
        L_0x025f:
            if (r18 != 0) goto L_0x0264
            r11.write(r2)     // Catch:{ all -> 0x02fd }
        L_0x0264:
            int r1 = NON_STRINGKEY_AS_STRING     // Catch:{ all -> 0x02fd }
            boolean r1 = r11.isEnabled(r1)     // Catch:{ all -> 0x02fd }
            ...
            r8.write(r1)     // Catch:{ all -> 0x02fd }
            goto L_0x027b
        L_0x0278:
            r8.write(r14)     // Catch:{ all -> 0x02fd }
        L_0x027b:
            r1 = 58
            r11.write(r1)     // Catch:{ all -> 0x02fd }
        L_0x0280:
            if (r3 != 0) goto L_0x028c
            r11.writeNull()     // Catch:{ all -> 0x02fd }
            r6 = r22
        L_0x0287:
            r14 = 0
            r18 = 0
        ...
        L_0x028c:
            ...
            com.alibaba.fastjson.serializer.ObjectSerializer r2 = r8.getObjectWriter(r1)     // Catch:{ all -> 0x02fd }
            r18 = r1
            r6 = r2
            goto L_0x02a0
        L_0x029c:
        ...
        L_0x02c1:
            r1 = r6
            com.alibaba.fastjson.serializer.JavaBeanSerializer r1 = (com.alibaba.fastjson.serializer.JavaBeanSerializer) r1     // Catch:{ all -> 0x02fd }
            r2 = r24
            r4 = r14
            r19 = r6
            r6 = r28
            r1.writeNoneASM(r2, r3, r4, r5, r6)     // Catch:{ all -> 0x02fd }
            goto L_0x02dc
        L_0x02cf:
            r19 = r6
            r5 = 0
            ...
            r4 = r14
            r6 = r28
            r1.write(r2, r3, r4, r5, r6)     // Catch:{ all -> 0x02fd }
        L_0x02dc:
            r6 = r18
            goto L_0x0287
        L_0x02df:
