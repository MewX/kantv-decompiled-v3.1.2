...
public abstract class SerializeFilterable {
    ...
    public boolean applyName(JSONSerializer jSONSerializer, Object obj, String str) {
        ...
        if (list != null) {
            for (PropertyPreFilter apply2 : list) {
    ...
    public Object processValue(JSONSerializer jSONSerializer, BeanContext beanContext, Object obj, String str, Object obj2) {
        if (obj2 != null) {
            if (jSONSerializer.out.writeNonStringValueAsString || !(beanContext == null || (beanContext.getFeatures() & SerializerFeature.WriteNonStringValueAsString.mask) == 0)) {
            ...
            if (beanContext != null && beanContext.isJsonDirect()) {
        ...
        if (list2 != null) {
            for (ContextValueFilter process4 : list2) {
