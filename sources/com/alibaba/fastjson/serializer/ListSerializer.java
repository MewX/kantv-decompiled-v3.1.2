            ...
            if (serializeWriter.isEnabled(SerializerFeature.PrettyFormat)) {
                ...
                for (Object next : list) {
                    ...
                    if (next == null) {
                        ...
                        objectWriter.write(jSONSerializer, obj5, Integer.valueOf(i4), type3, i);
                    }
                    i4++;
                    Object obj6 = obj;
                    c = ',';
                ...
                if (obj7 == null) {
                    ...
                    if (cls == Integer.class) {
                        ...
                        if ((SerializerFeature.DisableCircularReferenceDetect.mask & i3) != 0) {
                            i2 = i5;
                            jSONSerializer2.getObjectWriter(obj7.getClass()).write(jSONSerializer, obj7, Integer.valueOf(i5), type3, i);
                            z = z2;
                        } else {
                            i2 = i5;
