...
public class JSONSerializer extends SerializeFilterable {
    ...
    public void setContext(SerialContext serialContext, Object obj, Object obj2, int i, int i2) {
        if (!this.out.disableCircularReferenceDetect) {
            SerialContext serialContext2 = new SerialContext(serialContext, obj, obj2, i, i2);
            this.context = serialContext2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x001c, code lost:
        if (r2.parent != null) goto L_0x001e;
     */
    ...
    public boolean containsReference(Object obj) {
        ...
        SerialContext serialContext = (SerialContext) identityHashMap.get(obj);
        if (serialContext == null) {
            return false;
        }
