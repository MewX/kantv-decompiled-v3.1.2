...
public class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    public FieldSerializer(Class<?> cls, FieldInfo fieldInfo2) {
        ...
        sb.append("\":");
        this.double_quoted_fieldPrefix = sb.toString();
        ...
        this.writeNull = z;
        if (TypeUtils.isAnnotationPresentOneToMany(fieldInfo2.method) || TypeUtils.isAnnotationPresentManyToMany(fieldInfo2.method)) {
            z2 = true;
        }
        this.persistenceXToMany = z2;
    }
    ...
    public void writePrefix(JSONSerializer jSONSerializer) throws IOException {
        ...
        if (!serializeWriter.quoteFieldNames) {
            ...
            if (this.single_quoted_fieldPrefix == null) {
                ...
                sb2.append('\'');
                sb2.append(this.fieldInfo.name);
                sb2.append("':");
                this.single_quoted_fieldPrefix = sb2.toString();
            }
