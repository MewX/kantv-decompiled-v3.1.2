...
public class SerializeConfig {
    ...
    private ObjectSerializer getObjectWriter(Class<?> cls, boolean z) {
        ...
        if (objectSerializer == null) {
            try {
                for (Object next : ServiceLoader.load(AutowiredObjectSerializer.class, Thread.currentThread().getContextClassLoader())) {
                    if (next instanceof AutowiredObjectSerializer) {
                        AutowiredObjectSerializer autowiredObjectSerializer = (AutowiredObjectSerializer) next;
            ...
            objectSerializer = (ObjectSerializer) this.serializers.get(cls2);
        }
        if (objectSerializer == null) {
            ClassLoader classLoader = JSON.class.getClassLoader();
            if (classLoader != Thread.currentThread().getContextClassLoader()) {
                try {
                    for (Object next2 : ServiceLoader.load(AutowiredObjectSerializer.class, classLoader)) {
                        if (next2 instanceof AutowiredObjectSerializer) {
                            AutowiredObjectSerializer autowiredObjectSerializer2 = (AutowiredObjectSerializer) next2;
        ...
        if (objectSerializer == null) {
            ...
            if (Map.class.isAssignableFrom(cls2)) {
                ...
                put((Type) cls2, objectSerializer);
                ...
                if (superclass != null && superclass.isEnum()) {
                    ...
                    put((Type) cls2, arraySerializer);
                    objectSerializer = arraySerializer;
                } else {
                    Class cls3 = null;
                    if (Throwable.class.isAssignableFrom(cls2)) {
                        SerializeBeanInfo buildBeanInfo = TypeUtils.buildBeanInfo(cls2, null, this.propertyNamingStrategy);
                        ...
                        put((Type) cls2, javaBeanSerializer);
    ...
    public final ObjectSerializer get(Type type) {
        return (ObjectSerializer) this.serializers.get(type);
    }
