...
public class CalendarCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        if (serializeWriter.isEnabled(SerializerFeature.UseISO8601DateFormat)) {
            ...
            int rawOffset = calendar.getTimeZone().getRawOffset() / Conversation.DEFAULT_CONVERSATION_EXPIRE_TIME_IN_MILLS;
            if (rawOffset == 0) {
                ...
                String str2 = "%02d";
                if (rawOffset > 0) {
                    serializeWriter.append((CharSequence) "+").append((CharSequence) String.format(str2, new Object[]{Integer.valueOf(rawOffset)})).append((CharSequence) str);
                } else {
                    serializeWriter.append((CharSequence) "-").append((CharSequence) String.format(str2, new Object[]{Integer.valueOf(-rawOffset)})).append((CharSequence) str);
                }
            }
    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        ...
        if (type == XMLGregorianCalendar.class) {
            instance2 = createXMLGregorianCalendar((GregorianCalendar) instance2);
        }
        return instance2;
    }
