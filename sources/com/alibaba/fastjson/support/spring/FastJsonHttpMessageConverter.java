...
public class FastJsonHttpMessageConverter extends AbstractHttpMessageConverter<Object> implements GenericHttpMessageConverter<Object> {
        ...
        public static Type getType(Type type, Class<?> cls) {
            if (cls != null) {
                ...
                if (type instanceof TypeVariable) {
                    ...
                    type = ResolvableType.forClassWithGenerics(forType.getRawClass(), clsArr).getType();
                }
            }
            return type;
        }
    ...
    private Object readType(Type type, HttpInputMessage httpInputMessage) throws IOException {
        try {
            ...
            throw new HttpMessageNotReadableException(sb.toString(), e);
    ...
    public void writeInternal(java.lang.Object r12, org.springframework.http.HttpOutputMessage r13) throws java.io.IOException, org.springframework.http.converter.HttpMessageNotWritableException {
        /*
            ...
            r8.<init>()
            org.springframework.http.HttpHeaders r9 = r13.getHeaders()     // Catch:{ JSONException -> 0x00a0 }
            com.alibaba.fastjson.support.config.FastJsonConfig r0 = r11.fastJsonConfig     // Catch:{ JSONException -> 0x00a0 }
            com.alibaba.fastjson.serializer.SerializeFilter[] r0 = r0.getSerializeFilters()     // Catch:{ JSONException -> 0x00a0 }
            java.util.ArrayList r1 = new java.util.ArrayList     // Catch:{ JSONException -> 0x00a0 }
            java.util.List r0 = java.util.Arrays.asList(r0)     // Catch:{ JSONException -> 0x00a0 }
            r1.<init>(r0)     // Catch:{ JSONException -> 0x00a0 }
            r0 = 0
            java.lang.Object r12 = r11.strangeCodeForJackson(r12)     // Catch:{ JSONException -> 0x00a0 }
            boolean r2 = r12 instanceof com.alibaba.fastjson.support.spring.FastJsonContainer     // Catch:{ JSONException -> 0x00a0 }
            if (r2 == 0) goto L_0x0032
            com.alibaba.fastjson.support.spring.FastJsonContainer r12 = (com.alibaba.fastjson.support.spring.FastJsonContainer) r12     // Catch:{ JSONException -> 0x00a0 }
            com.alibaba.fastjson.support.spring.PropertyPreFilters r2 = r12.getFilters()     // Catch:{ JSONException -> 0x00a0 }
            java.util.List r2 = r2.getFilters()     // Catch:{ JSONException -> 0x00a0 }
            r1.addAll(r2)     // Catch:{ JSONException -> 0x00a0 }
            java.lang.Object r12 = r12.getValue()     // Catch:{ JSONException -> 0x00a0 }
        L_0x0032:
            r2 = r12
            boolean r12 = r2 instanceof com.alibaba.fastjson.support.spring.MappingFastJsonValue     // Catch:{ JSONException -> 0x00a0 }
            r3 = 1
            if (r12 == 0) goto L_0x0047
            r12 = r2
            com.alibaba.fastjson.support.spring.MappingFastJsonValue r12 = (com.alibaba.fastjson.support.spring.MappingFastJsonValue) r12     // Catch:{ JSONException -> 0x00a0 }
            java.lang.String r12 = r12.getJsonpFunction()     // Catch:{ JSONException -> 0x00a0 }
            boolean r12 = org.springframework.util.StringUtils.isEmpty(r12)     // Catch:{ JSONException -> 0x00a0 }
            if (r12 != 0) goto L_0x004d
            goto L_0x004b
        L_0x0047:
            boolean r12 = r2 instanceof com.alibaba.fastjson.JSONPObject     // Catch:{ JSONException -> 0x00a0 }
            if (r12 == 0) goto L_0x004d
        L_0x004b:
            r12 = 1
            goto L_0x004e
        ...
        L_0x004e:
            com.alibaba.fastjson.support.config.FastJsonConfig r0 = r11.fastJsonConfig     // Catch:{ JSONException -> 0x00a0 }
            java.nio.charset.Charset r3 = r0.getCharset()     // Catch:{ JSONException -> 0x00a0 }
            com.alibaba.fastjson.support.config.FastJsonConfig r0 = r11.fastJsonConfig     // Catch:{ JSONException -> 0x00a0 }
            com.alibaba.fastjson.serializer.SerializeConfig r4 = r0.getSerializeConfig()     // Catch:{ JSONException -> 0x00a0 }
            int r0 = r1.size()     // Catch:{ JSONException -> 0x00a0 }
            com.alibaba.fastjson.serializer.SerializeFilter[] r0 = new com.alibaba.fastjson.serializer.SerializeFilter[r0]     // Catch:{ JSONException -> 0x00a0 }
            java.lang.Object[] r0 = r1.toArray(r0)     // Catch:{ JSONException -> 0x00a0 }
            r5 = r0
            com.alibaba.fastjson.serializer.SerializeFilter[] r5 = (com.alibaba.fastjson.serializer.SerializeFilter[]) r5     // Catch:{ JSONException -> 0x00a0 }
            com.alibaba.fastjson.support.config.FastJsonConfig r0 = r11.fastJsonConfig     // Catch:{ JSONException -> 0x00a0 }
            java.lang.String r6 = r0.getDateFormat()     // Catch:{ JSONException -> 0x00a0 }
            int r7 = com.alibaba.fastjson.JSON.DEFAULT_GENERATE_FEATURE     // Catch:{ JSONException -> 0x00a0 }
            com.alibaba.fastjson.support.config.FastJsonConfig r0 = r11.fastJsonConfig     // Catch:{ JSONException -> 0x00a0 }
            com.alibaba.fastjson.serializer.SerializerFeature[] r10 = r0.getSerializerFeatures()     // Catch:{ JSONException -> 0x00a0 }
            r0 = r8
            r1 = r3
            r3 = r4
            r4 = r5
            ...
            r6 = r7
            r7 = r10
            int r0 = com.alibaba.fastjson.JSON.writeJSONString(r0, r1, r2, r3, r4, r5, r6, r7)     // Catch:{ JSONException -> 0x00a0 }
            if (r12 == 0) goto L_0x0087
            org.springframework.http.MediaType r12 = APPLICATION_JAVASCRIPT     // Catch:{ JSONException -> 0x00a0 }
            r9.setContentType(r12)     // Catch:{ JSONException -> 0x00a0 }
        L_0x0087:
            com.alibaba.fastjson.support.config.FastJsonConfig r12 = r11.fastJsonConfig     // Catch:{ JSONException -> 0x00a0 }
            boolean r12 = r12.isWriteContentLength()     // Catch:{ JSONException -> 0x00a0 }
            if (r12 == 0) goto L_0x0093
            long r0 = (long) r0     // Catch:{ JSONException -> 0x00a0 }
            r9.setContentLength(r0)     // Catch:{ JSONException -> 0x00a0 }
        L_0x0093:
            java.io.OutputStream r12 = r13.getBody()     // Catch:{ JSONException -> 0x00a0 }
            r8.writeTo(r12)     // Catch:{ JSONException -> 0x00a0 }
            r8.close()
            return
        L_0x009e:
            r12 = move-exception
        ...
        L_0x00a0:
            r12 = move-exception
            org.springframework.http.converter.HttpMessageNotWritableException r13 = new org.springframework.http.converter.HttpMessageNotWritableException     // Catch:{ all -> 0x009e }
            ...
            java.lang.String r1 = r12.getMessage()     // Catch:{ all -> 0x009e }
            r0.append(r1)     // Catch:{ all -> 0x009e }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x009e }
            r13.<init>(r0, r12)     // Catch:{ all -> 0x009e }
    ...
    private Object strangeCodeForJackson(Object obj) {
        ...
        return "com.fasterxml.jackson.databind.node.ObjectNode".equals(obj.getClass().getName()) ? obj.toString() : obj;
    }
