...
final class zzac implements ServiceConnection {
    ...
    public final synchronized boolean zzb(com.google.firebase.iid.zzal r6) {
        ...
        L_0x002e:
            ...
            return r2
        L_0x0030:
            java.util.Queue<com.google.firebase.iid.zzal<?>> r0 = r5.zzcg     // Catch:{ all -> 0x0097 }
        ...
        L_0x005f:
            ...
            com.google.firebase.iid.zzab r1 = r5.zzci     // Catch:{ all -> 0x0097 }
            ...
            goto L_0x0095
        L_0x0083:
            com.google.firebase.iid.zzab r6 = r5.zzci     // Catch:{ all -> 0x0097 }
            java.util.concurrent.ScheduledExecutorService r6 = r6.zzcb     // Catch:{ all -> 0x0097 }
    ...
    public final synchronized void zza(int i, String str) {
        ...
        if (i2 == 0) {
            ...
            this.zzcg.clear();
            for (int i3 = 0; i3 < this.zzch.size(); i3++) {
                ((zzal) this.zzch.valueAt(i3)).zza(zzak);
            }
            this.zzch.clear();
        } else if (i2 == 3) {
            this.state = 4;
