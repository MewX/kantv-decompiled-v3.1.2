        ...
        public void onPrepareError(MediaPeriodId mediaPeriodId, IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable(iOException) {
                ...
                public final void run() {
                    AdPrepareErrorListener.this.lambda$onPrepareError$0$AdsMediaSource$AdPrepareErrorListener(this.f$1);
                }
            });
        }
        ...
        public void onAdPlaybackState(AdPlaybackState adPlaybackState) {
            if (!this.released) {
                this.playerHandler.post(new Runnable(adPlaybackState) {
                    ...
                    public final void run() {
                        ComponentListener.this.lambda$onAdPlaybackState$0$AdsMediaSource$ComponentListener(this.f$1);
                    }
                });
            }
        }
