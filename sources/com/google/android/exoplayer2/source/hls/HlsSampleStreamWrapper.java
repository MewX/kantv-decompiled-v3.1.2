...
final class HlsSampleStreamWrapper implements com.google.android.exoplayer2.upstream.Loader.Callback<Chunk>, ReleaseCallback, SequenceableLoader, ExtractorOutput, UpstreamFormatChangedListener {
    ...
    public HlsSampleStreamWrapper(int i, Callback callback2, HlsChunkSource hlsChunkSource, Map<String, DrmInitData> map, Allocator allocator2, long j, Format format, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, EventDispatcher eventDispatcher2) {
        this.trackType = i;
    ...
    public int readData(int i, FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, boolean z) {
        ...
        if (read == -5) {
            ...
            if (i == this.primarySampleQueueIndex) {
                ...
                format2 = format2.copyWithManifestFormatInfo(i2 < this.mediaChunks.size() ? ((HlsMediaChunk) this.mediaChunks.get(i2)).trackFormat : this.upstreamTrackFormat);
            }
            if (format2.drmInitData != null) {
                DrmInitData drmInitData = (DrmInitData) this.overridingDrmInitData.get(format2.drmInitData.schemeType);
                if (drmInitData != null) {
