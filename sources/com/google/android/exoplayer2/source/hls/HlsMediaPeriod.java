...
public final class HlsMediaPeriod implements MediaPeriod, Callback, PlaylistEventListener {
    ...
    public List<StreamKey> getStreamKeys(List<TrackSelection> list) {
        ...
        for (TrackSelection trackSelection : list) {
            ...
            if (indexOf == -1) {
                ...
                for (int i7 = 0; i7 < trackSelection.length(); i7++) {
                    arrayList.add(new StreamKey(i2, iArr[trackSelection.getIndexInTrackGroup(i7)]));
                }
                z3 = true;
            } else {
                z2 = true;
        ...
        if (z2 && !z3) {
            int i8 = iArr[0];
            int i9 = ((Variant) hlsMasterPlaylist.variants.get(iArr[0])).format.bitrate;
            for (int i10 = 1; i10 < iArr.length; i10++) {
                int i11 = ((Variant) hlsMasterPlaylist.variants.get(iArr[i10])).format.bitrate;
                if (i11 < i9) {
                    i8 = iArr[i10];
                    i9 = i11;
                }
    ...
    private void buildAndPrepareSampleStreamWrappers(long j) {
        ...
        while (i < list2.size()) {
            ...
            buildSampleStreamWrapper.prepareWithMasterPlaylistInfo(new TrackGroupArray(new TrackGroup(rendition2.format)), 0, TrackGroupArray.EMPTY);
            i = i2 + 1;
        }
    ...
    private HlsSampleStreamWrapper buildSampleStreamWrapper(int i, Uri[] uriArr, Format[] formatArr, Format format, List<Format> list, Map<String, DrmInitData> map, long j) {
        ...
        HlsSampleStreamWrapper hlsSampleStreamWrapper = new HlsSampleStreamWrapper(i, this, hlsChunkSource, map, this.allocator, j, format, this.loadErrorHandlingPolicy, this.eventDispatcher);
    ...
    private static Format deriveAudioFormat(Format format, Format format2, boolean z) {
        ...
        return Format.createAudioContainerFormat(format3.id, str3, format3.containerMimeType, MimeTypes.getMediaMimeType(str2), str2, z ? format3.bitrate : -1, i3, -1, null, i2, i, str);
    }
}
