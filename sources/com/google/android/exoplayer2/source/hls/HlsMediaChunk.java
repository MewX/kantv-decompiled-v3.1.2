...
final class HlsMediaChunk extends MediaChunk {
    ...
    public static HlsMediaChunk createInstance(HlsExtractorFactory hlsExtractorFactory, DataSource dataSource, Format format, long j, HlsMediaPlaylist hlsMediaPlaylist, int i, Uri uri, @Nullable List<Format> list, int i2, @Nullable Object obj, boolean z, TimestampAdjusterProvider timestampAdjusterProvider, @Nullable HlsMediaChunk hlsMediaChunk, @Nullable byte[] bArr, @Nullable byte[] bArr2) {
        ...
        byte[] bArr3 = bArr;
        byte[] bArr4 = bArr2;
        Segment segment = (Segment) hlsMediaPlaylist2.segments.get(i3);
        DataSpec dataSpec2 = new DataSpec(UriUtil.resolveToUri(hlsMediaPlaylist2.baseUri, segment.url), segment.byterangeOffset, segment.byterangeLength, null);
        ...
        if (segment2 != null) {
            ...
            boolean z6 = z5;
            DataSpec dataSpec3 = new DataSpec(UriUtil.resolveToUri(hlsMediaPlaylist2.baseUri, segment2.url), segment2.byterangeOffset, segment2.byterangeLength, null);
        ...
        if (hlsMediaChunk2 != null) {
            ...
            z3 = z7;
            extractor2 = (!hlsMediaChunk2.isExtractorReusable || hlsMediaChunk2.discontinuitySequenceNumber != i4 || z7) ? null : hlsMediaChunk2.extractor;
        } else {
            Uri uri2 = uri;
        ...
        HlsMediaChunk hlsMediaChunk3 = new HlsMediaChunk(hlsExtractorFactory, buildDataSource, dataSpec2, format, z4, dataSource2, dataSpec, z2, uri, list, i2, obj, j2, j3, hlsMediaPlaylist2.mediaSequence + ((long) i3), i4, segment.hasGapTag, z, timestampAdjusterProvider.getAdjuster(i4), segment.drmInitData, extractor2, id3Decoder2, parsableByteArray, z3);
        return hlsMediaChunk3;
    }
    ...
    private DefaultExtractorInput prepareExtraction(DataSource dataSource, DataSpec dataSpec) throws IOException, InterruptedException {
        ...
        Result createExtractor = this.extractorFactory.createExtractor(this.previousExtractor, dataSpec2.uri, this.trackFormat, this.muxedCaptionFormats, this.drmInitData, this.timestampAdjuster, dataSource.getResponseHeaders(), defaultExtractorInput2);
