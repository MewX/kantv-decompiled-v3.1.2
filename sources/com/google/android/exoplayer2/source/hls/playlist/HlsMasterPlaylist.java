...
public final class HlsMasterPlaylist extends HlsPlaylist {
    ...
    public static final class Variant {
        ...
        public static Variant createMediaPlaylistVariantUrl(Uri uri) {
            Variant variant = new Variant(uri, Format.createContainerFormat("0", null, MimeTypes.APPLICATION_M3U8, null, null, -1, 0, 0, null), null, null, null, null);
            return variant;
        }

        public Variant copyWithFormat(Format format2) {
            Variant variant = new Variant(this.url, format2, this.videoGroupId, this.audioGroupId, this.subtitleGroupId, this.captionGroupId);
            return variant;
        }
    }

    static {
        HlsMasterPlaylist hlsMasterPlaylist = new HlsMasterPlaylist("", Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), null, Collections.emptyList(), false, Collections.emptyMap(), Collections.emptyList());
