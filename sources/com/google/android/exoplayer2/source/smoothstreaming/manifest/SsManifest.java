...
public class SsManifest implements FilterableManifest<SsManifest> {
    ...
    public static class StreamElement {
        ...
        public StreamElement copy(Format[] formatArr) {
            ...
            StreamElement streamElement = new StreamElement(this.baseUri, this.chunkTemplate, this.type, this.subType, this.timescale, this.name, this.maxWidth, this.maxHeight, this.displayWidth, this.displayHeight, this.language, formatArr2, this.chunkStartTimes, this.chunkStartTimesUs, this.lastChunkDurationUs);
    ...
    public final SsManifest copy(List<StreamKey> list) {
        ...
        SsManifest ssManifest = new SsManifest(this.majorVersion, this.minorVersion, this.durationUs, this.dvrWindowLengthUs, this.lookAheadCount, this.isLive, this.protectionElement, (StreamElement[]) arrayList2.toArray(new StreamElement[0]));
        return ssManifest;
    }
}
