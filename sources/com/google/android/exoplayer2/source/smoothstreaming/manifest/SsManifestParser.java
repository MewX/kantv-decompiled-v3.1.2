...
public class SsManifestParser implements Parser<SsManifest> {
    ...
    private static class ProtectionParser extends ElementParser {
        ...
        public Object build() {
            ...
            return new ProtectionElement(uuid2, PsshAtomUtil.buildPsshAtom(uuid2, this.initData), buildTrackEncryptionBoxes(this.initData));
        }

        private static TrackEncryptionBox[] buildTrackEncryptionBoxes(byte[] bArr) {
            TrackEncryptionBox trackEncryptionBox = new TrackEncryptionBox(true, null, 8, getProtectionElementKeyId(bArr), 0, 0, null);
            return new TrackEncryptionBox[]{trackEncryptionBox};
        }
    ...
    private static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            String attributeValue = xmlPullParser2.getAttributeValue(null, KEY_INDEX);
            String str = (String) getNormalizedAttribute(KEY_NAME);
            int parseRequiredInt = parseRequiredInt(xmlPullParser2, KEY_BITRATE);
            String fourCCToMimeType = fourCCToMimeType(parseRequiredString(xmlPullParser2, KEY_FOUR_CC));
            String str2 = KEY_CODEC_PRIVATE_DATA;
            if (intValue == 2) {
                this.format = Format.createVideoContainerFormat(attributeValue, str, "video/mp4", fourCCToMimeType, null, parseRequiredInt, parseRequiredInt(xmlPullParser2, KEY_MAX_WIDTH), parseRequiredInt(xmlPullParser2, KEY_MAX_HEIGHT), -1.0f, buildCodecSpecificData(xmlPullParser2.getAttributeValue(null, str2)), 0, 0);
                return;
            }
            ...
            if (intValue == 1) {
                ...
                int parseRequiredInt2 = parseRequiredInt(xmlPullParser2, KEY_CHANNELS);
                int parseRequiredInt3 = parseRequiredInt(xmlPullParser2, KEY_SAMPLING_RATE);
                List buildCodecSpecificData = buildCodecSpecificData(xmlPullParser2.getAttributeValue(null, str2));
                ...
                this.format = Format.createAudioContainerFormat(attributeValue, str, "audio/mp4", fourCCToMimeType, null, parseRequiredInt, parseRequiredInt2, parseRequiredInt3, buildCodecSpecificData, 0, 0, (String) getNormalizedAttribute(str3));
            } else if (intValue == 3) {
                String str5 = (String) getNormalizedAttribute(KEY_SUB_TYPE);
                char c = 65535;
                ...
                int i = c != 0 ? c != 1 ? 0 : 1024 : 64;
                this.format = Format.createTextContainerFormat(attributeValue, str, MimeTypes.APPLICATION_MP4, fourCCToMimeType, null, parseRequiredInt, 0, i, (String) getNormalizedAttribute(str3));
            } else {
                this.format = Format.createContainerFormat(attributeValue, str, MimeTypes.APPLICATION_MP4, fourCCToMimeType, null, parseRequiredInt, 0, 0, null);
            }
        }
    ...
    private static class SmoothStreamingMediaParser extends ElementParser {
        ...
        public Object build() {
            ...
            if (protectionElement2 != null) {
                DrmInitData drmInitData = new DrmInitData(new SchemeData(protectionElement2.uuid, "video/mp4", this.protectionElement.data));
    ...
    private static class StreamIndexParser extends ElementParser {
        ...
        private void parseStreamElementStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            String str2 = KEY_LANGUAGE;
            this.language = xmlPullParser.getAttributeValue(null, str2);
            putNormalizedAttribute(str2, this.language);
            String str3 = KEY_TIME_SCALE;
            this.timescale = (long) parseInt(xmlPullParser, str3, -1);
            if (this.timescale == -1) {
                this.timescale = ((Long) getNormalizedAttribute(str3)).longValue();
            }
