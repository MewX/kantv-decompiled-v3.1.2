...
public class DefaultSsChunkSource implements SsChunkSource {
    ...
    private static final class StreamElementIterator extends BaseMediaChunkIterator {
        ...
        public StreamElementIterator(StreamElement streamElement2, int i, int i2) {
    ...
    public DefaultSsChunkSource(LoaderErrorThrower loaderErrorThrower, SsManifest ssManifest, int i, TrackSelection trackSelection2, DataSource dataSource2) {
        ...
        while (i3 < this.extractorWrappers.length) {
            ...
            int i4 = i3;
            Track track = r7;
            Track track2 = new Track(indexInTrackGroup, streamElement.type, streamElement.timescale, C.TIME_UNSET, ssManifest2.durationUs, format, 0, format.drmInitData != null ? ssManifest2.protectionElement.trackEncryptionBoxes : null, streamElement.type == 2 ? 4 : 0, null, null);
    ...
    public final void getNextChunk(long j, long j2, List<? extends MediaChunk> list, ChunkHolder chunkHolder) {
        ...
        if (this.fatalError == null) {
            ...
            chunkHolder2.chunk = newMediaChunk(this.trackSelection.getSelectedFormat(), this.dataSource, buildRequestUri, null, i3, startTimeUs, chunkDurationUs, j5, this.trackSelection.getSelectionReason(), this.trackSelection.getSelectionData(), chunkExtractorWrapper);
        }
    }
    ...
    private static MediaChunk newMediaChunk(Format format, DataSource dataSource2, Uri uri, String str, int i, long j, long j2, long j3, int i2, Object obj, ChunkExtractorWrapper chunkExtractorWrapper) {
        ...
        ContainerMediaChunk containerMediaChunk = new ContainerMediaChunk(dataSource3, dataSpec, format2, i3, obj2, j4, j6, j7, C.TIME_UNSET, (long) i, 1, j5, chunkExtractorWrapper2);
