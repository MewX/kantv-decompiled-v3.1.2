...
public final class SsMediaSource extends BaseMediaSource implements Callback<ParsingLoadable<SsManifest>> {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public SsMediaSource createMediaSource(SsManifest ssManifest) {
            ...
            SsMediaSource ssMediaSource = new SsMediaSource(ssManifest, null, null, null, this.chunkSourceFactory, this.compositeSequenceableLoaderFactory, this.loadErrorHandlingPolicy, this.livePresentationDelayMs, this.tag);
        ...
        public SsMediaSource createMediaSource(Uri uri) {
            ...
            SsMediaSource ssMediaSource = new SsMediaSource(null, (Uri) Assertions.checkNotNull(uri), this.manifestDataSourceFactory, this.manifestParser, this.chunkSourceFactory, this.compositeSequenceableLoaderFactory, this.loadErrorHandlingPolicy, this.livePresentationDelayMs, this.tag);
            return ssMediaSource;
        }
    ...
    private SsMediaSource(SsManifest ssManifest, Uri uri, com.google.android.exoplayer2.upstream.DataSource.Factory factory, Parser<? extends SsManifest> parser, com.google.android.exoplayer2.source.smoothstreaming.SsChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory2, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, long j, @Nullable Object obj) {
        Uri uri2;
        boolean z = false;
    ...
    private void processManifest() {
        ...
        if (j2 == Long.MAX_VALUE) {
            ...
            singlePeriodTimeline = new SinglePeriodTimeline(C.TIME_UNSET, j4, j3, msToUs, true, true, this.tag);
        } else {
