...
public class SampleQueue implements TrackOutput {
    ...
    private void clearAllocationNodes(AllocationNode allocationNode) {
        if (allocationNode.wasInitialized) {
            int i = ((int) (this.writeAllocationNode.startPosition - allocationNode.startPosition)) / this.allocationLength;
            Allocation[] allocationArr = new Allocation[((this.writeAllocationNode.wasInitialized ? 1 : 0) + i)];
