...
public class DashManifestParser extends DefaultHandler implements Parser<DashManifest> {
    ...
    public Format buildFormat(String str, String str2, String str3, int i, int i2, float f, int i3, int i4, int i5, String str4, List<Descriptor> list, List<Descriptor> list2, String str5, List<Descriptor> list3) {
        ...
        if (sampleMimeType != null) {
            ...
            if (MimeTypes.isVideo(parseEac3SupplementalProperties)) {
                return Format.createVideoContainerFormat(str, str2, str3, parseEac3SupplementalProperties, str5, i5, i, i2, f, null, parseSelectionFlagsFromRoleDescriptors, parseRoleFlagsFromRoleDescriptors);
            }
            if (MimeTypes.isAudio(parseEac3SupplementalProperties)) {
                return Format.createAudioContainerFormat(str, str2, str3, parseEac3SupplementalProperties, str5, i5, i3, i4, null, parseSelectionFlagsFromRoleDescriptors, parseRoleFlagsFromRoleDescriptors, str4);
            }
    ...
    public Representation buildRepresentation(RepresentationInfo representationInfo, String str, ArrayList<SchemeData> arrayList, ArrayList<Descriptor> arrayList2) {
        ...
        if (!arrayList3.isEmpty()) {
            ...
            format = format.copyWithDrmInitData(new DrmInitData(str, (List<SchemeData>) arrayList3));
        }
    ...
    /* access modifiers changed from: protected */
    public SegmentTemplate parseSegmentTemplate(XmlPullParser xmlPullParser, SegmentTemplate segmentTemplate, List<Descriptor> list) throws XmlPullParserException, IOException {
        XmlPullParser xmlPullParser2 = xmlPullParser;
    ...
    public EventStream parseEventStream(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        String parseString2 = parseString(xmlPullParser, "value", str);
    ...
    public int parseSelectionFlagsFromRoleDescriptors(List<Descriptor> list) {
        for (int i = 0; i < list.size(); i++) {
            ...
            if ("urn:mpeg:dash:role:2011".equalsIgnoreCase(descriptor.schemeIdUri)) {
                if (ConfigBuilder.DEFAULT_DART_ENTRYPOINT.equals(descriptor.value)) {
                    return 1;
                }
            }
        }
