...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    public static final class Factory implements com.google.android.exoplayer2.source.dash.DashChunkSource.Factory {
        ...
        public DashChunkSource createDashChunkSource(LoaderErrorThrower loaderErrorThrower, DashManifest dashManifest, int i, int[] iArr, TrackSelection trackSelection, int i2, long j, boolean z, List<Format> list, @Nullable PlayerTrackEmsgHandler playerTrackEmsgHandler, @Nullable TransferListener transferListener) {
    ...
    protected static final class RepresentationHolder {
        ...
        public RepresentationHolder copyWithNewRepresentation(long j, Representation representation2) throws BehindLiveWindowException {
            ...
            if (index == null) {
                ...
                RepresentationHolder representationHolder4 = new RepresentationHolder(j, representation2, this.extractorWrapper, j4, index2);
        ...
        /* JADX WARNING: type inference failed for: r10v1, types: [com.google.android.exoplayer2.extractor.Extractor] */
    ...
    public DefaultDashChunkSource(LoaderErrorThrower loaderErrorThrower, DashManifest dashManifest, int i, int[] iArr, TrackSelection trackSelection2, int i2, DataSource dataSource2, long j, int i3, boolean z, List<Format> list, @Nullable PlayerTrackEmsgHandler playerTrackEmsgHandler2) {
    ...
    public void getNextChunk(long j, long j2, List<? extends MediaChunk> list, ChunkHolder chunkHolder) {
        ...
        if (this.fatalError == null) {
            ...
            if (playerTrackEmsgHandler2 == null || !playerTrackEmsgHandler2.maybeRefreshManifestBeforeLoadingNextChunk(msToUs)) {
                ...
                boolean z = access$000 != C.TIME_UNSET;
    ...
    public Chunk newMediaChunk(RepresentationHolder representationHolder, DataSource dataSource2, int i, Format format, int i2, Object obj, long j, int i3, long j2) {
        ...
        long j4 = (access$000 == C.TIME_UNSET || access$000 > segmentEndTimeUs2) ? -9223372036854775807L : access$000;
