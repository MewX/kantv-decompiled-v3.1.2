...
public final class MediaCodecInfo {
    ...
    public static MediaCodecInfo newPassthroughInstance(String str) {
        MediaCodecInfo mediaCodecInfo = new MediaCodecInfo(str, null, null, null, true, false, false);
        return mediaCodecInfo;
    }

    public static MediaCodecInfo newInstance(String str, String str2, String str3, @Nullable CodecCapabilities codecCapabilities, boolean z, boolean z2) {
        MediaCodecInfo mediaCodecInfo = new MediaCodecInfo(str, str2, str3, codecCapabilities, false, z, z2);
        return mediaCodecInfo;
    }

    private MediaCodecInfo(String str, @Nullable String str2, @Nullable String str3, @Nullable CodecCapabilities codecCapabilities, boolean z, boolean z2, boolean z3) {
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        if (i > 1 || ((Util.SDK_INT >= 26 && i > 0) || "audio/mpeg".equals(str2) || "audio/3gpp".equals(str2) || MimeTypes.AUDIO_AMR_WB.equals(str2) || MimeTypes.AUDIO_AAC.equals(str2) || MimeTypes.AUDIO_VORBIS.equals(str2) || MimeTypes.AUDIO_OPUS.equals(str2) || MimeTypes.AUDIO_RAW.equals(str2) || MimeTypes.AUDIO_FLAC.equals(str2) || MimeTypes.AUDIO_ALAW.equals(str2) || MimeTypes.AUDIO_MLAW.equals(str2) || MimeTypes.AUDIO_MSGSM.equals(str2))) {
            return i;
        }
