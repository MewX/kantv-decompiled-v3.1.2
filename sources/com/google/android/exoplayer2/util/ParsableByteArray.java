...
public final class ParsableByteArray {
    ...
    public int peekUnsignedByte() {
        return this.data[this.position] & Draft_75.END_OF_FRAME;
    }

    public char peekChar() {
        byte[] bArr = this.data;
        int i = this.position;
        return (char) ((bArr[i + 1] & Draft_75.END_OF_FRAME) | ((bArr[i] & Draft_75.END_OF_FRAME) << 8));
    }
    ...
    public int readUnsignedShort() {
        ...
        this.position = i3 + 1;
        return (bArr[i3] & Draft_75.END_OF_FRAME) | i2;
    }
    ...
    public int readLittleEndianUnsignedShort() {
        ...
        this.position = i2 + 1;
        return ((bArr[i2] & Draft_75.END_OF_FRAME) << 8) | b;
    }
    ...
    public short readShort() {
        ...
        int i3 = this.position;
        this.position = i3 + 1;
        return (short) ((bArr[i3] & Draft_75.END_OF_FRAME) | i2);
    }
    ...
    public short readLittleEndianShort() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        return (short) (((bArr[i2] & Draft_75.END_OF_FRAME) << 8) | b);
    }
    ...
    public int readUnsignedInt24() {
        ...
        int i = this.position;
        this.position = i + 1;
        int i2 = (bArr[i] & Draft_75.END_OF_FRAME) << 16;
        int i3 = this.position;
        this.position = i3 + 1;
        byte b = i2 | ((bArr[i3] & Draft_75.END_OF_FRAME) << 8);
        int i4 = this.position;
        this.position = i4 + 1;
        return (bArr[i4] & Draft_75.END_OF_FRAME) | b;
    }
    ...
    public int readInt24() {
        ...
        int i = this.position;
        this.position = i + 1;
        int i2 = ((bArr[i] & Draft_75.END_OF_FRAME) << 24) >> 8;
        int i3 = this.position;
        this.position = i3 + 1;
        byte b = i2 | ((bArr[i3] & Draft_75.END_OF_FRAME) << 8);
        int i4 = this.position;
    ...
    public int readLittleEndianInt24() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        byte b2 = b | ((bArr[i2] & Draft_75.END_OF_FRAME) << 8);
        int i3 = this.position;
        this.position = i3 + 1;
        return ((bArr[i3] & Draft_75.END_OF_FRAME) << 16) | b2;
    }
    ...
    public int readInt() {
        ...
        int i3 = this.position;
        this.position = i3 + 1;
        byte b = i2 | ((bArr[i3] & Draft_75.END_OF_FRAME) << 16);
        int i4 = this.position;
        this.position = i4 + 1;
        byte b2 = b | ((bArr[i4] & Draft_75.END_OF_FRAME) << 8);
        int i5 = this.position;
        this.position = i5 + 1;
        return (bArr[i5] & Draft_75.END_OF_FRAME) | b2;
    }
    ...
    public int readLittleEndianInt() {
        ...
        int i3 = this.position;
        this.position = i3 + 1;
        byte b3 = b2 | ((bArr[i3] & Draft_75.END_OF_FRAME) << 16);
        int i4 = this.position;
        this.position = i4 + 1;
        return ((bArr[i4] & Draft_75.END_OF_FRAME) << 24) | b3;
    }
    ...
    public int readUnsignedFixedPoint1616() {
        ...
        int i3 = this.position;
        this.position = i3 + 1;
        byte b = (bArr[i3] & Draft_75.END_OF_FRAME) | i2;
        this.position += 2;
        return b;
    }
