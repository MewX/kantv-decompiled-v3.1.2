...
public final class CacheDataSource implements DataSource {
    ...
    private void openNextSource(boolean z) throws IOException {
        ...
        if (cacheSpan == null) {
            ...
            DataSpec dataSpec3 = new DataSpec(uri3, i, null, j2, j2, this.bytesRemaining, this.key, this.flags);
            ...
            if (cacheSpan.isCached) {
                ...
                dataSpec2 = new DataSpec(uri4, i2, null, j8, j8, j7, this.key, this.flags);
