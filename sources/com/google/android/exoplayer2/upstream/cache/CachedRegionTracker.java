...
public final class CachedRegionTracker implements Listener {
    ...
    public CachedRegionTracker(Cache cache2, String str, ChunkIndex chunkIndex2) {
        ...
        synchronized (this) {
            Iterator descendingIterator = cache2.addListener(str, this).descendingIterator();
    ...
    public synchronized int getRegionEndTimeMs(long r8) {
        /*
            r7 = this;
            monitor-enter(r7)
            com.google.android.exoplayer2.upstream.cache.CachedRegionTracker$Region r0 = r7.lookupRegion     // Catch:{ all -> 0x0066 }
            r0.startOffset = r8     // Catch:{ all -> 0x0066 }
            java.util.TreeSet<com.google.android.exoplayer2.upstream.cache.CachedRegionTracker$Region> r0 = r7.regions     // Catch:{ all -> 0x0066 }
            com.google.android.exoplayer2.upstream.cache.CachedRegionTracker$Region r1 = r7.lookupRegion     // Catch:{ all -> 0x0066 }
            java.lang.Object r0 = r0.floor(r1)     // Catch:{ all -> 0x0066 }
            com.google.android.exoplayer2.upstream.cache.CachedRegionTracker$Region r0 = (com.google.android.exoplayer2.upstream.cache.CachedRegionTracker.Region) r0     // Catch:{ all -> 0x0066 }
            r1 = -1
