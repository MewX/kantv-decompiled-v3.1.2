...
public abstract class BaseDataSource implements DataSource {
    ...
    public final void transferInitializing(DataSpec dataSpec2) {
        for (int i = 0; i < this.listenerCount; i++) {
            ((TransferListener) this.listeners.get(i)).onTransferInitializing(this, dataSpec2, this.isNetwork);
        }
    }
    ...
    public final void transferStarted(DataSpec dataSpec2) {
        ...
        for (int i = 0; i < this.listenerCount; i++) {
            ((TransferListener) this.listeners.get(i)).onTransferStart(this, dataSpec2, this.isNetwork);
        }
    }
    ...
    public final void bytesTransferred(int i) {
        ...
        for (int i2 = 0; i2 < this.listenerCount; i2++) {
            ((TransferListener) this.listeners.get(i2)).onBytesTransferred(this, dataSpec2, this.isNetwork, i);
        }
    }
    ...
    public final void transferEnded() {
        DataSpec dataSpec2 = (DataSpec) Util.castNonNull(this.dataSpec);
        for (int i = 0; i < this.listenerCount; i++) {
            ((TransferListener) this.listeners.get(i)).onTransferEnd(this, dataSpec2, this.isNetwork);
        }
        this.dataSpec = null;
    }
}
