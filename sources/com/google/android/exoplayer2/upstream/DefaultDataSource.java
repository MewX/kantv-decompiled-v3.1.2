...
public final class DefaultDataSource implements DataSource {
    ...
    public DefaultDataSource(Context context2, String str, int i, int i2, boolean z) {
        DefaultHttpDataSource defaultHttpDataSource = new DefaultHttpDataSource(str, null, i, i2, z, null);
        this(context2, defaultHttpDataSource);
    }
    ...
    public DefaultDataSource(Context context2, @Nullable TransferListener transferListener, String str, int i, int i2, boolean z) {
        DefaultHttpDataSource defaultHttpDataSource = new DefaultHttpDataSource(str, null, transferListener, i, i2, z, null);
        this(context2, transferListener, (DataSource) defaultHttpDataSource);
    }
    ...
    private void addListenersToDataSource(DataSource dataSource2) {
        for (int i = 0; i < this.transferListeners.size(); i++) {
            dataSource2.addTransferListener((TransferListener) this.transferListeners.get(i));
        }
    }
