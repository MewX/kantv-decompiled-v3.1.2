...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        public DefaultBandwidthMeter build() {
            DefaultBandwidthMeter defaultBandwidthMeter = new DefaultBandwidthMeter(this.context, this.initialBitrateEstimates, this.slidingWindowMaxWeight, this.clock, this.resetOnNetworkTypeChange);
        ...
        public synchronized void register(DefaultBandwidthMeter defaultBandwidthMeter) {
            ...
            this.mainHandler.post(new Runnable(defaultBandwidthMeter) {
                ...
                public final void run() {
                    ConnectivityActionReceiver.this.lambda$register$0$DefaultBandwidthMeter$ConnectivityActionReceiver(this.f$1);
                }
            });
        }
    ...
    private DefaultBandwidthMeter(@Nullable Context context2, SparseArray<Long> sparseArray, int i, Clock clock2, boolean z) {
        Context context3;
        int i2;
        if (context2 == null) {
            context3 = null;
    ...
    private void maybeNotifyBandwidthSample(int i, long j, long j2) {
        if (i != 0 || j != 0 || j2 != this.lastReportedBitrateEstimate) {
            ...
            $$Lambda$DefaultBandwidthMeter$5fiwNBHdIyEsfLPs7kZdGg5uwiw r1 = new Event(i, j, j2) {
