...
public class PlayerView extends FrameLayout implements AdViewProvider {
    ...
    private final class ComponentListener implements EventListener, TextOutput, VideoListener, OnLayoutChangeListener, SingleTapListener {
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        boolean z = true;
        boolean z2 = isDpadKey(keyEvent.getKeyCode()) && this.useController;
        if (z2 && !this.controller.isVisible()) {
