            ...
            if (access$500 != null) {
                if (PlayerControlView.this.nextButton == view) {
                    ...
                    if (access$500.getPlaybackState() == 1) {
                        ...
                        PlayerControlView.this.controlDispatcher.dispatchSeekTo(access$500, access$500.getCurrentWindowIndex(), C.TIME_UNSET);
                    }
            ...
            if (!currentTimeline.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (i2 == currentWindowIndex) {
                        this.currentWindowOffset = C.usToMs(j5);
                    }
                    ...
                    while (i3 <= this.window.lastPeriodIndex) {
                        ...
                        while (i5 < adGroupCount) {
                            ...
                            if (positionInWindowUs >= 0 && positionInWindowUs <= this.window.durationUs) {
                                ...
                                this.adGroupTimesMs[i4] = C.usToMs(positionInWindowUs + j5);
