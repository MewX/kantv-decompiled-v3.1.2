...
public final class Id3Decoder implements MetadataDecoder {
    ...
    private static String getCharsetName(int i) {
        return i != 1 ? i != 2 ? i != 3 ? StringUtil.__ISO_8859_1 : "UTF-8" : "UTF-16BE" : "UTF-16";
    }
    ...
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r19, com.google.android.exoplayer2.util.ParsableByteArray r20, boolean r21, int r22, @androidx.annotation.Nullable com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r23) {
        ...
        L_0x011d:
            com.google.android.exoplayer2.metadata.id3.TextInformationFrame r1 = decodeTxxxFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x0123:
            if (r8 != r1) goto L_0x0132
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            com.google.android.exoplayer2.metadata.id3.TextInformationFrame r1 = decodeTextInformationFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x012f:
            r0 = move-exception
            goto L_0x0228
        ...
        L_0x013e:
            com.google.android.exoplayer2.metadata.id3.UrlLinkFrame r1 = decodeWxxxFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x0144:
            r3 = 87
            if (r8 != r3) goto L_0x0152
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            com.google.android.exoplayer2.metadata.id3.UrlLinkFrame r1 = decodeUrlLinkFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x0152:
            r3 = 73
            r4 = 80
            ...
            com.google.android.exoplayer2.metadata.id3.PrivFrame r1 = decodePrivFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x0168:
            r5 = 71
            r6 = 79
        ...
        L_0x017a:
            com.google.android.exoplayer2.metadata.id3.GeobFrame r1 = decodeGeobFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x0180:
            r5 = 67
        ...
        L_0x0195:
            com.google.android.exoplayer2.metadata.id3.ApicFrame r1 = decodeApicFrame(r7, r15, r0)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x019b:
            r3 = 77
        ...
        L_0x01a7:
            com.google.android.exoplayer2.metadata.id3.CommentFrame r1 = decodeCommentFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x01ac:
            ...
            r5 = r22
            r6 = r23
            com.google.android.exoplayer2.metadata.id3.ChapterFrame r1 = decodeChapterFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x01c8:
            ...
            r5 = r22
            r6 = r23
            com.google.android.exoplayer2.metadata.id3.ChapterTocFrame r1 = decodeChapterTOCFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x01e0:
            ...
            com.google.android.exoplayer2.metadata.id3.MlltFrame r1 = decodeMlltFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            goto L_0x01f9
        L_0x01f1:
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            com.google.android.exoplayer2.metadata.id3.BinaryFrame r1 = decodeBinaryFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x021f }
        L_0x01f9:
            ...
            java.lang.String r0 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x021f }
            ...
            com.google.android.exoplayer2.util.Log.w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x021f }
        L_0x021b:
            r7.setPosition(r14)
            return r1
        L_0x021f:
            java.lang.String r0 = "Unsupported character encoding"
            com.google.android.exoplayer2.util.Log.w(r12, r0)     // Catch:{ all -> 0x012f }
            r7.setPosition(r14)
            return r16
        L_0x0228:
            r7.setPosition(r14)
    ...
    private static UrlLinkFrame decodeWxxxFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        String str = new String(bArr, 0, indexOfEos, charsetName);
        int delimiterLength = indexOfEos + delimiterLength(readUnsignedByte);
        return new UrlLinkFrame("WXXX", str, decodeStringIfValid(bArr, delimiterLength, indexOfZeroByte(bArr, delimiterLength), StringUtil.__ISO_8859_1));
    }
    ...
    private static UrlLinkFrame decodeUrlLinkFrame(ParsableByteArray parsableByteArray, int i, String str) throws UnsupportedEncodingException {
        ...
        return new UrlLinkFrame(str, null, new String(bArr, 0, indexOfZeroByte(bArr, 0), StringUtil.__ISO_8859_1));
    }
    ...
    private static PrivFrame decodePrivFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        return new PrivFrame(new String(bArr, 0, indexOfZeroByte, StringUtil.__ISO_8859_1), copyOfRangeIfValid(bArr, indexOfZeroByte + 1, bArr.length));
    }
    ...
    private static GeobFrame decodeGeobFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        parsableByteArray.readBytes(bArr, 0, i2);
        int indexOfZeroByte = indexOfZeroByte(bArr, 0);
        String str = new String(bArr, 0, indexOfZeroByte, StringUtil.__ISO_8859_1);
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i, int i2) throws UnsupportedEncodingException {
        ...
        String str2 = "image/";
        String str3 = StringUtil.__ISO_8859_1;
        if (i2 == 2) {
            StringBuilder sb = new StringBuilder();
            sb.append(str2);
            sb.append(Util.toLowerInvariant(new String(bArr, 0, 3, str3)));
            str = sb.toString();
            if ("image/jpg".equals(str)) {
                str = DLNAMimeTypes.MIME_IMAGE_JPEG;
            }
            i3 = 2;
        } else {
            i3 = indexOfZeroByte(bArr, 0);
            String lowerInvariant = Util.toLowerInvariant(new String(bArr, 0, i3, str3));
            if (lowerInvariant.indexOf(47) == -1) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append(str2);
                sb2.append(lowerInvariant);
                str = sb2.toString();
            } else {
                str = lowerInvariant;
            }
        }
        byte b = bArr[i3 + 1] & Draft_75.END_OF_FRAME;
        int i5 = i3 + 2;
    ...
    private static ChapterFrame decodeChapterFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, @Nullable FramePredicate framePredicate2) throws UnsupportedEncodingException {
        ...
        String str = new String(parsableByteArray2.data, position, indexOfZeroByte - position, StringUtil.__ISO_8859_1);
    ...
    private static ChapterTocFrame decodeChapterTOCFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, @Nullable FramePredicate framePredicate2) throws UnsupportedEncodingException {
        ...
        int i4 = indexOfZeroByte - position;
        String str = StringUtil.__ISO_8859_1;
        String str2 = new String(bArr, position, i4, str);
        parsableByteArray.setPosition(indexOfZeroByte + 1);
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
        ...
        for (int i5 = 0; i5 < readUnsignedByte2; i5++) {
            ...
            strArr[i5] = new String(parsableByteArray2.data, position2, indexOfZeroByte2 - position2, str);
    ...
    private static int removeUnsynchronization(ParsableByteArray parsableByteArray, int i) {
        ...
        while (true) {
            ...
            if ((bArr[i3] & Draft_75.END_OF_FRAME) == 255 && bArr[i4] == 0) {
