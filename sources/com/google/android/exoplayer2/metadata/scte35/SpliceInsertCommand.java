...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    static SpliceInsertCommand parseFromSection(ParsableByteArray parsableByteArray, long j, TimestampAdjuster timestampAdjuster) {
        ...
        if (!z6) {
            ...
            if (!z8) {
                ...
                for (int i4 = 0; i4 < readUnsignedByte2; i4++) {
                    ...
                    ComponentSplice componentSplice = new ComponentSplice(readUnsignedByte3, parseSpliceTime2, timestampAdjuster2.adjustTsTimestamp(parseSpliceTime2));
        ...
        SpliceInsertCommand spliceInsertCommand = new SpliceInsertCommand(readUnsignedInt, z6, z4, z, z3, j3, timestampAdjuster2.adjustTsTimestamp(j3), list, z2, j2, i3, i2, i);
