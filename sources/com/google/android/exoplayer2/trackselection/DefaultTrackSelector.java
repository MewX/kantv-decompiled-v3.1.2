...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public static final class Parameters extends TrackSelectionParameters {
        ...
        private Parameters() {
            String str = TrackSelectionParameters.DEFAULT.preferredAudioLanguage;
            String str2 = TrackSelectionParameters.DEFAULT.preferredTextLanguage;
            boolean z = TrackSelectionParameters.DEFAULT.selectUndeterminedTextLanguage;
            int i = TrackSelectionParameters.DEFAULT.disabledTextTrackSelectionFlags;
            SparseArray sparseArray = r1;
            SparseArray sparseArray2 = new SparseArray();
            SparseBooleanArray sparseBooleanArray = r1;
            SparseBooleanArray sparseBooleanArray2 = new SparseBooleanArray();
            this(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, true, false, true, Integer.MAX_VALUE, Integer.MAX_VALUE, true, str, Integer.MAX_VALUE, Integer.MAX_VALUE, true, false, false, str2, z, i, false, false, true, 0, sparseArray, sparseBooleanArray);
        }
    ...
    public Pair<Definition, AudioTrackScore> selectAudioTrack(TrackGroupArray trackGroupArray, int[][] iArr, int i, Parameters parameters, boolean z) throws ExoPlaybackException {
        ...
        if (!parameters2.forceHighestSupportedBitrate && !parameters2.forceLowestBitrate && z) {
            int[] adaptiveAudioTracks = getAdaptiveAudioTracks(trackGroup2, iArr[i3], parameters2.maxAudioBitrate, parameters2.allowAudioMixedMimeTypeAdaptiveness, parameters2.allowAudioMixedSampleRateAdaptiveness);
    ...
    private static int[] getAdaptiveAudioTracks(TrackGroup trackGroup, int[] iArr, int i, boolean z, boolean z2) {
        TrackGroup trackGroup2 = trackGroup;
        HashSet hashSet = new HashSet();
        ...
        for (int i3 = 0; i3 < trackGroup2.length; i3++) {
            ...
            if (hashSet.add(audioConfigurationTuple2)) {
                int adaptiveAudioTrackCount = getAdaptiveAudioTrackCount(trackGroup, iArr, audioConfigurationTuple2, i, z, z2);
        ...
        for (int i5 = 0; i5 < trackGroup2.length; i5++) {
            if (isSupportedAdaptiveAudioTrack(trackGroup.getFormat(i5), iArr[i5], audioConfigurationTuple, i, z, z2)) {
                int i6 = i4 + 1;
                iArr2[i4] = i5;
                i4 = i6;
            }
    ...
    private static int getAdaptiveAudioTrackCount(TrackGroup trackGroup, int[] iArr, AudioConfigurationTuple audioConfigurationTuple, int i, boolean z, boolean z2) {
        int i2 = 0;
        for (int i3 = 0; i3 < trackGroup.length; i3++) {
            if (isSupportedAdaptiveAudioTrack(trackGroup.getFormat(i3), iArr[i3], audioConfigurationTuple, i, z, z2)) {
                i2++;
            }
        }
        return i2;
    ...
    private static boolean isSupportedAdaptiveAudioTrack(Format format, int i, AudioConfigurationTuple audioConfigurationTuple, int i2, boolean z, boolean z2) {
    ...
    /* access modifiers changed from: protected */
    @Nullable
    public Pair<Definition, Integer> selectTextTrack(TrackGroupArray trackGroupArray, int[][] iArr, Parameters parameters, @Nullable String str) throws ExoPlaybackException {
        int i;
        TrackGroupArray trackGroupArray2 = trackGroupArray;
        Parameters parameters2 = parameters;
        int i2 = 0;
        ...
        return Pair.create(new Definition(trackGroup, i3), Integer.valueOf(i4));
    }
    ...
    protected static boolean stringDefinesNoLanguage(@Nullable String str) {
        return TextUtils.isEmpty(str) || TextUtils.equals(str, C.LANGUAGE_UNDETERMINED);
    }

    protected static int getFormatLanguageScore(Format format, @Nullable String str) {
        ...
        String str2 = "-";
        if (Util.splitAtFirst(format.language, str2)[0].equals(Util.splitAtFirst(str, str2)[0])) {
            return 1;
        }
        return 0;
    }
