...
public class DefaultRenderersFactory implements RenderersFactory {
    ...
    public void buildVideoRenderers(Context context2, int i, MediaCodecSelector mediaCodecSelector2, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager2, boolean z, boolean z2, Handler handler, VideoRendererEventListener videoRendererEventListener, long j, ArrayList<Renderer> arrayList) {
        ...
        MediaCodecVideoRenderer mediaCodecVideoRenderer = new MediaCodecVideoRenderer(context2, mediaCodecSelector2, j, drmSessionManager2, z, z2, handler, videoRendererEventListener, 50);
        ...
        if (i2 != 0) {
            ...
            try {
                arrayList2.add(size, (Renderer) Class.forName("com.google.android.exoplayer2.ext.vp9.LibvpxVideoRenderer").getConstructor(new Class[]{Long.TYPE, Handler.class, VideoRendererEventListener.class, Integer.TYPE}).newInstance(new Object[]{Long.valueOf(j), handler, videoRendererEventListener, Integer.valueOf(50)}));
    ...
    public void buildAudioRenderers(android.content.Context r15, int r16, com.google.android.exoplayer2.mediacodec.MediaCodecSelector r17, @androidx.annotation.Nullable com.google.android.exoplayer2.drm.DrmSessionManager<com.google.android.exoplayer2.drm.FrameworkMediaCrypto> r18, boolean r19, boolean r20, com.google.android.exoplayer2.audio.AudioProcessor[] r21, android.os.Handler r22, com.google.android.exoplayer2.audio.AudioRendererEventListener r23, java.util.ArrayList<com.google.android.exoplayer2.Renderer> r24) {
        ...
        L_0x0033:
            ...
            com.google.android.exoplayer2.util.Log.i(r12, r2)     // Catch:{ ClassNotFoundException -> 0x0071, Exception -> 0x0067 }
            goto L_0x0071
        L_0x0067:
            r0 = move-exception
        ...
        L_0x0071:
            ...
            com.google.android.exoplayer2.util.Log.i(r12, r2)     // Catch:{ ClassNotFoundException -> 0x00ac, Exception -> 0x00a2 }
            goto L_0x00ac
        L_0x00a2:
            r0 = move-exception
            java.lang.RuntimeException r1 = new java.lang.RuntimeException
        ...
        L_0x00ac:
            ...
            com.google.android.exoplayer2.util.Log.i(r12, r0)     // Catch:{ ClassNotFoundException -> 0x00e4, Exception -> 0x00db }
            goto L_0x00e4
        L_0x00db:
            r0 = move-exception
            java.lang.RuntimeException r1 = new java.lang.RuntimeException
