...
final class ExoPlayerImplInternal implements Callback, MediaPeriod.Callback, InvalidationListener, SourceInfoRefreshListener, PlaybackParameterListener, Sender {
    ...
    public boolean handleMessage(Message message) {
        ...
        try {
            ...
            Log.e(str, "Internal runtime error.", e3);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:72:0x00a8 A[ADDED_TO_REGION, EDGE_INSN: B:72:0x00a8->B:85:0x00a8 ?: BREAK  
    EDGE_INSN: B:72:0x00a8->B:85:0x00a8 ?: BREAK  
    EDGE_INSN: B:72:0x00a8->B:85:0x00a8 ?: BREAK  , SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
            ...
            while (playingPeriod != null && playingPeriod.prepared) {
                ...
                if (selectTracks != null) {
                    if (z) {
                        ...
                        long applyTrackSelection = playingPeriod2.applyTrackSelection(selectTracks, this.playbackInfo.positionUs, this.queue.removeAfter(playingPeriod2), zArr);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:44:0x010c A[LOOP:0: B:44:0x010c->B:56:0x010c, LOOP_START, PHI: r14 
      PHI: (r14v12 com.google.android.exoplayer2.MediaPeriodHolder) = (r14v9 com.google.android.exoplayer2.MediaPeriodHolder), (r14v13 com.google.android.exoplayer2.MediaPeriodHolder) binds: [B:43:0x010a, B:56:0x010c] A[DONT_GENERATE, DONT_INLINE]] */
