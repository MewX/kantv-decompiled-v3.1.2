...
public final class MpegAudioHeader {
    ...
    public static int getFrameSize(int i) {
        ...
        if (i2 == 3) {
            return ((i8 * IjkMediaMeta.FF_PROFILE_H264_HIGH_444) / i6) + i7;
        }
        if (i3 == 1) {
            i9 = 72;
        }
    ...
    public static boolean populateHeader(int i, MpegAudioHeader mpegAudioHeader) {
        ...
        if (i6 == 3) {
            ...
            i3 = ((i14 * IjkMediaMeta.FF_PROFILE_H264_HIGH_444) / i10) + i11;
            i4 = i14;
            i2 = 1152;
        } else {
            ...
            i3 = (((i6 == 1 ? 72 : IjkMediaMeta.FF_PROFILE_H264_HIGH_444) * i15) / i10) + i11;
            i4 = i15;
            i2 = i12;
        }
