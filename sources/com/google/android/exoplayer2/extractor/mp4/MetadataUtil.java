...
final class MetadataUtil {
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        if (readInt2 == i) {
            ...
            String str2 = parseFullAtomFlags == 13 ? DLNAMimeTypes.MIME_IMAGE_JPEG : parseFullAtomFlags == 14 ? DLNAMimeTypes.MIME_IMAGE_PNG : null;
            if (str2 == null) {
                StringBuilder sb = new StringBuilder();
        ...
        Log.w(str, "Failed to parse cover art attribute");
        return null;
    }
