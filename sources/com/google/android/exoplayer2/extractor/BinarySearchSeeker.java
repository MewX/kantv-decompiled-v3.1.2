...
public abstract class BinarySearchSeeker {
    ...
    protected BinarySearchSeeker(SeekTimestampConverter seekTimestampConverter, TimestampSeeker timestampSeeker2, long j, long j2, long j3, long j4, long j5, long j6, int i) {
        ...
        BinarySearchSeekMap binarySearchSeekMap = new BinarySearchSeekMap(seekTimestampConverter, j, j2, j3, j4, j5, j6);
    ...
    public SeekOperationParams createSeekParamsForTargetTimeUs(long j) {
        long j2 = j;
        SeekOperationParams seekOperationParams2 = new SeekOperationParams(j2, this.seekMap.timeUsToTargetTime(j2), this.seekMap.floorTimePosition, this.seekMap.ceilingTimePosition, this.seekMap.floorBytePosition, this.seekMap.ceilingBytePosition, this.seekMap.approxBytesPerFrame);
