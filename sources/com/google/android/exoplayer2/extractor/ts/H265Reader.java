...
public final class H265Reader implements ElementaryStreamReader {
    ...
    private static Format parseMediaFormat(String str, NalUnitTargetBuffer nalUnitTargetBuffer, NalUnitTargetBuffer nalUnitTargetBuffer2, NalUnitTargetBuffer nalUnitTargetBuffer3) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            readUnsignedExpGolombCodedInt2 -= ((readUnsignedExpGolombCodedInt == 1 || readUnsignedExpGolombCodedInt == 2) ? 2 : 1) * (parsableNalUnitBitArray.readUnsignedExpGolombCodedInt() + parsableNalUnitBitArray.readUnsignedExpGolombCodedInt());
            readUnsignedExpGolombCodedInt3 -= (readUnsignedExpGolombCodedInt == 1 ? 2 : 1) * (parsableNalUnitBitArray.readUnsignedExpGolombCodedInt() + parsableNalUnitBitArray.readUnsignedExpGolombCodedInt());
        }
        ...
        if (parsableNalUnitBitArray.readBit()) {
            for (int i6 = 0; i6 < parsableNalUnitBitArray.readUnsignedExpGolombCodedInt(); i6++) {
                parsableNalUnitBitArray.skipBits(readUnsignedExpGolombCodedInt4 + 4 + 1);
            }
        }
        parsableNalUnitBitArray.skipBits(2);
        float f2 = 1.0f;
        if (parsableNalUnitBitArray.readBit() && parsableNalUnitBitArray.readBit()) {
            ...
            return Format.createVideoSampleFormat(str, MimeTypes.VIDEO_H265, null, -1, -1, i3, i4, -1.0f, Collections.singletonList(bArr), -1, f, null);
        }
        f = 1.0f;
        return Format.createVideoSampleFormat(str, MimeTypes.VIDEO_H265, null, -1, -1, i3, i4, -1.0f, Collections.singletonList(bArr), -1, f, null);
    }
