...
public final class FrameworkMediaDrm implements ExoMediaDrm<FrameworkMediaCrypto> {
    ...
    public /* synthetic */ void lambda$setOnEventListener$0$FrameworkMediaDrm(OnEventListener onEventListener, MediaDrm mediaDrm2, byte[] bArr, int i, int i2, byte[] bArr2) {
    ...
    public /* synthetic */ void lambda$setOnKeyStatusChangeListener$1$FrameworkMediaDrm(com.google.android.exoplayer2.drm.ExoMediaDrm.OnKeyStatusChangeListener r4, android.media.MediaDrm r5, byte[] r6, java.util.List<android.media.MediaDrm.KeyStatus> r7, boolean r8) {
        /*
            r3 = this;
        ...
        L_0x0026:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.drm.FrameworkMediaDrm.lambda$setOnKeyStatusChangeListener$1$FrameworkMediaDrm(com.google.android.exoplayer2.drm.ExoMediaDrm$OnKeyStatusChangeListener, android.media.MediaDrm, byte[], java.util.List, boolean):void");
    }
    ...
    private static byte[] addLaUrlAttributeIfMissing(byte[] bArr) {
        ...
        if (readLittleEndianShort == 1 && readLittleEndianShort2 == 1) {
            ...
            String str2 = C.UTF16LE_NAME;
            String readString = parsableByteArray.readString(readLittleEndianShort3, Charset.forName(str2));
            if (readString.contains("<LA_URL>")) {
                return bArr;
            }
            int indexOf = readString.indexOf("</DATA>");
            if (indexOf == -1) {
                Log.w(str, "Could not find the </DATA> tag. Skipping LA_URL workaround.");
            }
        ...
        Log.i(str, "Unexpected record count or type. Skipping LA_URL workaround.");
        return bArr;
    }
}
