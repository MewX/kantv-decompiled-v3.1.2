...
public final class OfflineLicenseHelper<T extends ExoMediaCrypto> {
    ...
    public static OfflineLicenseHelper<FrameworkMediaCrypto> newWidevineInstance(String str, boolean z, Factory factory, @Nullable HashMap<String, String> hashMap) throws UnsupportedDrmException {
    ...
    private byte[] blockingKeyRequest(int i, @Nullable byte[] bArr, DrmInitData drmInitData) throws DrmSessionException {
