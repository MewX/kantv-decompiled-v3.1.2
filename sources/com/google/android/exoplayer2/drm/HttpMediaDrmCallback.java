...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    public byte[] executeKeyRequest(UUID uuid, KeyRequest keyRequest) throws Exception {
        ...
        String str = C.PLAYREADY_UUID.equals(uuid) ? MimeTypes.TEXT_XML : C.CLEARKEY_UUID.equals(uuid) ? "application/json" : "application/octet-stream";
    ...
    private static byte[] executePost(com.google.android.exoplayer2.upstream.HttpDataSource.Factory r17, java.lang.String r18, byte[] r19, @androidx.annotation.Nullable java.util.Map<java.lang.String, java.lang.String> r20) throws java.io.IOException {
        /*
