...
public class DefaultLoadControl implements LoadControl {
    ...
    protected DefaultLoadControl(DefaultAllocator defaultAllocator, int i, int i2, int i3, int i4, int i5, int i6, boolean z, int i7, boolean z2) {
        ...
        this.allocator = defaultAllocator;
        this.minBufferAudioUs = C.msToUs((long) i8);
        this.minBufferVideoUs = C.msToUs((long) i9);
        this.maxBufferUs = C.msToUs((long) i10);
        this.bufferForPlaybackUs = C.msToUs((long) i11);
        this.bufferForPlaybackAfterRebufferUs = C.msToUs((long) i12);
        this.targetBufferBytesOverwrite = i6;
        this.prioritizeTimeOverSizeThresholds = z;
        this.backBufferDurationUs = C.msToUs((long) i13);
