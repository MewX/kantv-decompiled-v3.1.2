...
public abstract class DownloadService extends Service {
    ...
    private final class ForegroundNotificationUpdater {
        ...
        /* access modifiers changed from: private */
        public void update() {
            List currentDownloads = DownloadService.this.downloadManager.getCurrentDownloads();
    ...
    public void onDestroy() {
        ...
        ((DownloadManagerHelper) downloadManagerListeners.get(getClass())).detachService(this, true ^ this.downloadManager.isWaitingForRequirements());
