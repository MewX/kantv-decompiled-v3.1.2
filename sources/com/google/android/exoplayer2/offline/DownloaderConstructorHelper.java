...
public final class DownloaderConstructorHelper {
    ...
    public DownloaderConstructorHelper(Cache cache2, Factory factory, @Nullable Factory factory2, @Nullable DataSink.Factory factory3, @Nullable PriorityTaskManager priorityTaskManager2, @Nullable CacheKeyFactory cacheKeyFactory2) {
        Factory factory4;
        Factory factory5;
        Cache cache3 = cache2;
        ...
        if (factory2 != null) {
            ...
            factory5 = new FileDataSourceFactory();
        }
        Cache cache4 = cache2;
