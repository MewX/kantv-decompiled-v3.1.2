...
public final class DownloadManager {
    ...
    private static final class InternalHandler extends Handler {
        ...
        private void setStopReason(@Nullable String str, int i) {
            ...
            if (str == null) {
                ...
                try {
                    ...
                    Log.e(str2, "Failed to set manual stop reason", e);
                }
            } else {
        ...
        private void removeAllDownloads() {
            ...
            String str = DownloadManager.TAG;
            ...
            try {
                ...
                Log.e(str, "Failed to load downloads.");
            } catch (Throwable th) {
                r5.addSuppressed(th);
            }
            for (int i = 0; i < this.downloads.size(); i++) {
                ArrayList<Download> arrayList2 = this.downloads;
                arrayList2.set(i, copyDownloadWithState((Download) arrayList2.get(i), 5));
            }
            ...
            try {
                ...
                Log.e(str, "Failed to update index.", e);
            }
            ArrayList arrayList3 = new ArrayList(this.downloads);
            for (int i3 = 0; i3 < this.downloads.size(); i3++) {
                this.mainHandler.obtainMessage(2, new DownloadUpdate((Download) this.downloads.get(i3), false, arrayList3)).sendToTarget();
            }
            syncTasks();
            return;
            throw th;
        ...
        private void syncTasks() {
            ...
            for (int i2 = 0; i2 < this.downloads.size(); i2++) {
                ...
                Task task = (Task) this.activeTasks.get(download.request.id);
        ...
        private void onTaskStopped(Task task) {
            ...
            if (access$500 != null) {
                ...
                Log.e(DownloadManager.TAG, sb.toString(), access$500);
            }
            Download download = (Download) Assertions.checkNotNull(getDownload(str, false));
        ...
        private Download getDownload(String str, boolean z) {
            ...
            if (z) {
                try {
                    ...
                    sb.append(str);
                    Log.e(DownloadManager.TAG, sb.toString(), e);
                }
            }
            return null;
        }
