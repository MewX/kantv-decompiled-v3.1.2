...
public final class DownloadHelper {
    ...
    public static final Parameters DEFAULT_TRACK_SELECTOR_PARAMETERS = new ParametersBuilder().setForceHighestSupportedBitrate(true).build();
    ...
    private final DefaultTrackSelector trackSelector = new DefaultTrackSelector((Factory) new Factory());
    ...
    private static final class MediaPreparer implements SourceInfoRefreshListener, com.google.android.exoplayer2.source.MediaPeriod.Callback, android.os.Handler.Callback {
    ...
    public static DownloadHelper forProgressive(Uri uri2, @Nullable String str) {
        DownloadHelper downloadHelper = new DownloadHelper(DownloadRequest.TYPE_PROGRESSIVE, uri2, str, null, DEFAULT_TRACK_SELECTOR_PARAMETERS, new RendererCapabilities[0]);
        return downloadHelper;
    }

    public static DownloadHelper forDash(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory) {
        return forDash(uri2, factory, renderersFactory, null, DEFAULT_TRACK_SELECTOR_PARAMETERS);
    }

    public static DownloadHelper forDash(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, Parameters parameters) {
        DownloadHelper downloadHelper = new DownloadHelper(DownloadRequest.TYPE_DASH, uri2, null, DASH_FACTORY.createMediaSource(uri2, factory, null), parameters, Util.getRendererCapabilities(renderersFactory, drmSessionManager));
        return downloadHelper;
    }

    public static DownloadHelper forHls(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory) {
        return forHls(uri2, factory, renderersFactory, null, DEFAULT_TRACK_SELECTOR_PARAMETERS);
    }

    public static DownloadHelper forHls(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, Parameters parameters) {
        DownloadHelper downloadHelper = new DownloadHelper(DownloadRequest.TYPE_HLS, uri2, null, HLS_FACTORY.createMediaSource(uri2, factory, null), parameters, Util.getRendererCapabilities(renderersFactory, drmSessionManager));
        return downloadHelper;
    }

    public static DownloadHelper forSmoothStreaming(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory) {
        return forSmoothStreaming(uri2, factory, renderersFactory, null, DEFAULT_TRACK_SELECTOR_PARAMETERS);
    }

    public static DownloadHelper forSmoothStreaming(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, Parameters parameters) {
        DownloadHelper downloadHelper = new DownloadHelper(DownloadRequest.TYPE_SS, uri2, null, SS_FACTORY.createMediaSource(uri2, factory, null), parameters, Util.getRendererCapabilities(renderersFactory, drmSessionManager));
        return downloadHelper;
    }
    ...
    public DownloadHelper(String str, Uri uri2, @Nullable String str2, @Nullable MediaSource mediaSource2, Parameters parameters, RendererCapabilities[] rendererCapabilitiesArr) {
    ...
    public void addAudioLanguagesToSelection(String... strArr) {
        ...
        for (int i = 0; i < this.mappedTrackInfos.length; i++) {
            ParametersBuilder buildUpon = DEFAULT_TRACK_SELECTOR_PARAMETERS.buildUpon();
