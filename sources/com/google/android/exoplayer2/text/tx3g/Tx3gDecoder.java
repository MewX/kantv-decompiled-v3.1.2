...
public final class Tx3gDecoder extends SimpleSubtitleDecoder {
    ...
    public Tx3gDecoder(List<byte[]> list) {
        ...
        if (list != null && list.size() == 1 && (((byte[]) list.get(0)).length == 48 || ((byte[]) list.get(0)).length == 53)) {
            ...
            this.defaultColorRgba = ((bArr[26] & Draft_75.END_OF_FRAME) << 24) | ((bArr[27] & Draft_75.END_OF_FRAME) << 16) | ((bArr[28] & Draft_75.END_OF_FRAME) << 8) | (bArr[29] & Draft_75.END_OF_FRAME);
            ...
            if (this.customVerticalPlacement) {
                this.defaultVerticalPlacement = ((float) ((bArr[11] & Draft_75.END_OF_FRAME) | ((bArr[10] & Draft_75.END_OF_FRAME) << 8))) / ((float) this.calculatedVideoTrackHeight);
    ...
    public Subtitle decode(byte[] bArr, int i, boolean z) throws SubtitleDecoderException {
        ...
        Cue cue = new Cue(spannableStringBuilder, null, f, 0, 0, Float.MIN_VALUE, Integer.MIN_VALUE, Float.MIN_VALUE);
    ...
    private static String readSubtitleText(ParsableByteArray parsableByteArray2) throws SubtitleDecoderException {
        ...
        if (parsableByteArray2.bytesLeft() >= 2) {
            char peekChar = parsableByteArray2.peekChar();
