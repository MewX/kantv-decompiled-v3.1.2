...
public final class SsaDecoder extends SimpleSubtitleDecoder {
    ...
    private void parseDialogueLine(String str, List<Cue> list, LongArray longArray) {
        ...
        String str5 = "\n";
        list.add(new Cue(replaceAll.replaceAll("\\\\N", str5).replaceAll("\\\\n", str5)));
    ...
    public static long parseTimecodeUs(String str) {
        ...
        return (Long.parseLong(matcher.group(1)) * 60 * 60 * 1000000) + (Long.parseLong(matcher.group(2)) * 60 * 1000000) + (Long.parseLong(matcher.group(3)) * 1000000) + (Long.parseLong(matcher.group(4)) * NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS);
    }
}
