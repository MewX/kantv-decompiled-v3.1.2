...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        TtmlNode ttmlNode = new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(str), C.TIME_UNSET, C.TIME_UNSET, null, null, "", null);
        return ttmlNode;
    }
    ...
    public List<Cue> getCues(long j, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2, Map<String, String> map3) {
        ...
        for (Pair pair : arrayList) {
            ...
            if (str != null) {
                ...
                Cue cue = new Cue(BitmapFactory.decodeByteArray(decode, 0, decode.length), ttmlRegion.position, 0, ttmlRegion.line, ttmlRegion.lineAnchor, ttmlRegion.width, ttmlRegion.height);
                arrayList2.add(cue);
            }
        }
