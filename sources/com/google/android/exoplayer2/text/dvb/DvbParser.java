...
final class DvbParser {
    ...
    private static final byte[] defaultMap4To8 = {0, 17, 34, 51, 68, 85, 102, 119, -120, -103, -86, -69, Code.UINT8, Code.ARRAY32, -18, -1};
            ...
            case 17:
                ...
                if (readBits2 == subtitleService2.subtitlePageId && pageComposition2 != null) {
                    ...
                    if (pageComposition2.state == 0) {
                        parseRegionComposition.mergeFrom((RegionComposition) subtitleService2.regions.get(parseRegionComposition.id));
                    }
    ...
    private static int[] generateDefault4BitClutEntries() {
        ...
        for (int i = 1; i < iArr.length; i++) {
            if (i < 8) {
                ...
                int i2 = i & 1;
                int i3 = AVException.INVALID_PHONE_NUMBER;
                int i4 = i2 != 0 ? AVException.INVALID_PHONE_NUMBER : 0;
                int i5 = (i & 2) != 0 ? AVException.INVALID_PHONE_NUMBER : 0;
                if ((i & 4) == 0) {
                    i3 = 0;
                }
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i = 0; i < iArr.length; i++) {
            ...
            if (i < 8) {
                ...
                int i5 = i & 136;
                int i6 = OpType.block_VALUE;
                int i7 = 85;
                if (i5 == 0) {
                    int i8 = ((i & 1) != 0 ? 85 : 0) + ((i & 16) != 0 ? OpType.block_VALUE : 0);
                    int i9 = ((i & 2) != 0 ? 85 : 0) + ((i & 32) != 0 ? OpType.block_VALUE : 0);
                    if ((i & 4) == 0) {
                        i7 = 0;
                    }
                    if ((i & 64) == 0) {
                    ...
                    int i10 = 43;
                    if (i5 == 128) {
                        int i11 = ((i & 1) != 0 ? 43 : 0) + AVException.INVALID_PHONE_NUMBER + ((i & 16) != 0 ? 85 : 0);
                        int i12 = ((i & 2) != 0 ? 43 : 0) + AVException.INVALID_PHONE_NUMBER + ((i & 32) != 0 ? 85 : 0);
                        if ((i & 4) == 0) {
                            i10 = 0;
                        }
                        int i13 = i10 + AVException.INVALID_PHONE_NUMBER;
                        if ((i & 64) == 0) {
                            i7 = 0;
                        }
                    ...
                    int i16 = ((i & 1) != 0 ? 85 : 0) + ((i & 16) != 0 ? OpType.block_VALUE : 0);
                    int i17 = ((i & 2) != 0 ? 85 : 0) + ((i & 32) != 0 ? OpType.block_VALUE : 0);
                    if ((i & 4) == 0) {
                        i7 = 0;
                    }
                    if ((i & 64) == 0) {
                    ...
                    iArr[i] = getColor(AVException.INVALID_PHONE_NUMBER, i16, i17, i7 + i6);
                }
            }
        }
        return iArr;
