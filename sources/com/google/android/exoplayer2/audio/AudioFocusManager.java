...
public final class AudioFocusManager {
        ...
        public void onAudioFocusChange(int i) {
            if (i != -3) {
                if (i == -2) {
                    ...
                    sb.append(i);
                    Log.w(AudioFocusManager.TAG, sb.toString());
                    return;
                } else {
                    AudioFocusManager.this.audioFocusState = 1;
                }
    ...
    private static int convertAudioAttributesToFocusGain(@Nullable AudioAttributes audioAttributes2) {
        ...
        switch (i) {
            case 0:
                Log.w(str, "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
