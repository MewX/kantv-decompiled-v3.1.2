...
public final class Ac4Util {
    ...
    private static final int[] SAMPLE_COUNT = {CastStatusCodes.CANCELED, 2000, 1920, 1601, 1600, 1001, 1000, 960, 800, 800, 480, 400, 400, 2048};
    ...
    public static int parseAc4SyncframeSize(byte[] bArr, int i) {
        ...
        byte b = ((bArr[2] & Draft_75.END_OF_FRAME) << 8) | (bArr[3] & Draft_75.END_OF_FRAME);
        if (b == 65535) {
            b = ((bArr[4] & Draft_75.END_OF_FRAME) << 16) | ((bArr[5] & Draft_75.END_OF_FRAME) << 8) | (bArr[6] & Draft_75.END_OF_FRAME);
        } else {
            i2 = 4;
        }
        if (i == 44097) {
