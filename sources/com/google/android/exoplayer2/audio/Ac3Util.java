...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, Opcodes.IF_ICMPNE, 192, 224, 256, 320, 384, 448, 512, 576, 640};
    private static final int[] BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD = {1, 2, 3, 6};
    private static final int[] CHANNEL_COUNT_BY_ACMOD = {2, 1, 2, 3, 3, 4, 4, 5};
    private static final int[] SAMPLE_RATE_BY_FSCOD = {48000, 44100, 32000};
    private static final int[] SAMPLE_RATE_BY_FSCOD2 = {24000, 22050, 16000};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, AVException.INVALID_ROLE_NAME, OpType.members_blocked_VALUE, AVException.ACCOUNT_ALREADY_LINKED, 243, 278, 348, 417, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static int parseAc3SyncframeSize(byte[] bArr) {
        ...
        if (!(((bArr[5] & Draft_75.END_OF_FRAME) >> 3) == 16)) {
            return getAc3SyncframeSize((bArr[4] & Code.NIL) >> 6, bArr[4] & 63);
        }
        return (((bArr[3] & Draft_75.END_OF_FRAME) | ((bArr[2] & 7) << 8)) + 1) * 2;
    }

    public static int parseEAc3SyncframeAudioSampleCount(ByteBuffer byteBuffer) {
        int i = 6;
        if (((byteBuffer.get(byteBuffer.position() + 4) & Code.NIL) >> 6) != 3) {
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(byte[] bArr) {
        ...
        if ((bArr[7] & Draft_75.END_OF_FRAME) == 187) {
            z = true;
        }
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(ByteBuffer byteBuffer, int i) {
        return 40 << ((byteBuffer.get((byteBuffer.position() + i) + ((byteBuffer.get((byteBuffer.position() + i) + 7) & Draft_75.END_OF_FRAME) == 187 ? 9 : 8)) >> 4) & 7);
    }
