...
public class MurmurHash3 {
    ...
    public static int murmurhash3_x86_32(byte[] bArr, int i, int i2, int i3) {
        int i4 = (i2 & -4) + i;
        while (i < i4) {
            int i5 = ((bArr[i] & Draft_75.END_OF_FRAME) | ((bArr[i + 1] & Draft_75.END_OF_FRAME) << 8) | ((bArr[i + 2] & Draft_75.END_OF_FRAME) << 16) | (bArr[i + 3] << 24)) * -862048943;
        ...
        if (i8 != 1) {
            if (i8 != 2) {
                if (i8 == 3) {
                    i7 = (bArr[i4 + 2] & Draft_75.END_OF_FRAME) << 16;
                }
                int i9 = i3 ^ i2;
            ...
            i7 |= (bArr[i4 + 1] & Draft_75.END_OF_FRAME) << 8;
        }
        int i12 = ((bArr[i4] & Draft_75.END_OF_FRAME) | i7) * -862048943;
