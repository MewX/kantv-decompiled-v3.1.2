...
public final class zzjs extends zzge {
    ...
    private static final List<String> zzua = Collections.unmodifiableList(Arrays.asList(new String[]{"source", Param.MEDIUM, Param.CAMPAIGN, Param.TERM, "content"}));
    private int zzag;
    ...
    public final zzai zza(String str, String str2, Bundle bundle, String str3, long j, boolean z, boolean z2) {
        ...
        if (zzbl(str2) == 0) {
            ...
            zzai zzai = new zzai(str2, new zzah(zzg(zza(str, str2, bundle2, CollectionUtils.listOf(str4), false, false))), str3, j);
            return zzai;
        }
