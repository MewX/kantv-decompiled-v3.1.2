...
final class zzx extends zzjh {
    ...
    public final void zzb(List<Long> list) {
        ...
        if (zzcg()) {
            ...
            try {
                SQLiteDatabase writableDatabase = getWritableDatabase();
                StringBuilder sb4 = new StringBuilder(String.valueOf(sb2).length() + AVException.INVALID_PHONE_NUMBER);
    ...
    private final boolean zza(String str, List<Integer> list) {
        ...
        try {
            ...
            sb.append(")");
            String sb2 = sb.toString();
            StringBuilder sb3 = new StringBuilder(String.valueOf(sb2).length() + AVException.EXCEEDED_QUOTA);
