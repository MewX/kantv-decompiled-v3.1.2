        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                if (zzg != null) {
                    ...
                    zza(sb, 1, Constants.PARAM_PLATFORM, (Object) zzg.zzom());
                    if (zzg.zzoq()) {
                    ...
                    if (zzg.zzpn()) {
                        zza(sb, 1, OnNativeInvokeListener.ARG_RETRY_COUNTER, (Object) Integer.valueOf(zzg.zzpo()));
                    }
                    ...
                    if (zznl != null) {
                        for (zzc zzc : zznl) {
                            if (zzc != null) {
                                ...
                                if (zzc.zzmp()) {
                                    zza(sb, 2, ConversationControlOp.COUNT, (Object) Integer.valueOf(zzc.getCount()));
                                }
                                if (zzc.zzmk() != 0) {
