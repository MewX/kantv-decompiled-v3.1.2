...
final class zzai extends zzc {
    ...
    public final void zzb(com.google.android.gms.internal.cast.zzcn r8) {
        /*
            ...
            monitor-enter(r8)
            com.google.android.gms.cast.framework.media.RemoteMediaClient r0 = r7.zzoq     // Catch:{ all -> 0x00a2 }
            int r1 = r7.zzfu     // Catch:{ all -> 0x00a2 }
            int r0 = r0.zzc(r1)     // Catch:{ all -> 0x00a2 }
            r1 = -1
            r2 = 0
            ...
            return
        L_0x0023:
            int r1 = r7.zzfv     // Catch:{ all -> 0x00a2 }
            r3 = 1
            ...
            int r6 = r7.zzfv     // Catch:{ all -> 0x00a2 }
        ...
        L_0x0060:
            ...
            int r0 = r7.zzfv     // Catch:{ all -> 0x00a2 }
            int r0 = r0 + r3
            goto L_0x006a
        L_0x0068:
            int r0 = r7.zzfv     // Catch:{ all -> 0x00a2 }
        L_0x006a:
            com.google.android.gms.cast.framework.media.RemoteMediaClient r1 = r7.zzoq     // Catch:{ all -> 0x00a2 }
        ...
        L_0x007b:
            r0 = 0
        L_0x007c:
            com.google.android.gms.cast.framework.media.RemoteMediaClient r1 = r7.zzoq     // Catch:{ zzdk | IllegalStateException -> 0x0090 }
            com.google.android.gms.internal.cast.zzdh r1 = r1.zzex     // Catch:{ zzdk | IllegalStateException -> 0x0090 }
            com.google.android.gms.internal.cast.zzdm r4 = r7.zzgd     // Catch:{ zzdk | IllegalStateException -> 0x0090 }
            int[] r3 = new int[r3]     // Catch:{ zzdk | IllegalStateException -> 0x0090 }
            int r5 = r7.zzfu     // Catch:{ zzdk | IllegalStateException -> 0x0090 }
            r3[r2] = r5     // Catch:{ zzdk | IllegalStateException -> 0x0090 }
            org.json.JSONObject r2 = r7.zzfk     // Catch:{ zzdk | IllegalStateException -> 0x0090 }
            r1.zza(r4, r3, r0, r2)     // Catch:{ zzdk | IllegalStateException -> 0x0090 }
            goto L_0x00a0
        L_0x0090:
            com.google.android.gms.common.api.Status r0 = new com.google.android.gms.common.api.Status     // Catch:{ all -> 0x00a2 }
