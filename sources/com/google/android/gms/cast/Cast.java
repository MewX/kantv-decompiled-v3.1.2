...
public final class Cast {
    ...
    public static final Api<CastOptions> API = new Api<>("Cast.API", CLIENT_BUILDER, zzdf.zzwy);
    @VisibleForTesting
    ...
    public interface CastApi {
        ...
        public static final class zza implements CastApi {
            public final void requestStatus(GoogleApiClient googleApiClient) throws IOException, IllegalStateException {
                try {
                    ((zzcn) googleApiClient.getClient(zzdf.zzwy)).requestStatus();
            ...
            private final PendingResult<ApplicationConnectionResult> zza(GoogleApiClient googleApiClient, String str, String str2, zzag zzag) {
                zzi zzi = new zzi(this, googleApiClient, str, str2, null);
                return googleApiClient.execute(zzi);
            }
