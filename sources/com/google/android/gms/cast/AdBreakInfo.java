...
public class AdBreakInfo extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public AdBreakInfo build() {
            AdBreakInfo adBreakInfo = new AdBreakInfo(this.zzq, this.zze, this.zzg, this.zzr, this.zzs, this.zzt);
            return adBreakInfo;
        }
    }
        ...
        if (jSONObject.has(str)) {
            ...
            if (jSONObject.has(str2)) {
                try {
                    ...
                    AdBreakInfo adBreakInfo = new AdBreakInfo(j, string, j2, optBoolean, strArr, jSONObject.optBoolean("isEmbedded"));
                    return adBreakInfo;
