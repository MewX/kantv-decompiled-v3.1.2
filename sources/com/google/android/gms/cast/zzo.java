...
final class zzo extends AbstractClientBuilder<zzea, CastRemoteDisplayOptions> {
    ...
    public final /* synthetic */ Client buildClient(Context context, Looper looper, ClientSettings clientSettings, Object obj, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        bundle.putInt("configuration", castRemoteDisplayOptions.zzbc);
        zzea zzea = new zzea(context, looper, clientSettings, castRemoteDisplayOptions.zzai, bundle, castRemoteDisplayOptions.zzbb, connectionCallbacks, onConnectionFailedListener);
        return zzea;
    }
}
