...
public final class zzch extends GoogleApi<NoOptions> {
    ...
    public final Task<Void> zza(@NonNull String[] strArr, String str, List<zzbq> list) {
        return doWrite((TaskApiCall<A, TResult>) new zzcj<A,TResult>(this, strArr, str, null));
    }
}
