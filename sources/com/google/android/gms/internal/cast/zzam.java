...
public final class zzam extends View {
    ...
    public final synchronized void zzb(List<AdBreakInfo> list, @ColorInt int i) {
        this.zzdi = list;
        this.zzqm = new Paint(1);
        this.zzqm.setColor(-1);
        this.zzqm.setStyle(Style.FILL);
        invalidate();
    }
    ...
    public final synchronized void onDraw(@androidx.annotation.NonNull android.graphics.Canvas r9) {
        /*
            ...
            java.util.List<com.google.android.gms.cast.AdBreakInfo> r0 = r8.zzdi     // Catch:{ all -> 0x0076 }
        ...
        L_0x0011:
            ...
            int r1 = r1 - r2
            java.util.List<com.google.android.gms.cast.AdBreakInfo> r2 = r8.zzdi     // Catch:{ all -> 0x0076 }
        ...
        L_0x0031:
            ...
            int r5 = r8.zzql     // Catch:{ all -> 0x0076 }
            long r5 = (long) r5
            int r7 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r7 > 0) goto L_0x0031
            double r3 = (double) r3
            ...
            int r5 = r8.zzqk     // Catch:{ all -> 0x0076 }
            float r5 = (float) r5     // Catch:{ all -> 0x0076 }
            android.graphics.Paint r6 = r8.zzqm     // Catch:{ all -> 0x0076 }
