...
public abstract class zzqj extends zzpr {
    ...
    static class zza extends zzqj {
        ...
        public final void zzay(int i) throws IOException {
            if (!zzqj.zzawt || zzpp.zzna() || zzoi() < 5) {
                ...
                this.position = i16 + 1;
                zztx.zza(bArr11, (long) i16, (byte) i15);
            }
        }
        ...
        public final void zzp(long j) throws IOException {
            if (!zzqj.zzawt || zzoi() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zztx.zza(bArr3, (long) i3, (byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
        ...
        public final void zzcz(String str) throws IOException {
            ...
            try {
                ...
                if (zzbd2 == zzbd) {
                    ...
                    int zza = zztz.zza(str, this.buffer, this.position, zzoi());
                    this.position = i;
                    zzay((zza - i) - zzbd2);
                    this.position = zza;
                    return;
    ...
    static final class zzd extends zzqj {
        ...
        public final void zzay(int i) throws IOException {
            while ((i & -128) != 0) {
                this.zzawy.put((byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128));
                i >>>= 7;
            }
            try {
        ...
        public final void zzp(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.zzawy.put((byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128));
                j >>>= 7;
            }
            try {
        ...
        public final void zzay(int i) throws IOException {
            if (this.zzaxd <= this.zzaxc) {
                while ((i & -128) != 0) {
                    long j = this.zzaxd;
                    this.zzaxd = j + 1;
                    zztx.zza(j, (byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128));
                    i >>>= 7;
                }
                long j2 = this.zzaxd;
                this.zzaxd = 1 + j2;
            ...
            while (true) {
                long j3 = this.zzaxd;
                if (j3 >= this.zzaxb) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j3), Long.valueOf(this.zzaxb), Integer.valueOf(1)}));
                } else if ((i & -128) == 0) {
                    this.zzaxd = 1 + j3;
                    zztx.zza(j3, (byte) i);
                    return;
                    ...
                    this.zzaxd = j3 + 1;
                    zztx.zza(j3, (byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128));
                    i >>>= 7;
                }
            }
        }
        ...
        public final void zzp(long j) throws IOException {
            if (this.zzaxd <= this.zzaxc) {
                while ((j & -128) != 0) {
                    long j2 = this.zzaxd;
                    this.zzaxd = j2 + 1;
                    zztx.zza(j2, (byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128));
                    j >>>= 7;
                }
                long j3 = this.zzaxd;
                this.zzaxd = 1 + j3;
            ...
            while (true) {
                long j4 = this.zzaxd;
                if (j4 >= this.zzaxb) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j4), Long.valueOf(this.zzaxb), Integer.valueOf(1)}));
                } else if ((j & -128) == 0) {
                    this.zzaxd = 1 + j4;
                    ...
                    this.zzaxd = j4 + 1;
                    zztx.zza(j4, (byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128));
                    j >>>= 7;
                }
            }
        }
