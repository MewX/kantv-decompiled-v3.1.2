...
import com.google.android.gms.internal.gtm.zzc.C0002zzc;
import java.io.IOException;

public final class zzh extends zzuq<zzh> {
    public zzl[] zzpe;
    public zzl[] zzpf;
    public C0002zzc[] zzpg;

    public zzh() {
        this.zzpe = zzl.zzaa();
        this.zzpf = zzl.zzaa();
        this.zzpg = new C0002zzc[0];
        this.zzbhb = null;
        this.zzbhl = -1;
    }
    ...
    public final void zza(zzuo zzuo) throws IOException {
        ...
        C0002zzc[] zzcArr = this.zzpg;
        if (zzcArr != null && zzcArr.length > 0) {
            while (true) {
                C0002zzc[] zzcArr2 = this.zzpg;
                if (i >= zzcArr2.length) {
                    break;
                }
                C0002zzc zzc = zzcArr2[i];
                if (zzc != null) {
                    zzuo.zze(3, (zzsk) zzc);
                }
                i++;
    ...
    public final /* synthetic */ zzuw zza(zzun zzun) throws IOException {
        while (true) {
            ...
            if (zzni == 10) {
                ...
                C0002zzc[] zzcArr2 = new C0002zzc[(zzb3 + length3)];
                if (length3 != 0) {
                    System.arraycopy(this.zzpg, 0, zzcArr2, 0, length3);
                }
                while (length3 < zzcArr2.length - 1) {
                    zzcArr2[length3] = (C0002zzc) zzun.zza(C0002zzc.zza());
                    zzun.zzni();
                    length3++;
                }
                zzcArr2[length3] = (C0002zzc) zzun.zza(C0002zzc.zza());
