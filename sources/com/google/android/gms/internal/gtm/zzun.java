...
public final class zzun {
    ...
    public final int zzoa() throws IOException {
        ...
        if (zzof2 >= 0) {
            ...
            if (zzof3 >= 0) {
                ...
                b2 |= (zzof3 & Byte.MAX_VALUE) << 14;
                byte zzof4 = zzof();
                if (zzof4 >= 0) {
                    i = zzof4 << 21;
                } else {
                    byte b3 = b2 | ((zzof4 & Byte.MAX_VALUE) << 21);
                    byte zzof5 = zzof();
                    b = b3 | (zzof5 << 28);
                    if (zzof5 < 0) {
    ...
    public final int zzoc() throws IOException {
        return (zzof() & Draft_75.END_OF_FRAME) | ((zzof() & Draft_75.END_OF_FRAME) << 8) | ((zzof() & Draft_75.END_OF_FRAME) << 16) | ((zzof() & Draft_75.END_OF_FRAME) << 24);
    }
