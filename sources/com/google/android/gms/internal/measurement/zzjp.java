...
public final class zzjp implements zzjq {
    ...
    static {
        ...
        zzapx = zzct.zze("measurement.ad_id_cache_time", NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS);
        ...
        zzaqh = zzct.zze("measurement.alarm_manager.minimum_interval", DefaultLoadErrorHandlingPolicy.DEFAULT_TRACK_BLACKLIST_MS);
        zzaqi = zzct.zze("measurement.upload.minimum_delay", 500);
        zzaqj = zzct.zze("measurement.monitoring.sample_period_millis", 86400000);
        zzaqk = zzct.zze("measurement.upload.realtime_upload_interval", NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS);
        ...
        zzaqt = zzct.zze("measurement.upload.max_bundle_size", 65536);
        ...
        zzarc = zzct.zze("measurement.upload.max_batch_size", 65536);
