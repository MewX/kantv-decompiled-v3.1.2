...
final class zzat implements zzc {
    ...
    public final synchronized void zzb(List<zzay> list, long j) {
        ...
        if (zzau2 != null) {
            for (zzay zzay : list) {
                ...
                contentValues.put("value", zzay.zzagh);
    ...
    private final List<zzay> zzhu() {
        ...
        Cursor query = zzau.query("datalayer", new String[]{"key", "value"}, null, null, null, null, "ID", null);
    ...
    private final List<String> zzu(int i) {
        ...
        Cursor cursor = null;
        try {
            Cursor query = zzau.query("datalayer", new String[]{str}, null, null, null, null, String.format("%s ASC", new Object[]{str}), Integer.toString(i));
