...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createTranslationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<AnimatorListener> list2, RectF rectF) {
        ...
        if (calculateTranslationX == 0.0f || calculateTranslationY == 0.0f) {
            motionTiming2 = fabTransformationSpec2.timings.getTiming("translationXLinear");
            motionTiming = fabTransformationSpec2.timings.getTiming("translationYLinear");
        } else if ((!z || calculateTranslationY >= 0.0f) && (z || calculateTranslationY <= 0.0f)) {
            motionTiming2 = fabTransformationSpec2.timings.getTiming("translationXCurveDownwards");
            motionTiming = fabTransformationSpec2.timings.getTiming("translationYCurveDownwards");
        } else {
            motionTiming2 = fabTransformationSpec2.timings.getTiming("translationXCurveUpwards");
            motionTiming = fabTransformationSpec2.timings.getTiming("translationYCurveUpwards");
        }
        ...
        if (z) {
            ...
            calculateChildVisibleBoundsAtEndOfExpansion(view2, fabTransformationSpec, motionTiming3, motionTiming4, -calculateTranslationX, -calculateTranslationY, 0.0f, 0.0f, rectF);
        } else {
        ...
        motionTiming3.apply(objectAnimator2);
        motionTiming4.apply(objectAnimator);
