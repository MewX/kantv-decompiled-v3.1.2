...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Callback {
    ...
    private void drawDebug(@NonNull Canvas canvas, Rect rect) {
        Paint paint = this.debugPaint;
        if (paint != null) {
            paint.setColor(ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, AVException.INVALID_PHONE_NUMBER));
            ...
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(SupportMenu.CATEGORY_MASK, AVException.INVALID_PHONE_NUMBER));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-16711936, AVException.INVALID_PHONE_NUMBER));
