    ...
    static final class UnsafeProcessor extends Processor {
        ...
        public int encodeUtf8(CharSequence charSequence, byte[] bArr, int i, int i2) {
            ...
            while (true) {
                ...
                long j6 = 1 + j4;
                UnsafeUtil.putByte(bArr2, j4, (byte) charAt);
                i5++;
                j4 = j6;
            }
            if (i5 == length) {
            ...
            while (i5 < length) {
                ...
                if (charAt2 < c && j4 < j5) {
                    ...
                    long j8 = j4 + j;
                    UnsafeUtil.putByte(bArr2, j4, (byte) ((charAt2 >>> 6) | 960));
                    long j9 = j8 + j;
                    ...
                    long j11 = j4 + j;
                    UnsafeUtil.putByte(bArr2, j4, (byte) ((charAt2 >>> 12) | 480));
                    long j12 = j11 + j;
                    UnsafeUtil.putByte(bArr2, j11, (byte) (((charAt2 >>> 6) & 63) | 128));
                    long j13 = j12 + 1;
                    UnsafeUtil.putByte(bArr2, j12, (byte) ((charAt2 & '?') | 128));
                    j2 = j13;
                    j3 = 1;
                } else if (j4 <= j5 - 4) {
                    int i6 = i5 + 1;
                    if (i6 != length) {
                        ...
                        if (Character.isSurrogatePair(charAt2, charAt3)) {
                            int codePoint = Character.toCodePoint(charAt2, charAt3);
                            long j14 = j4 + 1;
                            UnsafeUtil.putByte(bArr2, j4, (byte) ((codePoint >>> 18) | PsExtractor.VIDEO_STREAM_MASK));
                            long j15 = j14 + 1;
                            UnsafeUtil.putByte(bArr2, j14, (byte) (((codePoint >>> 12) & 63) | 128));
                            long j16 = j15 + 1;
                            UnsafeUtil.putByte(bArr2, j15, (byte) (((codePoint >>> 6) & 63) | 128));
                            j3 = 1;
                            j2 = j16 + 1;
                            UnsafeUtil.putByte(bArr2, j16, (byte) ((codePoint & 63) | 128));
                            i5 = i6;
                            i5++;
                            c = 128;
                            long j102 = j3;
