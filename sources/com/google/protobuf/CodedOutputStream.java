...
public abstract class CodedOutputStream extends ByteOutput {
        ...
        public final void bufferUInt32NoTag(int i) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((i & -128) != 0) {
                    ...
                    this.position = i2 + 1;
                    UnsafeUtil.putByte(bArr, (long) i2, (byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128));
                    i >>>= 7;
                }
            ...
            while ((i & -128) != 0) {
                ...
                this.position = i4 + 1;
                bArr3[i4] = (byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128);
                this.totalBytesWritten++;
                i >>>= 7;
            }
        ...
        public final void bufferUInt64NoTag(long j) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128));
                    j >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128);
                this.totalBytesWritten++;
                j >>>= 7;
            }
            byte[] bArr4 = this.buffer;
        ...
        public final void writeUInt32NoTag(int i) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                while ((i & -128) != 0) {
                    ...
                    int i2 = this.position;
                    this.position = i2 + 1;
                    bArr[i2] = (byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128);
                    i >>>= 7;
                }
                try {
                    byte[] bArr2 = this.buffer;
                ...
                while ((i & -128) != 0) {
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    UnsafeUtil.putByte(bArr3, (long) i4, (byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128));
                    i >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i5 = this.position;
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                while ((j & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    bArr[i] = (byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128);
                    j >>>= 7;
                }
                try {
                    byte[] bArr2 = this.buffer;
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    UnsafeUtil.putByte(bArr3, (long) i3, (byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int i) throws IOException {
            while ((i & -128) != 0) {
                this.buffer.put((byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128));
                i >>>= 7;
            }
            try {
        ...
        public void writeUInt64NoTag(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.buffer.put((byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128));
                j >>>= 7;
            }
            try {
    ...
    private static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void write(byte b) throws IOException {
            ...
            throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j), Long.valueOf(this.limit), Integer.valueOf(1)}));
        }
        ...
        public void writeUInt32NoTag(int i) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((i & -128) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128));
                    i >>>= 7;
                }
            ...
            while (true) {
                ...
                if (j3 >= this.limit) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j3), Long.valueOf(this.limit), Integer.valueOf(1)}));
                } else if ((i & -128) == 0) {
                    this.position = 1 + j3;
                    ...
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((i & AVException.INVALID_PHONE_NUMBER) | 128));
                    i >>>= 7;
                }
            }
        }
        ...
        public void writeUInt64NoTag(long j) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((j & -128) != 0) {
                    long j2 = this.position;
                    this.position = j2 + 1;
                    UnsafeUtil.putByte(j2, (byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128));
                    j >>>= 7;
                }
                long j3 = this.position;
                this.position = 1 + j3;
            ...
            while (true) {
                ...
                if (j4 >= this.limit) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j4), Long.valueOf(this.limit), Integer.valueOf(1)}));
                } else if ((j & -128) == 0) {
                    this.position = 1 + j4;
                    ...
                    this.position = j4 + 1;
                    UnsafeUtil.putByte(j4, (byte) ((((int) j) & AVException.INVALID_PHONE_NUMBER) | 128));
                    j >>>= 7;
                }
            }
        }
        ...
        public void write(byte[] bArr, int i, int i2) throws IOException {
            if (bArr != null && i >= 0 && i2 >= 0 && bArr.length - i2 >= i) {
                ...
                long j3 = this.position;
                if (j2 >= j3) {
                    UnsafeUtil.copyMemory(bArr, (long) i, j3, j);
                    this.position += j;
                    return;
                }
            }
    ...
    public static CodedOutputStream newInstance(ByteBuffer byteBuffer) {
        ...
        if (UnsafeDirectNioEncoder.isSupported()) {
            codedOutputStream = newUnsafeInstance(byteBuffer);
        } else {
            codedOutputStream = newSafeInstance(byteBuffer);
        }
