    ...
    public static final class Builder extends com.google.protobuf.AbstractMessage.Builder<Builder> {
        ...
        public Builder mergeFrom(Message message) {
            ...
            if (dynamicMessage.type == this.type) {
                ...
                int i = 0;
                while (true) {
                    FieldDescriptor[] fieldDescriptorArr = this.oneofCases;
        ...
        public DynamicMessage build() {
            ...
            FieldSet<FieldDescriptor> fieldSet = this.fields;
            FieldDescriptor[] fieldDescriptorArr = this.oneofCases;
            throw newUninitializedMessageException(new DynamicMessage(descriptor, fieldSet, (FieldDescriptor[]) Arrays.copyOf(fieldDescriptorArr, fieldDescriptorArr.length), this.unknownFields));
        }
        ...
        public DynamicMessage buildParsed() throws InvalidProtocolBufferException {
            ...
            FieldSet<FieldDescriptor> fieldSet = this.fields;
            FieldDescriptor[] fieldDescriptorArr = this.oneofCases;
            throw newUninitializedMessageException(new DynamicMessage(descriptor, fieldSet, (FieldDescriptor[]) Arrays.copyOf(fieldDescriptorArr, fieldDescriptorArr.length), this.unknownFields)).asInvalidProtocolBufferException();
        }
        ...
        public DynamicMessage buildPartial() {
            ...
            FieldSet<FieldDescriptor> fieldSet = this.fields;
            FieldDescriptor[] fieldDescriptorArr = this.oneofCases;
            return new DynamicMessage(descriptor, fieldSet, (FieldDescriptor[]) Arrays.copyOf(fieldDescriptorArr, fieldDescriptorArr.length), this.unknownFields);
        }
