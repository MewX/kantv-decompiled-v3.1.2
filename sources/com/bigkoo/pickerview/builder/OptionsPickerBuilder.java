...
public class OptionsPickerBuilder {
    ...
    public OptionsPickerBuilder setOnCancelClickListener(OnClickListener onClickListener) {
    ...
    public OptionsPickerBuilder setDividerType(DividerType dividerType) {
