...
public class OpenGpsDialog {
    ...
    public OpenGpsDialog(Context context2) {
        this.context = context2;
        this.display = ((WindowManager) context2.getSystemService("window")).getDefaultDisplay();
    }

    public OpenGpsDialog builder() {
        View inflate = LayoutInflater.from(this.context).inflate(R.layout.view_opengps_dialog, null);
    ...
    public OpenGpsDialog setTitle(String str) {
        this.showTitle = true;
        String str2 = "";
        if (str2.equals(str)) {
    ...
    public OpenGpsDialog setMsg(String str) {
        this.showMsg = true;
        String str2 = "";
        if (str2.equals(str)) {
    ...
    public OpenGpsDialog setCancelable(boolean z) {
        this.dialog.setCancelable(z);
        return this;
    }

    public OpenGpsDialog setPositiveButton(String str, final OnClickListener onClickListener) {
        ...
        this.btn_pos.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                OpenGpsDialog.this.dialog.dismiss();
            }
        });
        return this;
    }

    public OpenGpsDialog setNegativeButton(String str, final OnClickListener onClickListener) {
