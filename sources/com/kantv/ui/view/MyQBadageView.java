...
public class MyQBadageView extends View implements Badge {
    ...
    protected FontMetrics mBadgeTextFontMetrics;
    ...
    private class BadgeContainer extends ViewGroup {
        ...
        public void onMeasure(int i, int i2) {
            ...
            for (int i3 = 0; i3 < getChildCount(); i3++) {
                ...
                if (!(childAt instanceof MyQBadageView)) {
                    view = childAt;
                } else {
                    view2 = childAt;
                }
    ...
    public MyQBadageView(Context context) {
        this(context, null);
    }

    private MyQBadageView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    private MyQBadageView(Context context, AttributeSet attributeSet, int i) {
    ...
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        L_0x00b9:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kantv.ui.view.MyQBadageView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public Bitmap createBadgeBitmap() {
        Bitmap createBitmap = Bitmap.createBitmap(((int) this.mBadgeBackgroundRect.width()) + DisplayUtil.dp2px(getContext(), 3.0f), ((int) this.mBadgeBackgroundRect.height()) + DisplayUtil.dp2px(getContext(), 3.0f), Config.ARGB_8888);
    ...
    private void drawDragging(Canvas canvas, float f, float f2) {
        ...
        int i = this.mDragQuadrant;
        path.addCircle(f8, f9, f, (i == 1 || i == 2) ? Direction.CCW : Direction.CW);
        ...
        if (this.mColorBackgroundBorder != 0 && this.mBackgroundBorderWidth > 0.0f) {
            ...
            if (i2 == 1 || i2 == 2) {
                f3 = ((PointF) this.mInnertangentPoints.get(2)).x - this.mRowBadgeCenter.x;
                f5 = this.mRowBadgeCenter.y;
                f4 = ((PointF) this.mInnertangentPoints.get(2)).y;
            } else {
                f3 = ((PointF) this.mInnertangentPoints.get(3)).x - this.mRowBadgeCenter.x;
                f5 = this.mRowBadgeCenter.y;
                f4 = ((PointF) this.mInnertangentPoints.get(3)).y;
            }
    ...
    private void drawBadgeBackground(Canvas canvas) {
        ...
        if (this.mDrawableBackgroundClip) {
            this.mBadgeBackgroundPaint.setXfermode(new PorterDuffXfermode(Mode.DST_IN));
    ...
    private void createClipLayer() {
        if (this.mBadgeText != null && this.mDrawableBackgroundClip) {
            ...
            if (this.mBadgeText.isEmpty() || this.mBadgeText.length() == 1) {
                ...
                this.mBitmapClip = Bitmap.createBitmap(i, i, Config.ARGB_4444);
                ...
                this.mBitmapClip = Bitmap.createBitmap((int) (this.mBadgeTextRect.width() + (this.mBadgePadding * 2.0f)), (int) (this.mBadgeTextRect.height() + this.mBadgePadding), Config.ARGB_4444);
    ...
    private void findBadgeCenter() {
        ...
        switch (this.mBadgeGravity) {
            case 17:
                ...
                pointF.x = ((float) this.mWidth) / 2.0f;
                pointF.y = ((float) this.mHeight) / 2.0f;
                break;
            case 49:
                PointF pointF2 = this.mBadgeCenter;
                pointF2.x = ((float) this.mWidth) / 2.0f;
                pointF2.y = this.mGravityOffsetY + this.mBadgePadding + (this.mBadgeTextRect.height() / 2.0f);
                break;
            case 81:
                PointF pointF3 = this.mBadgeCenter;
                pointF3.x = ((float) this.mWidth) / 2.0f;
                pointF3.y = ((float) this.mHeight) - ((this.mGravityOffsetY + this.mBadgePadding) + (this.mBadgeTextRect.height() / 2.0f));
                break;
            case 8388627:
                PointF pointF4 = this.mBadgeCenter;
                pointF4.x = this.mGravityOffsetX + this.mBadgePadding + (height / 2.0f);
                pointF4.y = ((float) this.mHeight) / 2.0f;
                break;
            case 8388629:
                PointF pointF5 = this.mBadgeCenter;
                pointF5.x = ((float) this.mWidth) - ((this.mGravityOffsetX + this.mBadgePadding) + (height / 2.0f));
                pointF5.y = ((float) this.mHeight) / 2.0f;
                break;
            case 8388659:
            ...
            case 8388691:
                ...
                pointF8.y = ((float) this.mHeight) - ((this.mGravityOffsetY + f7) + (this.mBadgeTextRect.height() / 2.0f));
                break;
            case 8388693:
                PointF pointF9 = this.mBadgeCenter;
                float f8 = (float) this.mWidth;
                float f9 = this.mGravityOffsetX;
                float f10 = this.mBadgePadding;
                pointF9.x = f8 - ((f9 + f10) + (height / 2.0f));
                pointF9.y = ((float) this.mHeight) - ((this.mGravityOffsetY + f10) + (this.mBadgeTextRect.height() / 2.0f));
                break;
        }
        initRowBadgeCenter();
    }
    ...
    private void updataListener(int i) {
        OnDragStateChangedListener onDragStateChangedListener = this.mDragStateChangedListener;
