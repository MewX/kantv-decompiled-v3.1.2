...
public class NewsCommentActivity extends PackageActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.all_news_comments);
        initBase();
        initStatusBar();
        initTitle();
    ...
    public void initRequest() {
        ...
        Api.getService().getComments(this.request).enqueue(new CommonCallBack(this, true) {
            ...
            public void onResponse(retrofit2.Call<okhttp3.ResponseBody> r27, retrofit2.Response<okhttp3.ResponseBody> r28) {
                /*
                    ...
                    com.kantv.ui.activity.NewsCommentActivity r0 = com.kantv.ui.activity.NewsCommentActivity.this
                ...
                L_0x000e:
                    ...
                    com.kantv.ui.activity.NewsCommentActivity r2 = com.kantv.ui.activity.NewsCommentActivity.this     // Catch:{ Exception -> 0x0221 }
                ...
                L_0x0180:
                    ...
                    goto L_0x010b
                L_0x01ac:
                    com.kantv.ui.activity.NewsCommentActivity r6 = com.kantv.ui.activity.NewsCommentActivity.this     // Catch:{ Exception -> 0x0221 }
                    ...
                    goto L_0x007a
                L_0x020f:
                    com.kantv.ui.activity.NewsCommentActivity r0 = com.kantv.ui.activity.NewsCommentActivity.this     // Catch:{ Exception -> 0x0221 }
                ...
                L_0x0225:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.kantv.ui.activity.NewsCommentActivity.AnonymousClass1.onResponse(retrofit2.Call, retrofit2.Response):void");
            }
        });
    }
    ...
    private void initView() {
        ...
        AnonymousClass2 r2 = new CommonAdapter<CommentChildBean>(this, R.layout.item_newscomment, this.mData) {
            /* access modifiers changed from: protected */
            public void convert(ViewHolder viewHolder, CommentChildBean commentChildBean, int i) {
                    ...
                    viewHolder2.setOnClickListener(R.id.item_index_bt, new OnClickListener() {
                        public void onClick(View view) {
                            if (((Boolean) PreferenceUtil.get(Utils.getContext(), "Login_State", Boolean.valueOf(false))).booleanValue()) {
                                ...
                                bundle.putString("tid", NewsCommentActivity.this.tid);
                    ...
                    AnonymousClass2 r0 = new CommonAdapter<String8Bean>(Utils.getContext(), R.layout.item_replysubmit, arrayList) {
                        ...
                        public void convert(ViewHolder viewHolder, String8Bean string8Bean, int i) {
                            if (string8Bean.getStr8().equals("0")) {
                                ...
                                viewHolder.setTextColor(R.id.item_replysubmit_text, NewsCommentActivity.this.getResources().getColor(R.color.them_color));
                            }
                        }
                    };
                ...
                viewHolder2.setOnClickListener(R.id.item_index_qj, new OnClickListener() {
                    public void onClick(View view) {
                        if (!((Boolean) PreferenceUtil.get(Utils.getContext(), "Login_State", Boolean.valueOf(false))).booleanValue()) {
                            NewsCommentActivity.this.initAlertDialog("提示", "您当前还未登录，是否前往登录？");
                        } else if (!GpsUtil.isOpen() && CommonViewModel.isMustOpenGps()) {
                            GpsUtil.requestGps(NewsCommentActivity.this);
                        } else if (NewsCommentActivity.this.checkPersonalInfo()) {
                            NewsCommentActivity.this.replyCommentDialog(commentChildBean2.getStr1(), commentChildBean2.getStr2(), commentChildBean2.getStr6(), commentChildBean2.getStr3());
                        }
                    }
                });
                if (commentChildBean.getStr4().equals(str)) {
                    viewHolder2.setImageDrawable(R.id.item_index_dianzhan, NewsCommentActivity.this.getResources().getDrawable(R.drawable.hand_like_enable));
                } else if (commentChildBean.getStr4().equals("0")) {
                    viewHolder2.setImageDrawable(R.id.item_index_dianzhan, NewsCommentActivity.this.getResources().getDrawable(R.drawable.hand_like_disable));
                }
                final int i5 = i;
                viewHolder2.setOnClickListener(R.id.item_index_dianji, new OnClickListener() {
                    public void onClick(View view) {
                        if (commentChildBean2.getStr4().equals("1")) {
                            ...
                            if (((Boolean) PreferenceUtil.get(Utils.getContext(), "Login_State", Boolean.valueOf(false))).booleanValue()) {
                                NewsCommentActivity.this.initRequestLikeThis(commentChildBean2.getStr2(), commentChildBean2.getStr1(), i5 - 1);
                            } else {
        ...
        this.mRecyclerView.setLoadingListener(new LoadingListener() {
            public void onRefresh() {
                ...
                if (NewsCommentActivity.this.mData != null) {
                    NewsCommentActivity.this.mData.clear();
                }
                NewsCommentActivity.this.initRequest();
            }

            public void onLoadMore() {
                NewsCommentActivity.this.page = NewsCommentActivity.this.page + 1;
                NewsCommentActivity.this.initRequest();
            }
        });
    }
    ...
    private void updatePersonInfoDialog(String str, String str2) {
        new AlertDialog(this).builder().setTitle(str).setMsg(str2).setCancelable(false).setPositiveButton("立即修改", new OnClickListener() {
            public void onClick(View view) {
                NewsCommentActivity.this.gotoActivity(MyInfoActivity.class);
            }
        }).show();
    }
    ...
    public void replyCommentDialog(final String str, String str2, final String str3, String str4) {
        ...
        textView2.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                if (!StringUtils.isEmpty(NewsCommentActivity.this.tid)) {
                    NewsCommentActivity newsCommentActivity = NewsCommentActivity.this;
                    newsCommentActivity.replyCommentDialog(str, newsCommentActivity.tid, str3);
                }
            }
        });
    ...
    public void replyCommentDialog(String str, String str2, String str3) {
        ...
        AnonymousClass6 r0 = new OnClickListener() {
            public void onClick(View view) {
                ...
                NewsCommentActivity.this.request.clear();
                NewsCommentActivity.this.request.put("noncestr", SignConfig.noncestr);
                NewsCommentActivity.this.request.put("timestamp", SignConfig.timestamp);
                NewsCommentActivity.this.request.put("sbID", SignConfig.sbID);
                NewsCommentActivity.this.request.put("sign", SignConfig.sign);
                NewsCommentActivity.this.request.put("_token", str);
                String str2 = str4;
                if (str2 != null && !str2.isEmpty()) {
                    NewsCommentActivity.this.request.put("pid", str4);
                    NewsCommentActivity.this.request.put("cid", str4);
                }
                NewsCommentActivity.this.request.put("tvid", str5);
                NewsCommentActivity.this.request.put("type", "1");
                NewsCommentActivity.this.request.put("content", trim);
                NewsCommentActivity.this.request.put("devicetype", "0");
                NewsCommentActivity.this.request.put("interfaceVersion", Utils.interfaceVersion);
                Api.getService().replySubmit(NewsCommentActivity.this.request).enqueue(new CommonCallBack(NewsCommentActivity.this, true) {
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        super.onResponse(call, response);
                        if (!NewsCommentActivity.this.isDestroy && !StringUtils.isEmpty(this.json)) {
                            JSONObject jsonObject = StringUtils.toJsonObject(this.json);
                            String str = "input_method";
                            if (jsonObject == null) {
                                ToastUtils.showShort((CharSequence) "提交失败");
                                InputMethodManager inputMethodManager = (InputMethodManager) NewsCommentActivity.this.getSystemService(str);
                                if (inputMethodManager != null) {
                                    inputMethodManager.hideSoftInputFromWindow(NewsCommentActivity.this.getWindow().getDecorView().getWindowToken(), 0);
                                }
                                if (bottomView2 != null) {
                            ...
                            if (jsonObject.optString("status").equals(StatusCode.STATUS_OK)) {
                                ...
                                NewsCommentActivity.this.initRequest();
                                editText2.setText("");
                                InputMethodManager inputMethodManager2 = (InputMethodManager) NewsCommentActivity.this.getSystemService(str);
                                if (inputMethodManager2 != null) {
                                    inputMethodManager2.hideSoftInputFromWindow(NewsCommentActivity.this.getWindow().getDecorView().getWindowToken(), 0);
                                }
                                bottomView2.dismissBottomView();
                            }
    ...
    public void initAlertDialog(String str, String str2) {
        ...
        new AlertDialog(this).builder().setTitle(str).setMsg(str2).setNegativeButton("取消", new OnClickListener() {
            ...
            public void onClick(View view) {
                NewsCommentActivity.this.gotoActivity(AccountLoginActivity.class);
            }
        }).show();
    }
        ...
        Api.getService().likethis(this.request).enqueue(new CommonCallBack(this, true) {
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (!NewsCommentActivity.this.isDestroy && !StringUtils.isEmpty(this.json)) {
                    ...
                    if (jsonObject != null) {
                        if (jsonObject.optString("status").equals(StatusCode.STATUS_OK)) {
                            ((CommentChildBean) NewsCommentActivity.this.mData.get(i)).setStr4("1");
                            ((CommentChildBean) NewsCommentActivity.this.mData.get(i)).setStr8(String.valueOf(Integer.parseInt(((CommentChildBean) NewsCommentActivity.this.mData.get(i)).getStr8()) + 1));
                            if (NewsCommentActivity.this.mAdapter != null) {
