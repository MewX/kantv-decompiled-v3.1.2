...
import com.kantv.ui.fragment.SoareSubFragment;
...
public class SoareListActivity extends PackageActivity implements CallBackUpdateUI {
    ...
    private void initRequest() {
        ...
        Api.getService().getTop(this.request).enqueue(new CommonCallBack(this, false) {
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                super.onResponse(call, response);
                SoareListActivity.this.initAnalysis(this.json);
            }
        });
    }
    ...
    private void initTab() {
        ...
        for (int i = 0; i < this.mData.size(); i++) {
            SoareSubFragment soareSubFragment = new SoareSubFragment();
            ...
            soareSubFragment.setArguments(bundle);
            soareSubFragment.setHotBGCallback(this);
            this.mFragmentData.add(soareSubFragment);
        }
        this.fragmentPagerAdapter = new FragmentPagerAdapter(getSupportFragmentManager()) {
            public int getCount() {
                return SoareListActivity.this.mFragmentData.size();
            }

            public Fragment getItem(int i) {
                return (Fragment) SoareListActivity.this.mFragmentData.get(i);
            }

            public CharSequence getPageTitle(int i) {
                return ((String2Bean) SoareListActivity.this.mData.get(i)).getText1();
            }
        };
