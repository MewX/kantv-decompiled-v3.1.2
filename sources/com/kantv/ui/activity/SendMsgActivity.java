...
public class SendMsgActivity extends PackageActivity {
    ...
    private void initTab() {
        ...
        MsgSendFragment msgSendFragment = new MsgSendFragment();
        Bundle bundle = new Bundle();
        String str = "type";
        bundle.putInt(str, 0);
        msgSendFragment.setArguments(bundle);
        MsgSendFragment msgSendFragment2 = new MsgSendFragment();
        Bundle bundle2 = new Bundle();
        bundle2.putInt(str, 1);
        msgSendFragment2.setArguments(bundle2);
        this.mFragmentData.add(msgSendFragment);
        this.mFragmentData.add(msgSendFragment2);
        this.fragmentPagerAdapter = new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public int getCount() {
                if (SendMsgActivity.this.mFragmentData != null) {
                    return SendMsgActivity.this.mFragmentData.size();
                }
                return 0;
            }
            ...
            public Fragment getItem(int i) {
                if (SendMsgActivity.this.mFragmentData != null) {
                    return (Fragment) SendMsgActivity.this.mFragmentData.get(i);
                }
                return null;
            }
