...
import com.kantv.ui.fragment.HotSubFragment;
...
public class HotListActivity extends PackageActivity implements CallBackUpdateUI {
    ...
    private void initRequest() {
        ...
        Api.getService().getTop(this.request).enqueue(new CommonCallBack(this, false) {
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                HotListActivity.this.initAnalysis(this.json);
            }
        });
    }
    ...
    private void initTab() {
        ...
        for (int i = 0; i < this.mData.size(); i++) {
            ...
            hotSubFragment.setHotBGCallback(this);
            this.mFragmentData.add(hotSubFragment);
        }
        this.fragmentPagerAdapter = new FragmentPagerAdapter(getSupportFragmentManager()) {
            public int getCount() {
                return HotListActivity.this.mFragmentData.size();
            }

            public Fragment getItem(int i) {
                return (Fragment) HotListActivity.this.mFragmentData.get(i);
            }

            public CharSequence getPageTitle(int i) {
                return ((String2Bean) HotListActivity.this.mData.get(i)).getText1();
            }
        };
