...
public class AgreeMsgActivity extends PackageActivity {
    ...
    private void initTab() {
        ...
        String str = "type";
        bundle.putInt(str, 0);
        msgLikeFragment.setArguments(bundle);
        MsgLikeFragment msgLikeFragment2 = new MsgLikeFragment();
        Bundle bundle2 = new Bundle();
        bundle2.putInt(str, 1);
        msgLikeFragment2.setArguments(bundle2);
        this.mFragmentData.add(msgLikeFragment);
        this.mFragmentData.add(msgLikeFragment2);
        this.fragmentPagerAdapter = new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public int getCount() {
                if (AgreeMsgActivity.this.mFragmentData != null) {
                    return AgreeMsgActivity.this.mFragmentData.size();
                }
                return 0;
            }
            ...
            public Fragment getItem(int i) {
                if (AgreeMsgActivity.this.mFragmentData != null) {
                    return (Fragment) AgreeMsgActivity.this.mFragmentData.get(i);
                }
                return null;
            }
