...
public class SoareSubFragment extends BaseFragment {
        ...
        Api.getService().getTop(this.request).enqueue(new CommonCallBack(getActivity(), false) {
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (jsonObject != null && jsonObject.optString("status").equals(StatusCode.STATUS_OK)) {
                    int i = 0;
                    SoareSubFragment.this.isFirst = false;
                    ...
                    if (jsonObject2 != null) {
                        ...
                        if (StringUtils.isJSONArrayNotEmpty(jsonArray)) {
                            while (i < jsonArray.length()) {
                                ...
                                if (jSONobject == null || SoareSubFragment.this.mData == null) {
                                    jSONArray = jsonArray;
                                } else {
                                    List access$100 = SoareSubFragment.this.mData;
                            ...
                            if (SoareSubFragment.this.mAdapter != null) {
                                SoareSubFragment.this.mAdapter.notifyDataSetChanged();
                            }
                        }
                    }
                }
    ...
    private void initView() {
        this.mAdapter = new CommonAdapter<String15Bean>(Utils.getContext(), R.layout.item_hotsub, this.mData) {
            ...
            public void convert(ViewHolder viewHolder, final String15Bean string15Bean, int i) {
                ...
                viewHolder.setText(R.id.item_hot_actor, ((String15Bean) SoareSubFragment.this.mData.get(i)).getStr6());
                if (i == 0) {
                    ...
                    if (SoareSubFragment.this.callBackUpdateUI != null) {
                        SoareSubFragment.this.hotListBGUrl = string15Bean.getStr7();
                        SoareSubFragment.this.callBackUpdateUI.updateUi(SoareSubFragment.this.hotListBGUrl);
                    }
                } else if (1 == i) {
                ...
                viewHolder.setOnClickListener(R.id.item_hotsub_rl, new OnClickListener() {
                    public void onClick(View view) {
                        ...
                        if (str4.substring(0, 4).equals("http")) {
                            ...
                            SoareSubFragment.this.getActivity().startActivity(intent);
                        } else {
                            Bundle bundle = new Bundle();
                            bundle.putString("tid", str4);
                            bundle.putString("seo", string15Bean.getStr11());
                            SoareSubFragment.this.gotoActivity(bundle, VideoPlayActivity.class);
                        }
                        KanApplication.getDefaultTracker().send(new EventBuilder().setCategory(UserPreference.ANALYZE11).setAction(UserPreference.ACTION1).setLabel(SoareSubFragment.this.title).build());
                    }
                });
            }
        };
