...
public class NewsCollectFragment extends BaseFragment implements IEdit {
    ...
    private void initView() {
            ...
            public void convert(ViewHolder viewHolder, final String12Bean string12Bean, int i) {
                ...
                viewHolder.setOnClickListener(R.id.item_news_rl, new OnClickListener() {
                    public void onClick(View view) {
                        ...
                        NewsCollectFragment.this.gotoActivity(bundle, NewsDetailActivity.class);
        ...
        this.mRecyclerView.setLoadingListener(new LoadingListener() {
            public void onRefresh() {
                AILog.i(NewsCollectFragment.TAG, IPluginMessage.onRefresh);
                if (NewsCollectFragment.this.mData != null) {
                    NewsCollectFragment.this.mData.clear();
                }
                if (NewsCollectFragment.this.mAdapter != null) {
                    NewsCollectFragment.this.mAdapter.notifyDataSetChanged();
                }
                NewsCollectFragment.this.initRequest(false, "");
            }

            public void onLoadMore() {
                AILog.i(NewsCollectFragment.TAG, "onLoadMore");
                NewsCollectFragment.this.initRequest(false, (NewsCollectFragment.this.mData == null || NewsCollectFragment.this.mData.size() <= 0) ? "" : ((String12Bean) NewsCollectFragment.this.mData.get(NewsCollectFragment.this.mData.size() - 1)).getStr5());
            }
        });
            ...
            if (i < this.mData.size()) {
                ...
                Api.getService().doCollect(this.request).enqueue(new CommonCallBack(getContext(), false) {
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        ...
                        if (!NewsCollectFragment.this.isDestroy && !StringUtils.isEmpty(this.json)) {
                            ...
                            if (jsonObject != null && jsonObject.optString("status").equals(StatusCode.STATUS_OK)) {
                                String str = "";
                                EventBus.getDefault().post(new EventBusBean(NewsCollectFragment.TAG, "default", str));
                                if (NewsCollectFragment.this.mData != null) {
                                    NewsCollectFragment.this.mData.clear();
                                }
                                if (NewsCollectFragment.this.mAdapter != null) {
                                ...
                                if (NewsCollectFragment.this.mRecyclerView != null) {
                                    NewsCollectFragment.this.mRecyclerView.reset();
                                }
                                NewsCollectFragment.this.initRequest(true, str);
        ...
        Api.getService().doCollect(this.request).enqueue(new CommonCallBack(getContext(), false) {
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (!NewsCollectFragment.this.isDestroy && !StringUtils.isEmpty(this.json)) {
                    JSONObject jsonObject = StringUtils.toJsonObject(this.json);
                    if (jsonObject != null && jsonObject.optString("status").equals(StatusCode.STATUS_OK)) {
                        if (NewsCollectFragment.this.mData != null && NewsCollectFragment.this.mData.size() > i) {
                            NewsCollectFragment.this.mData.remove(i);
                        }
                        if (NewsCollectFragment.this.mAdapter != null) {
                            NewsCollectFragment.this.mAdapter.notifyDataSetChanged();
                        }
    ...
    public void initRequest(boolean z, String str) {
        ...
        Api.getService().Collect(this.request).enqueue(new CommonCallBack(getContext(), z) {
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                String str;
                ...
                String str4 = "status";
                super.onResponse(call, response);
                if (!NewsCollectFragment.this.isDestroy) {
                    AILog.i(NewsCollectFragment.TAG, "refreshComplete");
                    if (NewsCollectFragment.this.mRecyclerView != null) {
                        NewsCollectFragment.this.mRecyclerView.refreshComplete();
                        NewsCollectFragment.this.mRecyclerView.loadMoreComplete();
                    }
                    try {
                            ...
                            if (asJsonObject != null) {
                                if (asJsonObject.get(str4).getAsString().equals(StatusCode.STATUS_OK)) {
                                    ...
                                    if (asJsonObject2 != null) {
                                        JsonArray asJsonArray = asJsonObject2.getAsJsonArray("collect");
                                        ...
                                        if (StringUtils.isJSONArrayNotEmpty(asJsonArray)) {
                                            for (int i = 0; i < asJsonArray.size(); i++) {
                                                ...
                                                String str6 = str5;
                                                List access$000 = NewsCollectFragment.this.mData;
                    ...
                    if (NewsCollectFragment.this.mData == null || NewsCollectFragment.this.mData.size() == 0) {
                        NewsCollectFragment.this.mEmptyTip.setText(NewsCollectFragment.this.getString(R.string.collect_empty));
                        NewsCollectFragment.this.mEmptyTip.setVisibility(0);
                    } else {
                        NewsCollectFragment.this.mEmptyTip.setVisibility(8);
                    }
                }
            }
