...
import com.kantv.kt_player.ExoPlayer.utils.NetInfoModule;
import com.kantv.kt_player.ExoPlayer.utils.NetInfoModule.NetChangeListener;
...
public abstract class GSYVideoView extends GSYTextureRenderView implements GSYMediaPlayerListener {
    ...
    protected static final String TAG = ExoPlayView.class.getSimpleName();
    protected int id = 0;
    ...
    public void initVideo() {
        ...
        gSYVideoManager.initVideo(str, map, this.mLooping, this.mSpeed, this.mCache, this.mCachePath, this.mOverrideExtension);
    }
