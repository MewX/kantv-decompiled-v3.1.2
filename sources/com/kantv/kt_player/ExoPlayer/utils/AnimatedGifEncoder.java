...
public class AnimatedGifEncoder {
    ...
    public void analyzePixels() {
        ...
        while (i2 < i) {
            ...
            int i7 = i6 + 1;
            int i8 = i7 + 1;
            int map = neuQuant.map(bArr3[i5] & Draft_75.END_OF_FRAME, bArr3[i6] & Draft_75.END_OF_FRAME, bArr3[i7] & Draft_75.END_OF_FRAME);
    ...
    public int findClosest(int i) {
        ...
        byte b = (i >> 16) & Draft_75.END_OF_FRAME;
        byte b2 = (i >> 8) & Draft_75.END_OF_FRAME;
        int i2 = 0;
        byte b3 = (i >> 0) & Draft_75.END_OF_FRAME;
        int length = bArr.length;
        int i3 = 0;
        int i4 = 16777216;
        while (i2 < length) {
            byte[] bArr2 = this.colorTab;
            int i5 = i2 + 1;
            int i6 = b - (bArr2[i2] & Draft_75.END_OF_FRAME);
            int i7 = i5 + 1;
            int i8 = b2 - (bArr2[i5] & Draft_75.END_OF_FRAME);
            int i9 = b3 - (bArr2[i7] & Draft_75.END_OF_FRAME);
    ...
    public void getImagePixels() {
        ...
        if (!(width2 == this.width && height2 == this.height)) {
            Bitmap createBitmap = Bitmap.createBitmap(this.width, this.height, Config.RGB_565);
