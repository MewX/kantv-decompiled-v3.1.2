...
import com.kantv.kt_player.ExoPlayer.base.GSYVideoViewBridge;
...
import com.kantv.kt_player.ExoPlayer.player.BasePlayerManager;
import com.kantv.kt_player.ExoPlayer.player.IPlayerInitSuccessListener;
import com.kantv.kt_player.ExoPlayer.player.IPlayerManager;
import com.kantv.kt_player.ExoPlayer.player.PlayerFactory;
...
public abstract class GSYVideoBaseManager implements OnPreparedListener, OnCompletionListener, OnBufferingUpdateListener, OnSeekCompleteListener, OnErrorListener, OnVideoSizeChangedListener, OnInfoListener, ICacheAvailableListener, GSYVideoViewBridge {
    ...
    protected static final int INIT_VIDEO = 4;
    ...
    private class MediaHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            int i = message.what;
            if (i == 0) {
                GSYVideoBaseManager.this.prepare(message);
            } else if (i == 1) {
            } else {
                if (i == 2) {
    ...
    public void initVideo(String str, Map<String, String> map, boolean z, float f, boolean z2, File file, String str2) {
    ...
    public void prepare(Message message) {
        try {
            this.playerManager.prepare(this.context, message);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
