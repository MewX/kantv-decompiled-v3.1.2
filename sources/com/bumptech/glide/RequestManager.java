...
public class RequestManager implements LifecycleListener {
    ...
    public final class GenericModelRequest<A, T> {
        ...
        public final class GenericTypeRequest {
            ...
            public <Z> GenericTranscodeRequest<A, T, Z> as(Class<Z> cls) {
                OptionsApplier access$500 = RequestManager.this.optionsApplier;
                ...
                GenericTranscodeRequest<A, T, Z> genericTranscodeRequest2 = (GenericTranscodeRequest) access$500.apply(genericTranscodeRequest);
                if (this.providedModel) {
                    genericTranscodeRequest2.load(this.model);
                }
        ...
        public GenericTypeRequest from(Class<A> cls) {
            return new GenericTypeRequest<>(cls);
        }

        public GenericTypeRequest load(A a) {
    ...
    public final class ImageModelRequest<T> {
        ...
        public DrawableTypeRequest<T> from(Class<T> cls) {
            OptionsApplier access$500 = RequestManager.this.optionsApplier;
            DrawableTypeRequest drawableTypeRequest = new DrawableTypeRequest(cls, this.loader, null, RequestManager.this.context, RequestManager.this.glide, RequestManager.this.requestTracker, RequestManager.this.lifecycle, RequestManager.this.optionsApplier);
            return (DrawableTypeRequest) access$500.apply(drawableTypeRequest);
        }
    ...
    public final class VideoModelRequest<T> {
        ...
        public DrawableTypeRequest<T> load(T t) {
            OptionsApplier access$500 = RequestManager.this.optionsApplier;
            DrawableTypeRequest drawableTypeRequest = new DrawableTypeRequest(RequestManager.getSafeClass(t), null, this.loader, RequestManager.this.context, RequestManager.this.glide, RequestManager.this.requestTracker, RequestManager.this.lifecycle, RequestManager.this.optionsApplier);
            return (DrawableTypeRequest) ((DrawableTypeRequest) access$500.apply(drawableTypeRequest)).load(t);
        }
    }
    ...
    public DrawableTypeRequest<Uri> fromMediaStore() {
        ...
        DrawableTypeRequest drawableTypeRequest = new DrawableTypeRequest(Uri.class, mediaStoreStreamLoader, buildFileDescriptorModelLoader, this.context, this.glide, this.requestTracker, this.lifecycle, optionsApplier2);
        return (DrawableTypeRequest) optionsApplier2.apply(drawableTypeRequest);
    }
    ...
    private <T> DrawableTypeRequest<T> loadGeneric(Class<T> cls) {
        ...
        OptionsApplier optionsApplier2 = this.optionsApplier;
        DrawableTypeRequest drawableTypeRequest = new DrawableTypeRequest(cls, buildStreamModelLoader, buildFileDescriptorModelLoader, this.context, this.glide, this.requestTracker, this.lifecycle, optionsApplier2);
        return (DrawableTypeRequest) optionsApplier2.apply(drawableTypeRequest);
    }
