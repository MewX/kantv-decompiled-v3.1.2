...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> animate(int i) {
        return animate((GlideAnimationFactory<TranscodeType>) new ViewAnimationFactory<TranscodeType>(this.context, i));
    }

    @Deprecated
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> animate(Animation animation) {
        return animate((GlideAnimationFactory<TranscodeType>) new ViewAnimationFactory<TranscodeType>(animation));
    }

    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> animate(Animator animator) {
        return animate((GlideAnimationFactory<TranscodeType>) new ViewPropertyAnimationFactory<TranscodeType>(animator));
    }
    ...
    public Target<TranscodeType> into(ImageView imageView) {
        ...
        if (imageView != null) {
            ...
            return into((Y) this.glide.buildImageViewTarget(imageView, this.transcodeClass));
        }
    ...
    public Target<TranscodeType> preload(int i, int i2) {
        return into((Y) PreloadTarget.obtain(i, i2));
    }
    ...
    private Request obtainRequest(Target<TranscodeType> target, float f, Priority priority2, RequestCoordinator requestCoordinator) {
        ...
        ChildLoadProvider<ModelType, DataType, ResourceType, TranscodeType> childLoadProvider = this.loadProvider;
        return GenericRequest.obtain(childLoadProvider, this.model, this.signature, this.context, priority3, target2, f2, this.placeholderDrawable, this.placeholderId, this.errorPlaceholder, this.errorId, this.fallbackDrawable, this.fallbackResource, this.requestListener, requestCoordinator2, this.glide.getEngine(), this.transformation, this.transcodeClass, this.isCacheable, this.animationFactory, this.overrideWidth, this.overrideHeight, this.diskCacheStrategy);
    }
}
