...
public class MediaStoreThumbFetcher implements DataFetcher<InputStream> {
    ...
    static class ImageThumbnailQuery implements ThumbnailQuery {
        ...
        public Cursor queryPath(Context context, Uri uri) {
            ...
            return context.getContentResolver().query(Thumbnails.EXTERNAL_CONTENT_URI, PATH_PROJECTION, PATH_SELECTION, new String[]{lastPathSegment}, null);
        }
    }
    ...
    static class ThumbnailStreamOpener {
        ...
        public int getOrientation(Context context, Uri uri) {
            String str = MediaStoreThumbFetcher.TAG;
    ...
    static class VideoThumbnailQuery implements ThumbnailQuery {
        ...
        public Cursor queryPath(Context context, Uri uri) {
            String lastPathSegment = uri.getLastPathSegment();
            return context.getContentResolver().query(Video.Thumbnails.EXTERNAL_CONTENT_URI, PATH_PROJECTION, PATH_SELECTION, new String[]{lastPathSegment}, null);
        }
    }
