...
class LZWEncoder {
    ...
    int[] masks = {0, 1, 3, 7, 15, 31, 63, AVException.INVALID_PHONE_NUMBER, 255, FrameMetricsAggregator.EVERY_DURATION, 1023, 2047, 4095, 8191, 16383, DNSRecordClass.CLASS_MASK, SupportMenu.USER_MASK};
    int maxbits = 12;
    int maxcode;
    int maxmaxcode = 4096;
    int n_bits;
