...
public class BitmapRequestBuilder<ModelType, TranscodeType> extends GenericRequestBuilder<ModelType, ImageVideoWrapper, Bitmap, TranscodeType> implements BitmapOptions, DrawableOptions {
    ...
    public BitmapRequestBuilder<ModelType, TranscodeType> thumbnail(BitmapRequestBuilder<?, TranscodeType> bitmapRequestBuilder) {
        super.thumbnail((GenericRequestBuilder<?, ?, ?, TranscodeType>) bitmapRequestBuilder);
        return this;
    }
    ...
    private RuntimeException crossFadeNotSupported() {
        ...
        sb.append(".crossFade() is not supported for ");
        sb.append(canonicalName);
        sb.append(", use .animate() to provide a compatible animation.");
    ...
    public final BitmapRequestBuilder<ModelType, TranscodeType> crossFade() {
        if (Bitmap.class.isAssignableFrom(this.transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>) new BitmapCrossFadeFactory<TranscodeType>());
        }
        if (Drawable.class.isAssignableFrom(this.transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>) new DrawableCrossFadeFactory<TranscodeType>());
        }
    ...
    public BitmapRequestBuilder<ModelType, TranscodeType> crossFade(int i) {
        if (Bitmap.class.isAssignableFrom(this.transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>) new BitmapCrossFadeFactory<TranscodeType>(i));
        }
        if (Drawable.class.isAssignableFrom(this.transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>) new DrawableCrossFadeFactory<TranscodeType>(i));
        }
        throw crossFadeNotSupported();
    }
    ...
    public BitmapRequestBuilder<ModelType, TranscodeType> crossFade(Animation animation, int i) {
        if (Bitmap.class.isAssignableFrom(this.transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>) new BitmapCrossFadeFactory<TranscodeType>(animation, i));
        }
        if (Drawable.class.isAssignableFrom(this.transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>) new DrawableCrossFadeFactory<TranscodeType>(animation, i));
        }
        throw crossFadeNotSupported();
    }
    ...
    public BitmapRequestBuilder<ModelType, TranscodeType> crossFade(int i, int i2) {
        if (Bitmap.class.isAssignableFrom(this.transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>) new BitmapCrossFadeFactory<TranscodeType>(this.context, i, i2));
        }
        if (Drawable.class.isAssignableFrom(this.transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>) new DrawableCrossFadeFactory<TranscodeType>(this.context, i, i2));
        }
        throw crossFadeNotSupported();
    }
