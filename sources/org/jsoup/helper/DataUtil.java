...
public final class DataUtil {
    ...
    static Document parseByteData(ByteBuffer byteBuffer, String str, String str2, Parser parser) {
        ...
        if (detectCharsetFromBom == null) {
            String str5 = "UTF-8";
            str3 = Charset.forName(str5).decode(byteBuffer).toString();
            ...
            if (first != null) {
                ...
                if (charsetFromContentType == null) {
                    String str6 = HttpRequest.PARAM_CHARSET;
                    if (first.hasAttr(str6)) {
                        str4 = first.attr(str6);
                    }
                }
            ...
            if (validateCharset == null || validateCharset.equals(str5)) {
                document = parseInput;
            } else {
