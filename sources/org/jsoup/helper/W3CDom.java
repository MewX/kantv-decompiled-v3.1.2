    ...
    protected static class W3CBuilder implements NodeVisitor {
        ...
        public void head(Node node, int i) {
            if (node instanceof org.jsoup.nodes.Element) {
                ...
                Element createElementNS = this.doc.createElementNS((String) this.namespaces.get(updateNamespaces(element)), element.tagName());
        ...
        private String updateNamespaces(org.jsoup.nodes.Element element) {
            ...
            while (true) {
                ...
                this.namespaces.put(str, attribute.getValue());
            }
