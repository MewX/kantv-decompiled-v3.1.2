...
class QueryParser {
    ...
    /* JADX WARNING: type inference failed for: r1v2, types: [org.jsoup.select.Evaluator] */
    /* JADX WARNING: type inference failed for: r11v1, types: [org.jsoup.select.Evaluator] */
    /* JADX WARNING: type inference failed for: r0v4 */
    /* JADX WARNING: type inference failed for: r11v3 */
    /* JADX WARNING: type inference failed for: r11v7 */
    /* JADX WARNING: type inference failed for: r11v8, types: [org.jsoup.select.CombiningEvaluator$And] */
    /* JADX WARNING: type inference failed for: r11v9, types: [org.jsoup.select.CombiningEvaluator$And] */
    /* JADX WARNING: type inference failed for: r11v10, types: [org.jsoup.select.CombiningEvaluator$And] */
    /* JADX WARNING: type inference failed for: r11v11, types: [org.jsoup.select.CombiningEvaluator$And] */
    /* JADX WARNING: type inference failed for: r1v6 */
    /* JADX WARNING: type inference failed for: r5v1 */
    /* JADX WARNING: type inference failed for: r1v7, types: [org.jsoup.select.CombiningEvaluator$And] */
    /* JADX WARNING: type inference failed for: r1v10, types: [org.jsoup.select.Evaluator] */
    /* JADX WARNING: type inference failed for: r5v4 */
    /* JADX WARNING: type inference failed for: r5v6, types: [org.jsoup.select.Evaluator] */
    ...
    private void byTag() {
        ...
        String str = "*|";
        String str2 = ":";
        if (consumeElementSelector.startsWith(str)) {
            this.evals.add(new Or(new Tag(consumeElementSelector.trim().toLowerCase()), new TagEndsWith(consumeElementSelector.replace(str, str2).trim().toLowerCase())));
            return;
        }
        String str3 = "|";
        if (consumeElementSelector.contains(str3)) {
            consumeElementSelector = consumeElementSelector.replace(str3, str2);
        }
    ...
    private void cssNthChild(boolean z, boolean z2) {
        ...
        if ("odd".equals(lowerCase)) {
            ...
            String str2 = "^\\+";
            if (matcher.matches()) {
                int parseInt = matcher.group(3) != null ? Integer.parseInt(matcher.group(1).replaceFirst(str2, str)) : 1;
                if (matcher.group(4) != null) {
                    i2 = Integer.parseInt(matcher.group(4).replaceFirst(str2, str));
                }
                i = parseInt;
            } else if (matcher2.matches()) {
                i2 = Integer.parseInt(matcher2.group().replaceFirst(str2, str));
                i = 0;
            } else {
