...
public abstract class Node implements Cloneable {
    ...
    public abstract void outerHtmlHead(Appendable appendable, int i, OutputSettings outputSettings) throws IOException;

    /* access modifiers changed from: 0000 */
    public abstract void outerHtmlTail(Appendable appendable, int i, OutputSettings outputSettings) throws IOException;
    ...
    /* access modifiers changed from: protected */
    public void indent(Appendable appendable, int i, OutputSettings outputSettings) throws IOException {
