...
public interface Datatype<V> {
    ...
    public enum Builtin {
        ...
        I2(r6, new IntegerDatatype(2)),
        I2_SHORT(r6, new ShortDatatype()),
        ...
        DATE("date", new DateTimeDatatype(new String[]{r13}, r13)),
        DATETIME("dateTime", new DateTimeDatatype(new String[]{r13, r12}, r12)),
        DATETIME_TZ("dateTime.tz", new DateTimeDatatype(new String[]{r13, r12, "yyyy-MM-dd'T'HH:mm:ssZ"}, "yyyy-MM-dd'T'HH:mm:ssZ")),
        TIME("time", new DateTimeDatatype(new String[]{r11}, r11)),
        TIME_TZ("time.tz", new DateTimeDatatype(new String[]{"HH:mm:ssZ", r11}, "HH:mm:ssZ")),
        ...
        private <VT> Builtin(String str, AbstractDatatype<VT> abstractDatatype) {
        ...
        public static Builtin getByDescriptorName(String str) {
            ...
            return (Builtin) byName.get(str.toLowerCase(Locale.ROOT));
        }
