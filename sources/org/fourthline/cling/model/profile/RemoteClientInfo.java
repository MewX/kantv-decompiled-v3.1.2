...
public class RemoteClientInfo extends ClientInfo {
    ...
    public RemoteClientInfo(Connection connection2, UpnpHeaders upnpHeaders) {
        super(upnpHeaders);
    ...
    public void setResponseUserAgent(UserAgentHeader userAgentHeader) {
        getExtraResponseHeaders().add(Type.USER_AGENT, (UpnpHeader) userAgentHeader);
    }
    ...
    public boolean isXbox360Request() {
        return RequestInfo.isXbox360Request(getRequestUserAgent(), getRequestHeaders().getFirstHeaderString(Type.SERVER));
    }

    public boolean isPS3Request() {
        return RequestInfo.isPS3Request(getRequestUserAgent(), getRequestHeaders().getFirstHeaderString(Type.EXT_AV_CLIENT_INFO));
    }
