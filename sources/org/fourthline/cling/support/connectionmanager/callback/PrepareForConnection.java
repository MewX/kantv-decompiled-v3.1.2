...
public abstract class PrepareForConnection extends ActionCallback {
    ...
    public PrepareForConnection(Service service, ProtocolInfo protocolInfo, ServiceReference serviceReference, int i, Direction direction) {
        this(service, null, protocolInfo, serviceReference, i, direction);
    }

    public PrepareForConnection(Service service, ControlPoint controlPoint, ProtocolInfo protocolInfo, ServiceReference serviceReference, int i, Direction direction) {
