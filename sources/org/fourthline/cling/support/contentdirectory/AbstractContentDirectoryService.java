...
public abstract class AbstractContentDirectoryService {
    ...
    protected AbstractContentDirectoryService(List<String> list, List<String> list2, PropertyChangeSupport propertyChangeSupport2) {
        this.systemUpdateID = new UnsignedIntegerFourBytes(0);
    ...
    public BrowseResult search(String str, String str2, String str3, long j, long j2, SortCriterion[] sortCriterionArr) throws ContentDirectoryException {
        try {
            BrowseResult browseResult = new BrowseResult(new DIDLParser().generate(new DIDLContent()), 0, 0);
            return browseResult;
        } catch (Exception e) {
