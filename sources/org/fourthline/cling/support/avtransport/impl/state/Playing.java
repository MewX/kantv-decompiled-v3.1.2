...
public abstract class Playing<T extends AVTransport> extends AbstractState<T> {
    ...
    public void onEntry() {
        ...
        getTransport().getLastChange().setEventedValue(getTransport().getInstanceId(), new AVTransportVariable.TransportState(TransportState.PLAYING), new CurrentTransportActions(getCurrentTransportActions()));
    }
