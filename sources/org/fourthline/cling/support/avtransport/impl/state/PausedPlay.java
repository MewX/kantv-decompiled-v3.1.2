...
public abstract class PausedPlay<T extends AVTransport> extends AbstractState<T> {
    ...
    public void onEntry() {
        ...
        getTransport().getLastChange().setEventedValue(getTransport().getInstanceId(), new AVTransportVariable.TransportState(TransportState.PAUSED_PLAYBACK), new CurrentTransportActions(getCurrentTransportActions()));
    }
