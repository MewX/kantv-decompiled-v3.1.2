...
public class DeviceCapabilities {
    ...
    public DeviceCapabilities(Map<String, ActionArgumentValue> map) {
        this(StorageMedium.valueOfCommaSeparatedList((String) ((ActionArgumentValue) map.get("PlayMedia")).getValue()), StorageMedium.valueOfCommaSeparatedList((String) ((ActionArgumentValue) map.get("RecMedia")).getValue()), RecordQualityMode.valueOfCommaSeparatedList((String) ((ActionArgumentValue) map.get("RecQualityModes")).getValue()));
    }
