...
public abstract class DIDLObject {
    ...
    public static abstract class Property<V> {
        ...
        public static abstract class UPNP {
            ...
            public static class ICON extends Property<URI> implements NAMESPACE {
                ...
                public ICON(URI uri) {
                    super(uri, SettingsJsonConstants.APP_ICON_KEY);
                }
            }
        ...
        protected Property(V v, String str) {
            ...
            this.value = v;
            if (str == null) {
                str = getClass().getSimpleName().toLowerCase(Locale.ROOT).replace("didlobject$property$upnp$", "");
            }
        ...
        public void setOnElement(Element element) {
            ...
            for (Property property : this.attributes) {
                String namespaceURI = ((DIDLAttribute) property.getValue()).getNamespaceURI();
                StringBuilder sb = new StringBuilder();
                sb.append(((DIDLAttribute) property.getValue()).getPrefix());
                sb.append(':');
                sb.append(property.getDescriptorName());
                element.setAttributeNS(namespaceURI, sb.toString(), ((DIDLAttribute) property.getValue()).getValue());
            }
        }
    ...
    protected DIDLObject(String str, String str2, String str3, String str4, boolean z, WriteStatus writeStatus2, Class classR, List<Res> list, List<Property> list2, List<DescMeta> list3) {
        this.restricted = true;
        this.resources = new ArrayList();
        this.properties = new ArrayList();
        this.descMetadata = new ArrayList();
    ...
    public DIDLObject setWriteStatus(WriteStatus writeStatus2) {
        this.writeStatus = writeStatus2;
        return this;
    }
    ...
    public DIDLObject setClazz(Class classR) {
        this.clazz = classR;
        return this;
    }
    ...
    public DIDLObject replaceFirstProperty(Property property) {
        ...
        while (it.hasNext()) {
            if (((Property) it.next()).getClass().isAssignableFrom(property.getClass())) {
                it.remove();
            }
        }
    ...
    public DIDLObject addProperties(Property[] propertyArr) {
        ...
        for (Property addProperty : propertyArr) {
    ...
    public DIDLObject removeProperties(Class<? extends Property> cls) {
        Iterator it = getProperties().iterator();
        while (it.hasNext()) {
            if (cls.isInstance((Property) it.next())) {
                it.remove();
            }
        }
        return this;
    ...
    public boolean hasProperty(Class<? extends Property> cls) {
        for (Property isInstance : getProperties()) {
    ...
    public <V> Property<V>[] getPropertiesByNamespace(Class<? extends NAMESPACE> cls) {
        ArrayList arrayList = new ArrayList();
        for (Property property : getProperties()) {
            if (cls.isInstance(property)) {
                arrayList.add(property);
    ...
    public <V> V getFirstPropertyValue(Class<? extends Property<V>> cls) {
        Property firstProperty = getFirstProperty(cls);
    ...
    public <V> List<V> getPropertyValues(Class<? extends Property<V>> cls) {
        ArrayList arrayList = new ArrayList();
        for (Property value : getProperties(cls)) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.id.equals(((DIDLObject) obj).id);
    }
