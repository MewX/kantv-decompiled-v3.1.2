...
public class Res {
    ...
    public Res(String str, Long l, String str2, Long l2, String str3) {
        String str4 = "*";
        this(new ProtocolInfo(Protocol.HTTP_GET, str4, str, str4), l, str2, l2, str3);
    }
    ...
    public Res(ProtocolInfo protocolInfo2, Long l, String str) {
        this.protocolInfo = protocolInfo2;
        this.size = l;
        this.value = str;
    }

    public Res(ProtocolInfo protocolInfo2, Long l, String str, Long l2, String str2) {
        this.protocolInfo = protocolInfo2;
        this.size = l;
        this.duration = str;
        this.bitrate = l2;
    ...
    public Res(URI uri, ProtocolInfo protocolInfo2, Long l, String str, Long l2, Long l3, Long l4, Long l5, Long l6, String str2, String str3, String str4) {
        this.importUri = uri;
        this.protocolInfo = protocolInfo2;
        this.size = l;
        this.duration = str;
    ...
    public void setProtocolInfo(ProtocolInfo protocolInfo2) {
        this.protocolInfo = protocolInfo2;
    }
    ...
    public int getResolutionX() {
        ...
        String str = "x";
        if (getResolution().split(str).length == 2) {
            return Integer.valueOf(getResolution().split(str)[0]).intValue();
        }
        return 0;
    }
    ...
    public int getResolutionY() {
        if (getResolution() != null) {
            String str = "x";
            if (getResolution().split(str).length == 2) {
                return Integer.valueOf(getResolution().split(str)[1]).intValue();
            }
        }
        return 0;
    }
