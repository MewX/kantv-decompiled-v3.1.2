...
public class Variable implements Value {
    ...
    private class IntegerValueAccessor extends AbstractNumberValueAccessor implements IntegerValue {
        ...
        public boolean isInByteRange() {
            ...
            if (Variable.BYTE_MIN <= Variable.this.longValue && Variable.this.longValue <= Variable.BYTE_MAX) {
                z = true;
            }
            return z;
        }
        ...
        public boolean isInShortRange() {
            ...
            if (Variable.SHORT_MIN <= Variable.this.longValue && Variable.this.longValue <= Variable.SHORT_MAX) {
                z = true;
            }
            return z;
        }
        ...
        public boolean isInIntRange() {
            ...
            if (Variable.INT_MIN <= Variable.this.longValue && Variable.this.longValue <= Variable.INT_MAX) {
                z = true;
            }
            return z;
        }
