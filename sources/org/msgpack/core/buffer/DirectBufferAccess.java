...
class DirectBufferAccess {
    ...
    static {
        ...
        L_0x004e:
            ...
            org.msgpack.core.buffer.DirectBufferAccess$DirectBufferConstructorType r1 = org.msgpack.core.buffer.DirectBufferAccess.DirectBufferConstructorType.ARGS_MB_INT_INT     // Catch:{ Exception -> 0x00cd }
            r8 = r5
            r5 = r0
            r0 = r8
        L_0x007e:
            byteBufferConstructor = r5     // Catch:{ Exception -> 0x00cd }
            directBufferConstructorType = r1     // Catch:{ Exception -> 0x00cd }
