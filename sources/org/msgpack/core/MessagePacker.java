...
public class MessagePacker implements Closeable, Flushable {
    ...
    public MessagePacker packString(String str) throws IOException {
        if (str.length() <= 0) {
            ...
            String str2 = "Unexpected UTF-8 encoder state";
            if (str.length() < 256) {
                ...
                if (encodeStringToBufferAt >= 0) {
                    if (this.str8FormatSupport && encodeStringToBufferAt < 256) {
                        ...
                        this.position = i4 + 1;
                        messageBuffer4.putByte(i4, Code.STR16);
                ...
                if (encodeStringToBufferAt2 >= 0) {
                    if (encodeStringToBufferAt2 < 65536) {
                        ...
                        this.position = i5 + 1;
                        messageBuffer5.putByte(i5, Code.STR16);
                        this.buffer.putShort(this.position, (short) encodeStringToBufferAt2);
                        this.position += 2;
                        this.position += encodeStringToBufferAt2;
                    } else if (((long) encodeStringToBufferAt2) < IjkMediaMeta.AV_CH_WIDE_RIGHT) {
                        MessageBuffer messageBuffer6 = this.buffer;
                        int i6 = this.position;
                        messageBuffer6.putMessageBuffer(i6 + 5, messageBuffer6, i6 + 3, encodeStringToBufferAt2);
                        MessageBuffer messageBuffer7 = this.buffer;
                        int i7 = this.position;
                        this.position = i7 + 1;
                        messageBuffer7.putByte(i7, Code.STR32);
