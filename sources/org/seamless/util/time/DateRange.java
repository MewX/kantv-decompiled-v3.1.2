...
public class DateRange implements Serializable {
    ...
    public static DateRange valueOf(String str) {
        ...
        String substring = str.substring(str.indexOf(str3) + 3);
        String[] split = substring.substring(0, substring.indexOf(";")).split(",");
        if (split.length != 2) {
            return null;
        }
        try {
            return new DateRange(!split[0].equals(str2) ? new Date(Long.valueOf(split[0]).longValue()) : null, !split[1].equals(str2) ? new Date(Long.valueOf(split[1]).longValue()) : null);
    ...
    public String toString() {
        ...
        sb.append("dr=");
        Object obj = "0";
        sb.append(getStart() != null ? Long.valueOf(getStart().getTime()) : obj);
        sb.append(",");
        if (getEnd() != null) {
