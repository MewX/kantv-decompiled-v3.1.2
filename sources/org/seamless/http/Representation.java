...
public class Representation<E> implements Serializable {
    ...
    public Representation(CacheControl cacheControl2, Integer num, String str, Long l, String str2, E e) {
        this(null, cacheControl2, num, str, l, str2, e);
    }

    public Representation(URL url2, CacheControl cacheControl2, Integer num, String str, Long l, String str2, E e) {
        this.url = url2;
    ...
    public Long getMaxAgeOrNull() {
        ...
        return Long.valueOf((long) getCacheControl().getMaxAge());
    }
