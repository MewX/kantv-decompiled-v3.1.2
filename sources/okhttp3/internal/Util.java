...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = $$Lambda$TEfSBt3hRUlBSSARfPEHsJesTtE.INSTANCE;
    ...
    private static String inet6AddressToAscii(byte[] bArr) {
        ...
        while (i < bArr.length) {
            if (i == i3) {
                ...
                buffer.writeHexadecimalUnsignedLong((long) (((bArr[i] & Draft_75.END_OF_FRAME) << 8) | (bArr[i + 1] & Draft_75.END_OF_FRAME)));
                i += 2;
            }
        }
