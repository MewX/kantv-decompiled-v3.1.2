...
final class Http2Reader implements Closeable {
    ...
    private void readHeaders(Handler handler, int i, byte b, int i2) throws IOException {
        ...
        if (i2 != 0) {
            boolean z = (b & 1) != 0;
            if ((b & 8) != 0) {
                s = (short) (this.source.readByte() & Draft_75.END_OF_FRAME);
            }
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        ...
        handler.priority(i, readInt & Integer.MAX_VALUE, (this.source.readByte() & Draft_75.END_OF_FRAME) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    static int readMedium(BufferedSource bufferedSource) throws IOException {
        return (bufferedSource.readByte() & Draft_75.END_OF_FRAME) | ((bufferedSource.readByte() & Draft_75.END_OF_FRAME) << 16) | ((bufferedSource.readByte() & Draft_75.END_OF_FRAME) << 8);
    }
