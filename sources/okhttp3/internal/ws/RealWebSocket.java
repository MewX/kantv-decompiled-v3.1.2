...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        String str = "Upgrade";
        final Request build2 = this.originalRequest.newBuilder().header(str, "websocket").header(HttpHeaders.CONNECTION, str).header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", Constants.VIA_REPORT_TYPE_JOININ_GROUP).build();
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0056:
            ...
            okio.BufferedSink r0 = okio.Okio.buffer(r0)     // Catch:{ all -> 0x00a5 }
