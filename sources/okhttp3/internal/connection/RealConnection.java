...
public final class RealConnection extends Listener implements Connection {
    ...
    static RealConnection testConnection(RealConnectionPool realConnectionPool, Route route2, Socket socket2, long j) {
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        /*
            ...
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0132 }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x0132 }
            okhttp3.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x0132 }
            ...
            okhttp3.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            if (r3 == 0) goto L_0x0041
            okhttp3.internal.platform.Platform r3 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
        ...
        L_0x0041:
            ...
            okhttp3.Handshake r4 = okhttp3.Handshake.get(r3)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            okhttp3.HttpUrl r6 = r0.url()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            ...
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            ...
            r4.append(r0)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            java.lang.String r0 = okhttp3.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            r4.append(r0)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            java.lang.String r0 = "\n    DN: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            ...
            java.lang.String r0 = "\n    subjectAltNames: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            java.util.List r8 = okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
        ...
        L_0x00d8:
            okhttp3.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            ...
            okhttp3.internal.platform.Platform r8 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
        ...
        L_0x00f9:
            ...
            okio.Source r8 = okio.Okio.source(r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            okio.BufferedSource r8 = okio.Okio.buffer(r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            r7.source = r8     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            okio.Sink r8 = okio.Okio.sink(r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            okio.BufferedSink r8 = okio.Okio.buffer(r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            r7.sink = r8     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            r7.handshake = r4     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            if (r2 == 0) goto L_0x011c
            okhttp3.Protocol r8 = okhttp3.Protocol.get(r2)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            goto L_0x011e
        L_0x011c:
        ...
        L_0x0132:
            r8 = move-exception
        L_0x0133:
            boolean r0 = okhttp3.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x012f }
    ...
    private Request createTunnelRequest() throws IOException {
        Request build = new Request.Builder().url(this.route.address().url()).method(HttpMethods.CONNECT, null).header(HttpHeaders.HOST, Util.hostHeader(this.route.address().url(), true)).header(HttpHeaders.PROXY_CONNECTION, HttpHeaders.KEEP_ALIVE).header("User-Agent", Version.userAgent()).build();
    ...
    private boolean routeMatchesAny(List<Route> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (route2.proxy().type() == Type.DIRECT && this.route.proxy().type() == Type.DIRECT && this.route.socketAddress().equals(route2.socketAddress())) {
                return true;
            }
        }
        return false;
    ...
    /* access modifiers changed from: 0000 */
    public ExchangeCodec newCodec(OkHttpClient okHttpClient, Chain chain) throws SocketException {
    ...
    public Streams newWebSocketStreams(Exchange exchange) throws SocketException {
        ...
        AnonymousClass1 r2 = new Streams(true, this.source, this.sink) {
