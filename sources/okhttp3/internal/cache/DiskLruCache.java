...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        r10.redundantOpCount = r0 - r10.lruEntries.size();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x006b, code lost:
        if (r1.exhausted() == false) goto L_0x006d;
     */
    ...
    private void readJournal() throws java.io.IOException {
        /*
            ...
            r2 = 0
            java.lang.String r3 = r1.readUtf8LineStrict()     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r4 = r1.readUtf8LineStrict()     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r5 = r1.readUtf8LineStrict()     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r6 = r1.readUtf8LineStrict()     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r7 = r1.readUtf8LineStrict()     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r8 = "libcore.io.DiskLruCache"
            boolean r8 = r8.equals(r3)     // Catch:{ Throwable -> 0x00ad }
            if (r8 == 0) goto L_0x007d
            java.lang.String r8 = "1"
            boolean r8 = r8.equals(r4)     // Catch:{ Throwable -> 0x00ad }
            if (r8 == 0) goto L_0x007d
            int r8 = r10.appVersion     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r8 = java.lang.Integer.toString(r8)     // Catch:{ Throwable -> 0x00ad }
            boolean r5 = r8.equals(r5)     // Catch:{ Throwable -> 0x00ad }
            if (r5 == 0) goto L_0x007d
            int r5 = r10.valueCount     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r5 = java.lang.Integer.toString(r5)     // Catch:{ Throwable -> 0x00ad }
            boolean r5 = r5.equals(r6)     // Catch:{ Throwable -> 0x00ad }
            if (r5 == 0) goto L_0x007d
            java.lang.String r5 = ""
            boolean r5 = r5.equals(r7)     // Catch:{ Throwable -> 0x00ad }
            if (r5 == 0) goto L_0x007d
            r0 = 0
        L_0x0054:
            java.lang.String r3 = r1.readUtf8LineStrict()     // Catch:{ EOFException -> 0x005e }
            r10.readJournalLine(r3)     // Catch:{ EOFException -> 0x005e }
            int r0 = r0 + 1
            goto L_0x0054
        L_0x005e:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r3 = r10.lruEntries     // Catch:{ Throwable -> 0x00ad }
            int r3 = r3.size()     // Catch:{ Throwable -> 0x00ad }
            int r0 = r0 - r3
            r10.redundantOpCount = r0     // Catch:{ Throwable -> 0x00ad }
            boolean r0 = r1.exhausted()     // Catch:{ Throwable -> 0x00ad }
            if (r0 != 0) goto L_0x0071
            r10.rebuildJournal()     // Catch:{ Throwable -> 0x00ad }
            goto L_0x0077
        L_0x0071:
            okio.BufferedSink r0 = r10.newJournalWriter()     // Catch:{ Throwable -> 0x00ad }
            r10.journalWriter = r0     // Catch:{ Throwable -> 0x00ad }
        L_0x0077:
        ...
        L_0x007c:
            return
        L_0x007d:
            java.io.IOException r5 = new java.io.IOException     // Catch:{ Throwable -> 0x00ad }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ Throwable -> 0x00ad }
            r8.<init>()     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r9 = "unexpected journal header: ["
            r8.append(r9)     // Catch:{ Throwable -> 0x00ad }
            r8.append(r3)     // Catch:{ Throwable -> 0x00ad }
            r8.append(r0)     // Catch:{ Throwable -> 0x00ad }
            r8.append(r4)     // Catch:{ Throwable -> 0x00ad }
            r8.append(r0)     // Catch:{ Throwable -> 0x00ad }
            r8.append(r6)     // Catch:{ Throwable -> 0x00ad }
            r8.append(r0)     // Catch:{ Throwable -> 0x00ad }
            r8.append(r7)     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r0 = "]"
            r8.append(r0)     // Catch:{ Throwable -> 0x00ad }
            java.lang.String r0 = r8.toString()     // Catch:{ Throwable -> 0x00ad }
            r5.<init>(r0)     // Catch:{ Throwable -> 0x00ad }
            throw r5     // Catch:{ Throwable -> 0x00ad }
        L_0x00ab:
            r0 = move-exception
            goto L_0x00b0
        L_0x00ad:
    ...
    public synchronized void rebuildJournal() throws java.io.IOException {
        /*
            r7 = this;
            monitor-enter(r7)
            okio.BufferedSink r0 = r7.journalWriter     // Catch:{ all -> 0x00c4 }
            if (r0 == 0) goto L_0x000a
            okio.BufferedSink r0 = r7.journalWriter     // Catch:{ all -> 0x00c4 }
            r0.close()     // Catch:{ all -> 0x00c4 }
        L_0x000a:
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00c4 }
            java.io.File r1 = r7.journalFileTmp     // Catch:{ all -> 0x00c4 }
            okio.Sink r0 = r0.sink(r1)     // Catch:{ all -> 0x00c4 }
            okio.BufferedSink r0 = okio.Okio.buffer(r0)     // Catch:{ all -> 0x00c4 }
            r1 = 0
            java.lang.String r2 = "libcore.io.DiskLruCache"
            okio.BufferedSink r2 = r0.writeUtf8(r2)     // Catch:{ Throwable -> 0x00bc }
            r3 = 10
            r2.writeByte(r3)     // Catch:{ Throwable -> 0x00bc }
            java.lang.String r2 = "1"
            okio.BufferedSink r2 = r0.writeUtf8(r2)     // Catch:{ Throwable -> 0x00bc }
            r2.writeByte(r3)     // Catch:{ Throwable -> 0x00bc }
            int r2 = r7.appVersion     // Catch:{ Throwable -> 0x00bc }
            long r4 = (long) r2     // Catch:{ Throwable -> 0x00bc }
            okio.BufferedSink r2 = r0.writeDecimalLong(r4)     // Catch:{ Throwable -> 0x00bc }
            r2.writeByte(r3)     // Catch:{ Throwable -> 0x00bc }
            int r2 = r7.valueCount     // Catch:{ Throwable -> 0x00bc }
            long r4 = (long) r2     // Catch:{ Throwable -> 0x00bc }
            okio.BufferedSink r2 = r0.writeDecimalLong(r4)     // Catch:{ Throwable -> 0x00bc }
            r2.writeByte(r3)     // Catch:{ Throwable -> 0x00bc }
            r0.writeByte(r3)     // Catch:{ Throwable -> 0x00bc }
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r2 = r7.lruEntries     // Catch:{ Throwable -> 0x00bc }
            java.util.Collection r2 = r2.values()     // Catch:{ Throwable -> 0x00bc }
            java.util.Iterator r2 = r2.iterator()     // Catch:{ Throwable -> 0x00bc }
        L_0x004c:
            boolean r4 = r2.hasNext()     // Catch:{ Throwable -> 0x00bc }
            if (r4 == 0) goto L_0x0085
            java.lang.Object r4 = r2.next()     // Catch:{ Throwable -> 0x00bc }
            okhttp3.internal.cache.DiskLruCache$Entry r4 = (okhttp3.internal.cache.DiskLruCache.Entry) r4     // Catch:{ Throwable -> 0x00bc }
            okhttp3.internal.cache.DiskLruCache$Editor r5 = r4.currentEditor     // Catch:{ Throwable -> 0x00bc }
            r6 = 32
            if (r5 == 0) goto L_0x0070
            java.lang.String r5 = "DIRTY"
            okio.BufferedSink r5 = r0.writeUtf8(r5)     // Catch:{ Throwable -> 0x00bc }
            r5.writeByte(r6)     // Catch:{ Throwable -> 0x00bc }
            java.lang.String r4 = r4.key     // Catch:{ Throwable -> 0x00bc }
            r0.writeUtf8(r4)     // Catch:{ Throwable -> 0x00bc }
            r0.writeByte(r3)     // Catch:{ Throwable -> 0x00bc }
            goto L_0x004c
        L_0x0070:
            ...
            okio.BufferedSink r5 = r0.writeUtf8(r5)     // Catch:{ Throwable -> 0x00bc }
            r5.writeByte(r6)     // Catch:{ Throwable -> 0x00bc }
            java.lang.String r5 = r4.key     // Catch:{ Throwable -> 0x00bc }
            r0.writeUtf8(r5)     // Catch:{ Throwable -> 0x00bc }
            r4.writeLengths(r0)     // Catch:{ Throwable -> 0x00bc }
            r0.writeByte(r3)     // Catch:{ Throwable -> 0x00bc }
            goto L_0x004c
        L_0x0085:
            if (r0 == 0) goto L_0x008a
            $closeResource(r1, r0)     // Catch:{ all -> 0x00c4 }
        L_0x008a:
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00c4 }
            java.io.File r1 = r7.journalFile     // Catch:{ all -> 0x00c4 }
            boolean r0 = r0.exists(r1)     // Catch:{ all -> 0x00c4 }
            if (r0 == 0) goto L_0x009d
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00c4 }
            java.io.File r1 = r7.journalFile     // Catch:{ all -> 0x00c4 }
            java.io.File r2 = r7.journalFileBackup     // Catch:{ all -> 0x00c4 }
            r0.rename(r1, r2)     // Catch:{ all -> 0x00c4 }
        L_0x009d:
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00c4 }
            java.io.File r1 = r7.journalFileTmp     // Catch:{ all -> 0x00c4 }
            java.io.File r2 = r7.journalFile     // Catch:{ all -> 0x00c4 }
            r0.rename(r1, r2)     // Catch:{ all -> 0x00c4 }
            okhttp3.internal.io.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x00c4 }
            java.io.File r1 = r7.journalFileBackup     // Catch:{ all -> 0x00c4 }
            r0.delete(r1)     // Catch:{ all -> 0x00c4 }
            okio.BufferedSink r0 = r7.newJournalWriter()     // Catch:{ all -> 0x00c4 }
            r7.journalWriter = r0     // Catch:{ all -> 0x00c4 }
            r0 = 0
            r7.hasJournalErrors = r0     // Catch:{ all -> 0x00c4 }
            r7.mostRecentRebuildFailed = r0     // Catch:{ all -> 0x00c4 }
            monitor-exit(r7)
            return
        L_0x00ba:
            r2 = move-exception
