...
public final class CacheInterceptor implements Interceptor {
    ...
    private static Headers combine(Headers headers, Headers headers2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((!org.eclipse.jetty.http.HttpHeaders.WARNING.equalsIgnoreCase(name) || !value.startsWith("1")) && (isContentSpecificHeader(name) || !isEndToEnd(name) || headers2.get(name) == null)) {
    ...
    static boolean isEndToEnd(String str) {
        return !org.eclipse.jetty.http.HttpHeaders.CONNECTION.equalsIgnoreCase(str) && !org.eclipse.jetty.http.HttpHeaders.KEEP_ALIVE.equalsIgnoreCase(str) && !org.eclipse.jetty.http.HttpHeaders.PROXY_AUTHENTICATE.equalsIgnoreCase(str) && !"Proxy-Authorization".equalsIgnoreCase(str) && !"TE".equalsIgnoreCase(str) && !"Trailers".equalsIgnoreCase(str) && !org.eclipse.jetty.http.HttpHeaders.TRANSFER_ENCODING.equalsIgnoreCase(str) && !"Upgrade".equalsIgnoreCase(str);
    }
