...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = $$Lambda$CipherSuite$9SWcmR6qHxy1V18Yo6ZHyn4RNk.INSTANCE;
    ...
    public static final CipherSuite TLS_PSK_WITH_3DES_EDE_CBC_SHA = init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", AVException.INVALID_ROLE_NAME);
    public static final CipherSuite TLS_PSK_WITH_AES_128_CBC_SHA = init("TLS_PSK_WITH_AES_128_CBC_SHA", AVException.EXCEEDED_QUOTA);
    public static final CipherSuite TLS_PSK_WITH_AES_256_CBC_SHA = init("TLS_PSK_WITH_AES_256_CBC_SHA", AVException.SCRIPT_ERROR);
    ...
    public static final CipherSuite TLS_RSA_WITH_SEED_CBC_SHA = init("TLS_RSA_WITH_SEED_CBC_SHA", OpType.modify_VALUE);
