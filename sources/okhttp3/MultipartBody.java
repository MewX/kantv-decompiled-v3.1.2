...
public final class MultipartBody extends RequestBody {
    ...
    private static final byte[] COLONSPACE = {HttpTokens.COLON, HttpTokens.SPACE};
    private static final byte[] CRLF = {13, 10};
    private static final byte[] DASHDASH = {45, 45};
    public static final MediaType DIGEST = MediaType.get("multipart/digest");
    public static final MediaType FORM = MediaType.get(MultipartFormDataBody.CONTENT_TYPE);
    ...
    public static final class Part {
        ...
        public static Part createFormData(String str, @Nullable String str2, RequestBody requestBody) {
            if (str != null) {
                ...
                return create(new okhttp3.Headers.Builder().addUnsafeNonAscii(com.koushikdutta.async.http.body.Part.CONTENT_DISPOSITION, sb.toString()).build(), requestBody);
            }
