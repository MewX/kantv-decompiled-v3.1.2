        ...
        return new Iterator<String>() {
            ...
            public boolean hasNext() {
                ...
                L_0x0009:
                    ...
                    r3 = 0
                    okio.Source r4 = r2.getSource(r0)     // Catch:{ Throwable -> 0x0030 }
                    okio.BufferedSource r4 = okio.Okio.buffer(r4)     // Catch:{ Throwable -> 0x0030 }
                    java.lang.String r4 = r4.readUtf8LineStrict()     // Catch:{ Throwable -> 0x0030 }
                    r5.nextUrl = r4     // Catch:{ Throwable -> 0x0030 }
