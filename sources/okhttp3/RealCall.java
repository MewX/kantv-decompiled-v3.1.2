...
final class RealCall implements Call {
    ...
    final class AsyncCall extends NamedRunnable {
        ...
        public void execute() {
            /*
                ...
                r0.timeoutEnter()
                r0 = 0
                okhttp3.RealCall r1 = okhttp3.RealCall.this     // Catch:{ IOException -> 0x0028 }
                okhttp3.Response r0 = r1.getResponseWithInterceptorChain()     // Catch:{ IOException -> 0x0028 }
                r1 = 1
                okhttp3.Callback r2 = r5.responseCallback     // Catch:{ IOException -> 0x0024 }
                okhttp3.RealCall r3 = okhttp3.RealCall.this     // Catch:{ IOException -> 0x0024 }
    ...
    public okhttp3.Response getResponseWithInterceptorChain() throws java.io.IOException {
        ...
        L_0x004b:
            ...
            r0 = 0
            r1 = 0
            okhttp3.Request r2 = r11.originalRequest     // Catch:{ IOException -> 0x0097, all -> 0x0095 }
            okhttp3.Response r2 = r10.proceed(r2)     // Catch:{ IOException -> 0x0097, all -> 0x0095 }
            okhttp3.internal.connection.Transmitter r3 = r11.transmitter     // Catch:{ IOException -> 0x0097, all -> 0x0095 }
            ...
            return r2
        L_0x008a:
            okhttp3.internal.Util.closeQuietly(r2)     // Catch:{ IOException -> 0x0097, all -> 0x0095 }
        ...
        L_0x0097:
            r0 = move-exception
            r2 = 1
            okhttp3.internal.connection.Transmitter r3 = r11.transmitter     // Catch:{ all -> 0x00a0 }
