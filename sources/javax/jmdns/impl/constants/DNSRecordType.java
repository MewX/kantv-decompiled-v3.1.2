...
public enum DNSRecordType {
    ...
    TYPE_TKEY("tkey", 249),
    TYPE_TSIG("tsig", 250),
    TYPE_IXFR("ixfr", AVException.INVALID_LINKED_SESSION),
    TYPE_AXFR("axfr", AVException.UNSUPPORTED_SERVICE),
    TYPE_MAILA("mails", AVException.FILE_DOWNLOAD_INCONSISTENT_FAILURE),
    ...
    public static DNSRecordType typeForName(String str) {
        ...
        sb.append("Could not find record type for name: ");
        sb.append(str);
