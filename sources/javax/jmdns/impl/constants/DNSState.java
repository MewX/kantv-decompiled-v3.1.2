...
public enum DNSState {
    ...
    CLOSED(SessionControlOp.CLOSED, StateClass.closed);
    
    private final String _name;
    private final StateClass _state;

    private enum StateClass {
        private static final /* synthetic */ StateClass[] $VALUES = null;
        public static final StateClass announced = null;
        public static final StateClass announcing = null;
        public static final StateClass canceled = null;
        public static final StateClass canceling = null;
        public static final StateClass closed = null;
        public static final StateClass closing = null;
        public static final StateClass probing = null;

        private StateClass(String str, int i) {
        }

        public static StateClass valueOf(String str) {
            return (StateClass) Enum.valueOf(StateClass.class, str);
        }
        ...
        static {
            ...
            closed = new StateClass(SessionControlOp.CLOSED, 6);
