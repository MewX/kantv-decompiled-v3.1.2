...
public final class DNSIncoming extends DNSMessage {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0089:
                ...
                javax.jmdns.impl.constants.DNSOptionCode r6 = javax.jmdns.impl.constants.DNSOptionCode.UL     // Catch:{ NoSuchFieldError -> 0x0093 }
    ...
    public static class MessageInputStream extends ByteArrayInputStream {
        ...
        public synchronized int peek() {
            return this.pos < this.count ? this.buf[this.pos] & Draft_75.END_OF_FRAME : -1;
        }
    ...
    /* JADX WARNING: type inference failed for: r2v56, types: [javax.jmdns.impl.DNSRecord$IPv4Address] */
    /* JADX WARNING: type inference failed for: r2v57, types: [javax.jmdns.impl.DNSRecord$IPv6Address] */
    /* JADX WARNING: type inference failed for: r2v58, types: [javax.jmdns.impl.DNSRecord$Text] */
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:130:0x00d0 A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:83:0x027e  */
    ...
    private javax.jmdns.impl.DNSRecord readAnswer(java.net.InetAddress r19) {
        ...
        L_0x0123:
            ...
            r6.<init>()
            java.lang.String r8 = "There was an OPT answer using an experimental/local option code: "
            r6.append(r8)
            r6.append(r1)
            r6.append(r14)
        ...
        L_0x017f:
            ...
            goto L_0x00d0
        L_0x01ad:
            byte r1 = r7[r12]     // Catch:{ Exception -> 0x0255 }
            byte r2 = r7[r5]     // Catch:{ Exception -> 0x0256 }
            r6 = 6
            byte[] r14 = new byte[r6]     // Catch:{ Exception -> 0x0257 }
            byte r15 = r7[r3]     // Catch:{ Exception -> 0x0257 }
            r14[r12] = r15     // Catch:{ Exception -> 0x0257 }
            byte r15 = r7[r13]     // Catch:{ Exception -> 0x0257 }
            r14[r5] = r15     // Catch:{ Exception -> 0x0257 }
            byte r15 = r7[r9]     // Catch:{ Exception -> 0x0257 }
            r14[r3] = r15     // Catch:{ Exception -> 0x0257 }
            byte r15 = r7[r8]     // Catch:{ Exception -> 0x0257 }
            r14[r13] = r15     // Catch:{ Exception -> 0x0257 }
            byte r15 = r7[r6]     // Catch:{ Exception -> 0x0257 }
            r14[r9] = r15     // Catch:{ Exception -> 0x0257 }
            r15 = 7
            byte r16 = r7[r15]     // Catch:{ Exception -> 0x0257 }
            r14[r8] = r16     // Catch:{ Exception -> 0x0257 }
            int r11 = r7.length     // Catch:{ Exception -> 0x0252 }
            r15 = 8
            if (r11 <= r15) goto L_0x01f7
            byte[] r11 = new byte[r6]     // Catch:{ Exception -> 0x0252 }
            byte r17 = r7[r15]     // Catch:{ Exception -> 0x0252 }
            r11[r12] = r17     // Catch:{ Exception -> 0x0252 }
            r17 = 9
            byte r17 = r7[r17]     // Catch:{ Exception -> 0x0252 }
            r11[r5] = r17     // Catch:{ Exception -> 0x0252 }
            r17 = 10
            byte r17 = r7[r17]     // Catch:{ Exception -> 0x0252 }
            r11[r3] = r17     // Catch:{ Exception -> 0x0252 }
            r17 = 11
            byte r17 = r7[r17]     // Catch:{ Exception -> 0x0252 }
            r11[r13] = r17     // Catch:{ Exception -> 0x0252 }
            r17 = 12
            byte r17 = r7[r17]     // Catch:{ Exception -> 0x0252 }
            r11[r9] = r17     // Catch:{ Exception -> 0x0252 }
            r17 = 13
            byte r17 = r7[r17]     // Catch:{ Exception -> 0x0252 }
            r11[r8] = r17     // Catch:{ Exception -> 0x0252 }
            goto L_0x01f8
        L_0x01f7:
            r11 = r14
        L_0x01f8:
            int r6 = r7.length     // Catch:{ Exception -> 0x0253 }
            r8 = 18
            if (r6 != r8) goto L_0x0216
            byte[] r6 = new byte[r9]     // Catch:{ Exception -> 0x0253 }
            r8 = 14
            byte r8 = r7[r8]     // Catch:{ Exception -> 0x0253 }
            r6[r12] = r8     // Catch:{ Exception -> 0x0253 }
            r8 = 15
            byte r8 = r7[r8]     // Catch:{ Exception -> 0x0253 }
            r6[r5] = r8     // Catch:{ Exception -> 0x0253 }
            byte r8 = r7[r4]     // Catch:{ Exception -> 0x0253 }
            r6[r3] = r8     // Catch:{ Exception -> 0x0253 }
            r8 = 17
            byte r8 = r7[r8]     // Catch:{ Exception -> 0x0253 }
            r6[r13] = r8     // Catch:{ Exception -> 0x0253 }
            goto L_0x0217
        L_0x0216:
            r6 = 0
        L_0x0217:
            int r8 = r7.length     // Catch:{ Exception -> 0x025a }
            r9 = 22
            if (r8 != r9) goto L_0x0274
            byte[] r8 = new byte[r15]     // Catch:{ Exception -> 0x025a }
            r9 = 14
            byte r9 = r7[r9]     // Catch:{ Exception -> 0x025a }
            r8[r12] = r9     // Catch:{ Exception -> 0x025a }
            r9 = 15
            byte r9 = r7[r9]     // Catch:{ Exception -> 0x025a }
            r8[r5] = r9     // Catch:{ Exception -> 0x025a }
            byte r9 = r7[r4]     // Catch:{ Exception -> 0x025a }
            r8[r3] = r9     // Catch:{ Exception -> 0x025a }
            r3 = 17
            byte r3 = r7[r3]     // Catch:{ Exception -> 0x025a }
            r8[r13] = r3     // Catch:{ Exception -> 0x025a }
            r3 = 18
            byte r3 = r7[r3]     // Catch:{ Exception -> 0x025a }
            r9 = 4
            r8[r9] = r3     // Catch:{ Exception -> 0x025a }
            r3 = 19
            byte r3 = r7[r3]     // Catch:{ Exception -> 0x025a }
            r9 = 5
            r8[r9] = r3     // Catch:{ Exception -> 0x025a }
    ...
    private String _hexString(byte[] bArr) {
        ...
        for (byte b : bArr) {
            byte b2 = b & Draft_75.END_OF_FRAME;
            sb.append(_nibbleToHex[b2 / 16]);
            sb.append(_nibbleToHex[b2 % 16]);
        }
        return sb.toString();
    }
