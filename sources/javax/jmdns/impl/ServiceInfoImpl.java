...
public class ServiceInfoImpl extends ServiceInfo implements DNSListener, DNSStatefulObject {
    ...
    protected static Map<Fields, String> checkQualifiedNameMap(Map<Fields, String> map) {
        ...
        boolean containsKey = map.containsKey(Fields.Domain);
        String str = ImagesContract.LOCAL;
        String str2 = containsKey ? (String) map.get(Fields.Domain) : str;
    ...
    private static String removeSeparators(String str) {
        ...
        if (trim.startsWith(EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR)) {
            trim = trim.substring(1);
        }
    ...
    public String readUTF(byte[] bArr, int i, int i2) {
        ...
        while (i < i5) {
            int i6 = i + 1;
            byte b2 = bArr[i] & Draft_75.END_OF_FRAME;
            switch (b2 >> 4) {
                case 0:
                case 1:
                case 2:
    ...
    public void updateRecord(javax.jmdns.impl.DNSCache r5, long r6, javax.jmdns.impl.DNSEntry r8) {
        /*
            ...
            if (r0 != 0) goto L_0x0144
            int[] r0 = javax.jmdns.impl.ServiceInfoImpl.AnonymousClass1.$SwitchMap$javax$jmdns$impl$constants$DNSRecordType
    ...
    public String getNiceTextString() {
        ...
        while (true) {
            if (i >= length) {
                ...
                byte b = getTextBytes()[i] & Draft_75.END_OF_FRAME;
